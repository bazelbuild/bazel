...
use the [`--override_repository`](command-line-reference.html#flag--override_repository) 
flag. This enables you to change the contents of external repositories without changing
your source code.
