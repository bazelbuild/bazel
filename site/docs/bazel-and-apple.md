...
[`xcode_config`](https://docs.bazel.build/versions/main/be/workspace.html#xcode_config)
target whose `versions` attribute is a list of remotely available
[`xcode_version`](https://docs.bazel.build/versions/main/be/workspace.html#xcode_version)
targets, and whose `default` attribute is one of these
[`xcode_versions`](https://docs.bazel.build/versions/main/be/workspace.html#xcode_version).

If you are using dynamic execution, you should set `--xcode_config` to an
[`xcode_config`](https://docs.bazel.build/versions/main/be/workspace.html#xcode_config)
target whose `remote_versions` attribute is an
[`available_xcodes`](https://docs.bazel.build/versions/main/be/workspace.html#available_xcodes)
