...
a JSON file. Once you have generated this JSON profile, you can analyze it
using Chrome's [`chrome://tracing`](https://dev.chromium.org/developers/how-tos/trace-event-profiling-tool) tool or Bazel's
[`analyze-profile`](user-manual.html#analyze-profile') command.

### Chrome's `chrome://tracing`

Using either Chromium or Google Chrome, you can load the generated JSON file
and graphically inspect the performance trace.

To do so:

1. Open Chromium or Chrome
2. Navigate to `chrome://tracing`
3. Click **Load**, and select your generated JSON profile.
4. Use the toolbar to select, pan, zoom, etc.
5. Use the search bar to look for specific actions (e.g. `Testing`.

See an example screenshot here: <br/>
<img src="images/chrome-tracing.png" width="500px"/>

<!--
Screenshot using:
  $ chromium-browser --version
  Chromium 85.0.4183.121 Built on Ubuntu , running on Ubuntu 18.04
Profile generated using:
  https://github.com/EricCousineau-TRI/repro/blob/9cc40aa7b/bazel/bazel_3.5.0_profile_example/repro.sh
-->

### `analyze-profile`

By default, this subcommand will print out summary analysis information for
each of the
