...
### Overriding and adding repos

The root module can use
[`override_repo`](/rules/lib/globals/module#override_repo) to override or add
repos to a module extension. This is especially useful when patches are applied
to the repos generated by the extension.
