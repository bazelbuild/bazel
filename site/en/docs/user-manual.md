...
Module extension tags now have an implicit _sort_key field.
This field allows comparing tags from different classes to determine their order.
It ensures consistent ordering within the MODULE.bazel file.
