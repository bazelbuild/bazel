...
def embedded_jdk_repositories():
    ...
    http_file(
        ...
        # BellSoft Liberica is currently the only vendor with a GA JDK 26 build for
        # Windows ARM64 (Azul Zulu and Adoptium Temurin do not provide one). It ships
        # with jmods, which are required for cross-jlinking the minimized JDK.
