...
distdir_tar(
    ...
    urls = {
        ...
        "java_tools_javac11_linux-v6.0.zip": [
            "https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_linux-v6.0.zip",
        ],
        "java_tools_javac11_windows-v6.0.zip": [
            "https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_windows-v6.0.zip",
        ],
        "java_tools_javac11_darwin-v6.0.zip": [
            "https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_darwin-v6.0.zip",
        ],
        "coverage_output_generator-v2.0.zip": [
...
distdir_tar(
    ...
    urls = {
        ...
        "java_tools_javac11_linux-v6.0.zip": ["https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_linux-v6.0.zip"],
        "java_tools_javac11_windows-v6.0.zip": ["https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_windows-v6.0.zip"],
        "java_tools_javac11_darwin-v6.0.zip": ["https://mirror.bazel.build/bazel_java_tools/releases/javac11/v5.1/java_tools_javac11_darwin-v6.0.zip"],
