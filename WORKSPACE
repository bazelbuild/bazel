...
distdir_tar(
    ...
    sha256 = {
        ...
        "java_tools_pkg-0.5.tar.gz": "12a7cbadaac0adcf3bed0f163000592781fe617c7401e25b491a847836f40fed",
    },
    urls = {
        ...
        "java_tools_pkg-0.5.tar.gz": ["https://mirror.bazel.build/bazel_java_tools/java_tools_pkg-0.5.tar.gz"],
    },
)
