...
distdir_tar(
    ...
    archives = [
        ...
        "android_tools_pkg-0.17.0rc1.tar.gz",
    ...
    sha256 = {
        ...
        "android_tools_pkg-0.17.0rc1.tar.gz": "f1b8a93d5916c476454fad6627ba5a66bf7e7f482b91e44d81b78ff0589d3b77",
        # bazelbuild/bazel-skylib
    ...
    urls = {
        ...
        "android_tools_pkg-0.17.0rc1.tar.gz": [
            "https://mirror.bazel.build/bazel_android_tools/android_tools_pkg-0.17.0rc1.tar.gz",
        ],
        # bazelbuild/bazel-skylib
        "2d4c9528e0f453b5950eeaeac11d8d09f5a504d4.tar.gz": [
...
http_archive(
    ...
    patch_cmds = EXPORT_WORKSPACE_IN_BUILD_FILE,
    patch_cmds_win = EXPORT_WORKSPACE_IN_BUILD_FILE_WIN,
    sha256 = "f1b8a93d5916c476454fad6627ba5a66bf7e7f482b91e44d81b78ff0589d3b77", # DO_NOT_REMOVE_THIS_ANDROID_TOOLS_UPDATE_MARKER
    url = "https://mirror.bazel.build/bazel_android_tools/android_tools_pkg-0.17.0rc1.tar.gz",
)
