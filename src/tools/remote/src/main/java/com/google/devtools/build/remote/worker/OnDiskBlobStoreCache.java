...
class OnDiskBlobStoreCache extends RemoteCache {
  ...
  public OnDiskBlobStoreCache(RemoteOptions options, Path cacheDir, DigestUtil digestUtil) {
    super(new DiskCacheClient(cacheDir, /* verifyDownloads= */ true, digestUtil),
        options, digestUtil);
  }
  ...
  public void uploadActionResult(ActionKey actionKey, ActionResult actionResult) throws IOException, InterruptedException {
