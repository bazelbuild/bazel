...
public class StarlarkBaseExternalContextTest {
   ...
   * </code></pre>
   */
  public static final byte[] EMPTY_TAR_GZ_BYTES =
      new byte[] {31, -117, 8, 0, 0, 0, 0, 0, 0, 3, 3, 0, 0, 0, 0, 0, 0, 0, 0, 0};

  /** The sha256 of a gzipped, empty file (<code>gzip -n < /dev/null | sha256sum</code>). */
  public static final String SHA256_EMPTY_GZ_FILE =
      "59869db34853933b239f1e2219cf7d431da006aa919635478511fabbfc8849d2";

  @Rule public final MockitoRule mockito = MockitoJUnit.rule();

  @Mock private BlazeDirectories blazeDirectories;
  @Mock private Environment environment;
  @Mock private DownloadManager downloadManager;
  @Mock private ProcessWrapper processWrapper;
  ...
  private static Object callStarlarkMethod(Object instance, String starlarkMethodName, Object... args)
    ...
    try (StarlarkBaseExternalContext sbec = setupStarlarkContext(testPath)) {
      ...
      Object download =
          sbec.download(
              ...
              /* allowFail= */ true,
              /* canonicalId= */ "id",
              /* authUnchecked= */ Dict.<String, Dict>builder().buildImmutable(),
              /* headersUnchecked= */ Dict.<String, Dict>builder().buildImmutable(),
              /* integrity= */ "",
              /* block= */ false,
  ...
  public void downloadAndExtract_allowFail_unsuccessfulReturnValue() throws Exception {
    ...
    when(downloadManager.startDownload(
        ...
        .thenReturn(new CompletableFuture<>());
    try (StarlarkBaseExternalContext sbec = setupStarlarkContext(testPath)) {
      StructImpl struct = sbec.downloadAndExtract(
          /* url= */ "http://example.com/file.txt.gz",
          /* output= */ "/test/output",
          /* sha256= */ SHA256_EMPTY_FILE,
          /* type= */ "gz",
