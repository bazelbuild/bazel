...
public class RemoteSpawnRunnerTest {
  ...
  public void accountingDisabledWithoutWorker() {
    ...
    RemoteSpawnRunner.spawnMetricsAccounting(spawnMetrics, ExecutedActionMetadata.getDefaultInstance());
    verifyZeroInteractions(spawnMetrics);
  }

  @Test
  public void accountingAddsDurationsForStages() {
    SpawnMetrics.Builder builder = new SpawnMetrics.Builder()
    ...
    ExecutedActionMetadata executedMetadata = ExecutedActionMetadata.newBuilder()
