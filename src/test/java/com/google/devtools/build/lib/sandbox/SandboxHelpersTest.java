...
public class SandboxHelpersTest {
  ...
  public void processInputFiles_resolvesMaterializationPath_fileArtifact() throws Exception {
    ...
    FileArtifactValue inputMetadata = FileArtifactValue.createForResolvedSymlink(
    ...
    assertThat(inputs.getFiles()).containsEntry(
        input.getExecPath(),
        RootedPath.toRootedPath(execRoot, PathFragment.create("b/b")));
  }
  ...
  public void processInputFiles_resolvesMaterializationPath_treeArtifact() throws Exception {
    ...
    FileArtifactValue childMetadata = FileArtifactValue.createForNormalFile(FAKE_DIGEST,
        null, 0L);
    TreeArtifactValue parentMetadata = TreeArtifactValue.newBuilder(parent)
