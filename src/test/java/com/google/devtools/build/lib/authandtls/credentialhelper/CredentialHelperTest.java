...
public class CredentialHelperTest {
  ...
  public void unknownUri() {
    CredentialHelperException e =
        assertThrows(
            CredentialHelperException.class, () -> getCredentialsFromHelper("https://unknown.example.com"));
  ...
  public void credentialHelperOutputsNothing() throws Exception {
    CredentialHelperException e =
        assertThrows(
            CredentialHelperException.class, () -> getCredentialsFromHelper("https://printnothing.example.com"));
  ...
  public void helperTimeout() throws Exception {
    CredentialHelperException e =
        assertThrows(
            CredentialHelperException.class, () -> getCredentialsFromHelper("https://timeout.example.com"));
