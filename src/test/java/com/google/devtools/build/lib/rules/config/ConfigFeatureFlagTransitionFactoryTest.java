...
public final class ConfigFeatureFlagTransitionFactoryTest extends BuildViewTestCase {
  ...
  public void emptyTransition_returnsOriginalOptionsIfFragmentNotPresent() throws Exception {
    ...
    PatchTransition transition = new ConfigFeatureFlagTransitionFactory("flag_values").create(
        RuleTransitionData.create(rule));
  ...
  public void populatedTransition_returnsOriginalOptionsIfFragmentNotPresent() throws Exception {
    Rule rule =
        scratchRule(
            ...
            "    allowed_values = ['a', 'b'],",
            "    default_value = 'a')");
    PatchTransition transition = new ConfigFeatureFlagTransitionFactory("flag_values").create(RuleTransitionData.create(rule));
