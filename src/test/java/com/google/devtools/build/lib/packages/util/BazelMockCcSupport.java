...
public final class BazelMockCcSupport extends MockCcSupport {
  ...
  public void setup(MockToolsConfig config) throws IOException {
    config.create(
        ...
        "      'x86_32_windows|compiler': ':cc-compiler-x86_32_windows',",
        ...
        "    toolchain_type = ':toolchain_type',",
        ")",
        "cc_toolchain(name = 'cc-compiler-x86_32_windows', all_files = ':empty', ",
        "    compiler_files = ':empty',",
        "    cpu = 'x86_32_windows', compiler = 'compiler', libc = 'local', ",
        "    dwp_files = ':empty',",
        "    dynamic_runtime_libs = [':empty'], ",
        "    linker_files = ':empty',",
        "    module_map = 'crosstool.cppmap', supports_header_parsing = 1,",
