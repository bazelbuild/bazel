...
public final class JavaCompileActionBuilderTest extends BuildViewTestCase {
   ...
   * that threw {@code ConcurrentModificationException} while {@code checkForLostInputs} iterated
   * the lost-input collection. This test makes the interleaving deterministic by blocking one read
   * on a latch.
   */
  @Test
