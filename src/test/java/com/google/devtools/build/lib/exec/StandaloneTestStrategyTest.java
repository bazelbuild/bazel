...
public final class StandaloneTestStrategyTest extends BuildViewTestCase {
  ...
  public void testMetadataResetOnRetry() throws Exception {
    ...
    ActionExecutionContext context = new FakeActionExecutionContext(
    ...
    execute(testRunnerAction, context, new TestedStandaloneTestStrategy(Options.getDefaults(ExecutionOptions.class), Options.getDefaults(TestSummaryOptions.class), outputBase));
