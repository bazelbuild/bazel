...
public abstract class ObjcRuleTestCase extends BuildViewTestCase {
  ...
  protected static void addAppleBinaryStarlarkRule(Scratch scratch) throws Exception {
    ...
    scratch.file(
        ...
        "    if platform_type == apple_common.platform_type.visionos:",
        ...
        "    if platform_type == apple_common.platform_type.catalyst:",
        ...
        "            return getattr(apple_common.platform, platform)",
        ...
        "    prefixed_cpu = _get_prefixed_apple_cpu(apple_config.apple_platform_type,"
            + " apple_config.apple_cpus)",
        "    return _for_target(apple_config.apple_platform_type, prefixed_cpu)",
        ...
        "    apple_config = apple_common.get_apple_config(build_config = build_config)",
        "    platform = _get_single_arch_platform(apple_config)",
        "",
        "    ctx.actions.run(",
