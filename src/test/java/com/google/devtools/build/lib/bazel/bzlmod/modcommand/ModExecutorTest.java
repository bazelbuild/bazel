...
public class ModExecutorTest {
  ...
  public void testModCommandPath_complexGraphFiltersCorrectly() throws ParseException, IOException {
    ...
    file2.deleteOnExit();
    Writer writer2 = new OutputStreamWriter(new FileOutputStream(file2), UTF_8);
    ...
    file3.deleteOnExit();
    Writer writer3 = new OutputStreamWriter(new FileOutputStream(file3), UTF_8);
    ...
    file4.deleteOnExit();
    Writer writer4 = new OutputStreamWriter(new FileOutputStream(file4), UTF_8);
    ...
    file5.deleteOnExit();
    Writer writer5 = new OutputStreamWriter(new FileOutputStream(file5), UTF_8);
