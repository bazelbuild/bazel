...
public class CcToolchainSuiteTest extends BuildViewTestCase {
  ...
  public void testCcToolchainLabelFromAttributes() throws Exception {
    scratch.file(
        ...
        "       'aarch64|compiler': 'aarch64-compiler'",
        "       'aarch64' : 'aarch64-default-from-cpu'",
        ...
        "default_toolchain {",
        "  cpu: 'aarch64'",
        "  toolchain_identifier: 'aarch64-from-crosstool'",
        "}",
        "default_toolchain {",
        "  cpu: 'darwin'",
    ...
    useConfiguration("--crosstool_top=//cc:suite", "--compiler=compiler", "--cpu=aarch64");
    config = getConfiguration(getConfiguredTarget("//a:b")).getFragment(CppConfiguration.class);
    assertThat(config.getCcToolchainRuleLabel().toString()).isEqualTo("//cc:aarch64-compiler");
  ...
  public void testCcToolchainFromToolchainIdentifier() throws Exception {
    scratch.file(
        ...
        "       'aarch64' : ':darwin',",
        "       'aarch64|compiler' : ':aarch64',",
        "       'aarch64|compiler-from-attribute' : ':aarch64',",
        "       'aarch64|compiler1' : ':aarch64',",
        "       'aarch64|right-compiler' : ':aarch64',",
        "    },",
        "    proto = \"\"\"",
        "major_version: 'v1'",
        "minor_version: '0'",
        ...
        "default_toolchain {",
        "  cpu: 'aarch64'",
        "  toolchain_identifier: 'aarch64-toolchain-identifier'",
        "}",
        "toolchain {",
        "  compiler: 'compiler'",
        "  target_cpu: 'k8'",
