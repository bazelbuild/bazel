...
public class JavaSkylarkApiTest extends BuildViewTestCase {
  ...
  public void mergeSourceInfo() throws Exception {
    ...
    ConfiguredTarget myRuleTarget = getConfiguredTarget("//foo:custom");
    JavaSourceInfoProvider sourceInfo = JavaInfo.getProvider(JavaSourceInfoProvider.class, myRuleTarget);
    assertThat(prettyArtifactNames(sourceInfo.getJarFiles())).containsExactly("foo/java/A.jar", "foo/java/B.jar");
  }
