...
public class ConfiguredTargetQuerySemanticsTest extends ConfiguredTargetQueryTest {
  ...
  @Test
  public void testAspectOnAspetDepsAppearInCqueryDeps() throws Exception {
    writeFile(
        "donut/test.bzl",
        "TestAspectInfo = provider('TestAspectInfo', fields = ['info'])",
    ...
    assertThat(result)
        .containsExactly(
            "//donut:test.bzl%_test_aspect_on_aspect on top of"
                + " [//donut:test_rule_dep#//donut:test.bzl%_test_aspect"
                + " ConfiguredTargetKey{label=//donut:test_rule_dep,"
                + " config=BuildConfigurationKey[5559b14d4860d5388d8b2cfd3fa1851c502b729ec778df697bbf62c95cf026da]}"
                + " {}]",
            "//donut:test.bzl%_test_aspect_on_aspect on top of"
                + " [//donut:test_rule#//donut:test.bzl%_test_aspect"
                + " ConfiguredTargetKey{label=//donut:test_rule,"
                + " config=BuildConfigurationKey[5559b14d4860d5388d8b2cfd3fa1851c502b729ec778df697bbf62c95cf026da]}"
                + " {}]",
            "//donut:test_rule_dep",
            "//donut:test_rule",
