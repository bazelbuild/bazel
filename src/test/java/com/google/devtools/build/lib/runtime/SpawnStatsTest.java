...
public final class SpawnStatsTest {
  ...
  public void one() {
    ...
    spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("foo").build());
  ...
  public void oneRemote() {
    ArrayList<SpawnResult> spawns = new ArrayList<>();
    spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("remote cache hit").build());
    stats.countActionResult(ActionResult.create(spawns));
    stats.incrementActionCount();
    assertThat(SpawnStats.convertSummaryToString(stats.getSummary()))
  ...
  public void order() {
    ArrayList<SpawnResult> spawns = new ArrayList<>();
    spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("a").build());
    stats.countActionResult(ActionResult.create(spawns));
    stats.incrementActionCount();

    for (int i = 0; i < 2; i++) {
      spawns = new ArrayList<>();
      spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("b").build());
      stats.countActionResult(ActionResult.create(spawns));
      stats.incrementActionCount();
    }
    ...
    for (int i = 0; i < 3; i++) {
      spawns = new ArrayList<>();
      spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("c").build());
      stats.countActionResult(ActionResult.create(spawns));
      stats.incrementActionCount();
    }
    assertThat(SpawnStats.convertSummaryToString(stats.getSummary()))
  ...
  public void orderCacheInternalRest() {
    ...
    for (int i = 0; i < 2; i++) {
      spawns = new ArrayList<>();
      spawns.add(new SpawnResult.Builder().setStatus(SpawnResult.Status.SUCCESS).setRunnerName("z").build());
      stats.countActionResult(ActionResult.create(spawns));
      stats.incrementActionCount();
    }
