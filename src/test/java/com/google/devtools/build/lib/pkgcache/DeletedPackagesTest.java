...
import com.google.devtools.build.lib.pkgcache.PackageOptions.CommaSeparatedPackagePatternListConverter;
...
/** Tests for {@link DeletedPackages} and {@link CommaSeparatedPackagePatternListConverter}. */
@RunWith(JUnit4.class)
public class DeletedPackagesTest {

  private static final CommaSeparatedPackagePatternListConverter CONVERTER =
      new CommaSeparatedPackagePatternListConverter();
  ...
  @Test
  public void converter_subtreeWithAbsolutePackage() throws Exception {
    assertThat(CONVERTER.convert("//foo/bar/..."))
        .containsExactly(new DeletedPackages.Pattern(mainPkg("foo/bar"), true));
  }
  ...
  @Test
  public void converter_malformedSubtreeThrows() {
    assertThrows(OptionsParsingException.class, () -> CONVERTER.convert("/..."));
    assertThrows(OptionsParsingException.class, () -> CONVERTER.convert("a//..."));
    assertThrows(OptionsParsingException.class, () -> CONVERTER.convert("foo//..."));
    assertThrows(OptionsParsingException.class, () -> CONVERTER.convert("foo/.../bar"));
  }
