...
public class SkylarkCcCommonTest extends BuildViewTestCase {
  ...
  private void setUpCcLinkingContextTest() throws Exception {
    ...
    scratch.file(
        ...
        "def _create(ctx, feature_configuration, static_library, pic_static_library, dynamic_library,",
        "  interface_library, dynamic_library_symlink_path, interface_library_symlink_path, alwayslink):",
        ...
        "     ctx.attr.dynamic_library_symlink_path if ctx.attr.dynamic_library_symlink_path else None,",
        "     ctx.attr.interface_library_symlink_path if ctx.attr.interface_library_symlink_path else None,",
        "     ctx.attr.alwayslink)",
