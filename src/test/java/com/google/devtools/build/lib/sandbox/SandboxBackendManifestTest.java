  ...
  public void toDebugString_rendersManifestFields() {
    Manifest manifest =
        Manifest.newBuilder()
            ...
            .putOutputs("ws/pkg/out.o", Output.newBuilder().setType("file").build())
            .putWritableDirs("/tmp", "/scratch/tmp")
            .build();
    ...
    assertThat(text).contains("/out/execroot");
    assertThat(text).contains("ws/pkg/out.o");
  }
}
