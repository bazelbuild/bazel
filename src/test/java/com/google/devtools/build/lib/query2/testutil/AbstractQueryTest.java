...
public abstract class AbstractQueryTest<T> {
  ...
  protected void useReducedSetOfRules() throws Exception {
    ...
    helper.writeFile("/workspace/rules_python_workspace/MODULE.bazel",
    ...
    helper.writeFile("/workspace/rules_python_internal_workspace/MODULE.bazel",
    ...
    helper.writeFile("/workspace/bazel_skylib_workspace/MODULE.bazel",
        "module(name='bazel_skylib')");
