...
public class GrpcServerTest {
  ...
  /**
   * Ensure that if a command is marked as preemptible, running a second command
              ...
              while (true) {
                try {
                  ...
                  return BlazeCommandResult.failureDetail(
                    FailureDetail.newBuilder()
                        .setInterrupted(
                            Interrupted.newBuilder().setCode(Code.INTERRUPTED))
                        .build());
                }
              }
            } else {
  ...
  /**
   * Ensure that if a command is marked as preemptible, running a second
   * preemptible command interupts the first command.
   */
  @Test
  ...
  /**
   * Ensure that when a command is not marked as preemptible, running a second
   * command does not interrupt the first command.
   */
  @Test
