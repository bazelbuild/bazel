...
public class IndexRegistryTest extends FoundationTestCase {
      ...
      return downloadEvents.stream()
          .collect(
              ImmutableMap.toImmutableMap(
                  RegistryFileDownloadEvent::uri, RegistryFileDownloadEvent::checksum));
    }
  }
  ...
  public void testGetArchiveRepoSpec() throws Exception {
    ...
    assertThat(
            registry.getRepoSpec(
                createModuleKey("bar", "2.0"), reporter))
        .isEqualTo(
            new ArchiveRepoSpecBuilder()
                .setUrls(
                    ImmutableList.of(
  ...
  public void testGetRepoSpecChecksumMismatch() throws Exception {
    ...
    String sourceJson =
        ...
        """;
    String maliciousSourceJson = sourceJson.replaceAll("project_x", "malicious");
  ...
  public void testBazelRegistryChecksumMismatch() throws Exception {
    ...
    String registryJson =
        ...
        """;
    String maliciousRegistryJson = registryJson.replaceAll("foo", "malicious");
