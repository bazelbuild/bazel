...
public class BazelProtoLibraryTest extends BuildViewTestCase {
  ...
  // The tests below are for Bazel **and** Blaze.
  //
  // TODO(lberki): Extract these into their own test suite (`SharedProtoLibraryTest`).
  ...
  private void setUpForSharedTests() throws Exception {
    if (isThisBazel()) {
      scratch.file(
          "proto/defs.bzl",
