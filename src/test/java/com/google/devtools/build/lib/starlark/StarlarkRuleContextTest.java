...
public final class StarlarkRuleContextTest extends BuildViewTestCase {
  ...
  @Test
  public void testLabelListDictForbidsDuplicatesWithinSingleKeyOverlappingSelects() throws Exception {
    reporter.removeHandler(failFastHandler);
    scratch.file("a.txt", "");
    scratch.file(
        "my_rule.bzl",
  ...
  public void testLabelListDictForbidsRulesMissingRequiredProviders() throws Exception {
    ...
    getConfiguredTarget("//:r");
    assertContainsEvent(
        "in label_list_dict attribute of my_rule rule //:r: '//:dep' does not have mandatory providers: 'MyInfo'");
  }
