 ...
 *
 * <p>The archive has the following structure
 *
 * <p>root_folder/ another_folder/ regularFile hardLinkFile hardlink to
...
public class TestArchiveDescriptor {
  ...
  DecompressorDescriptor.Builder createDescriptorBuilder() throws IOException {
    ...
    Path tarballPath = testFs.getPath(Runfiles.preload().withSourceRepository("").rlocation(path));
