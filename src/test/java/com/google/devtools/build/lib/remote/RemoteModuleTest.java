...
public class RemoteModuleTest {
  ...
  private CommandEnvironment testCommandEnvironment(RemoteOptions remoteOptions)
    ...
    BlazeRuntime runtime = new BlazeRuntime.Builder()
    ...
    BlazeDirectories directories = new BlazeDirectories(serverDirectories,
        scratch.dir("/workspace"), scratch.dir("/system_javabase"), productName);
  ...
  private Server createFakeServer(String serverName, BindableService... services) {
  ...
  public void testVerifyCapabilities_ExecutionAndCacheForSingleEndpoint() throws Exception {
    ...
    try {
      ...
      assertThat(executionServerCapabilitiesImpl.getRequestCount() == 1).isTrue();
    } finally {
