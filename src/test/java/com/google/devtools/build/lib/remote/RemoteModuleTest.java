...
public final class RemoteModuleTest {
  ...
  private static CommandEnvironment createTestCommandEnvironment(RemoteModule remoteModule,
  ...
  public void testNetrc_netrcWithoutRemoteCache() throws Exception {
    ...
    Cache<URI, ImmutableMap<String, ImmutableList<String>>> credentialCache = Caffeine.newBuilder()
        .build();
