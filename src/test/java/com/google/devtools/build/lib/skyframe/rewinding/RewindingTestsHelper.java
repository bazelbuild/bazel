...
public class RewindingTestsHelper {
    ...
    testCase.write(
        ...
        def _consumer_impl(ctx):
            ...
            ctx.actions.run_shell(
                ...
                execution_requirements = {"no-cache": "1"} if ctx.attr.no_cache else {},
            )
            return DefaultInfo(files = depset([out]))
  ...
  public final void runActionTemplateExpansionRewound_withDownstreamExpansionInFlight(
    ...
    testCase.write(
        ...
        """
        load(":common.bzl", "consumer", "copy_tool")
        load(":defs.bzl", "downstream_tree", "upstream_tree")
  ...
  public final void runActionTemplateExpansionRewound_threeActionDeadlock(
        ...
        delegate ->
            new RewoundActionSynchronizer() {
              ...
              public SilentCloseable enterActionExecution(
                ...
                if (wasRewound
                    && "Consuming //foo:tree_consumer".equals(action.getProgressMessage())) {
    ...
    assertThat(spawns).hasCount("Consuming //foo:tree_consumer", 2);
  ...
  public final void runActionTemplateExpansionRewound_emptySubdirectoryWithTreeConsumer(
    ...
    var spawns = ImmutableMultiset.copyOf(getExecutedSpawnDescriptions());
    assertThat(spawns).hasCount("Producing upstream", 2);
    assertThat(spawns).hasCount("Consuming //foo:tree_consumer", 1);
  }
  ...
  private void writeRewindingLockWorkspace(boolean emptySubdirectory) throws Exception {
    ...
    writeCopyToolAndConsumerRules(copyScript);
    testCase.write(
        "foo/defs.bzl",
        """
def _map_impl(template_ctx, input_directories, output_directories, tools, **kwargs):
...
"""
    ...
    testCase.write(
        ...
        """
load(":common.bzl", "consumer", "copy_tool")
load(":defs.bzl", "downstream", "upstream")
copy_tool(name = "copy_tool")
...
consumer(name = "tree_consumer", srcs = [":upstream"], no_cache = True)
consumer(name = "losing_consumer", srcs = [":tree_consumer"], no_cache = True)
consumer(name = "losing_upstream", srcs = [":witness"], no_cache = True)
