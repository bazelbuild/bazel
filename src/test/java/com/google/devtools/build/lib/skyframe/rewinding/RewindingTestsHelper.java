...
public class RewindingTestsHelper {
   ...
   * com.google.devtools.build.lib.actions.ActionTemplate} can be rewound while a consumer of the
   * tree artifact it populates is running, either by waiting for the consumer to complete (Bazel)
   * or by relying on the particular filesystem to support this concurrent access (Blaze).
   *
