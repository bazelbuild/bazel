...
public class RemoteCacheTests {
  ...
  @Mock private Consumer<ProgressStatus> reporter;
  ...
  public void downloadRelativeFileSymlink() throws Exception {
    ...
    cache.download(context, remotePathResolver, result.build(), null, outputFilesLocker, reporter);
  ...
  public void downloadFailureMaintainsDirectories() throws Exception {
    ...
    assertThrows(
        ...
        () ->
            cache.download(
                context, remotePathResolver, result.build(), null, outputFilesLocker, reporter));
  ...
  public void testDownloadWithStdoutStderrOnSuccess() throws Exception {
    ...
    cache.download(context, remotePathResolver, result, spyOutErr, outputFilesLocker, reporter);
  ...
  public void testDownloadWithStdoutStderrOnFailure() throws Exception {
    ...
    assertThrows(
        ...
        () ->
            cache.download(
                context, remotePathResolver, result, spyOutErr, outputFilesLocker, reporter));
    verify(spyOutErr, Mockito.times(2)).childOutErr();
    verify(spyChildOutErr).clearOut();
    verify(spyChildOutErr).clearErr();
  ...
  public void testDownloadClashes() throws Exception {
    ...
    remoteCache.download(
        context, remotePathResolver, r, new FileOutErr(), outputFilesLocker, reporter);
