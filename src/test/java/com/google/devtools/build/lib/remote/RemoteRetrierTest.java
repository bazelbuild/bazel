...
public class RemoteRetrierTest {
  ...
  public void testNoRetries() throws Exception {
    ...
    RemoteRetrier retrier =
        Mockito.spy(new RemoteRetrier(options, (e) -> Result.TRANSIENT_FAILURE, retryService, Retrier.ALLOW_ALL_CALLS));
    when(fooMock.foo())
        .thenReturn("bla")
  ...
  public void testRepeatedRetriesReset() throws Exception {
    ...
    RemoteRetrier retrier =
        Mockito.spy(
            new RemoteRetrier(s, (e) -> Result.TRANSIENT_FAILURE, retryService, Retrier.ALLOW_ALL_CALLS, sleeper));
  ...
  public void testInterruptedExceptionIsPassedThrough() throws Exception {
    ...
    options.remoteMaxRetryAttempts = 0;
    RemoteRetrier retrier =
        new RemoteRetrier(options, (e) -> Result.TRANSIENT_FAILURE, retryService, Retrier.ALLOW_ALL_CALLS);
