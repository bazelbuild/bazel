...
public class ExternalPackageHelperTest extends BuildViewTestCase {
  ...
  public void createEnvironment() throws Exception {
    ...
    skyFunctions.put(
        GET_REGISTERED_EXECUTION_PLATFORMS_FUNCTION, new GetRegisteredExecutionPlatformsFunction(starlarkSemantics));
    skyFunctions.put(GET_REGISTERED_TOOLCHAINS_FUNCTION, new GetRegisteredToolchainsFunction(starlarkSemantics));
