...
public class TransitionFactoriesTest {
  ...
  public void hostTransition() {
    TransitionFactory<TransitionFactory.Data> factory = TransitionFactories.of(HostTransition.INSTANCE);
  ...
  public void noTransition() {
    TransitionFactory<TransitionFactory.Data> factory = TransitionFactories.of(NoTransition.INSTANCE);
    assertThat(factory).isNotNull();
  ...
  public void nullTransition() {
    TransitionFactory<TransitionFactory.Data> factory = TransitionFactories.of(NullTransition.INSTANCE);
    assertThat(factory).isNotNull();
