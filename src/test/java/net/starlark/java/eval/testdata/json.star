...
assert_eq(json.decode('"\\ud83d\\ude39\\ud83d\\udc8d"'), "😹💍")
assert_eq(json.decode('"\\u0123"'), "\304\243")
...
assert_eq(json.encode_indent(dict(x = 1, y = ["one", "two", [], {}]), prefix = "\302\266", indent = "\342\200\223\342\200\223\342\200\223"), '''\
{
¶–––"x": 1,
¶–––"y": [
¶––––––"one",
...
assert_eq(json.indent(s, prefix = "\302\266", indent = "\342\200\223\342\200\223\342\200\223"), '''\
{
¶–––"x": 1,
¶–––"y": [
¶––––––"one",
