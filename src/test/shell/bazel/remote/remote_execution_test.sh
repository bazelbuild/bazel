...
EOF
  ...
  || fail "Expected toplevel output bazel-testlogs/a/test/test.xml to be downloaded"
...
function test_remote_download_minimal_and_test_xml_generation() {
  # Test that when testing with --remote_download_minimal, Bazel wouldn't regenerate the test.xml if the action actually
  # produced it. See https://github.com/bazelbuild/bazel/issues/12554
