...
function test_repository_layout_indirect_dependency() {
...
EOF
    ...
    bazel build //foo:srcs || fail "expected success"
}

function test_external_directory_in_main_repo_is_not_visible() {
...
EOF
    ...
    bazel build //external/foo:use-srcs \
