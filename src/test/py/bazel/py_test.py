...
class PyTest(test_base.TestBase):
  ...
  def testRunfilesSymlinks(self):
    ...
    self.assertTrue(os.readlink('bazel-bin/a/a.runfiles/_main/a/a.py')
                    .endswith('/a/a.py'))
    self.assertTrue(os.readlink('bazel-bin/a/a.runfiles/_main/a/b.py')
                    .endswith('/a/b.py'))
...
class TestInitPyFiles(test_base.TestBase):
  ...
  def testInitPyFilesCreated(self):
    ...
    if self.IsWindows():
      ...
      self.assertTrue(
          os.path.exists(
              'bazel-bin/src/a/a.runfiles/_main/src/a/__init__.py'))
