...
class RepoContentsCacheTest(test_base.TestBase):
  ...
  def doTestRepoContentsCacheDeleted(self, checkExternalRepositoryFiles):
    ...
    extra_args = [
        ...
        % str(checkExternalRepositoryFiles).lower(),
  ...
  def testRepoContentsCacheDeleted_withoutCheckExternalRepositoryFiles(self):
    self.doTestRepoContentsCacheDeleted(checkExternalRepositoryFiles=False)
