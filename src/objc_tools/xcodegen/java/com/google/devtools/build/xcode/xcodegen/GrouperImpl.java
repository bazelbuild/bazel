...
/**
 * An implementation of {@code Grouper} that does what you would expect. It arranges the
 * {@code PBXFileReference}s into a hierarchy of {@code PBXGroup}s that mirrors the actual location
 * of the files on disk.
 * <p>
 * When using this {@link Grouper} implementation, the top-level items are the following:
 * <ul>
...
public class GrouperImpl implements Grouper {
  ...
  public GrouperImpl(FileSystem fileSystem) {
   ...
   * {@link GrouperImpl} expresses <em>root</em> in general.
   */
