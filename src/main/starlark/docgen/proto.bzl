...
load("@com_google_protobuf//bazel/private:java_proto_library.bzl", "java_proto_library")  # buildifier: disable=bzl-visibility
...
load("@com_google_protobuf//bazel/private/oss:cc_proto_library.bzl", "cc_proto_library")  # buildifier: disable=bzl-visibility
load("@com_google_protobuf//bazel/private/oss:py_proto_library.bzl", "py_proto_library")  # buildifier: disable=bzl-visibility
