...
def cc_binary_impl(ctx, additional_linkopts, force_linkstatic = False):
    ...
    (compilation_context, compilation_outputs) = cc_common.compile(
        ...
        feature_configuration = feature_configuration,
        cc_toolchain = cc_toolchain,
        user_compile_flags = runtimes_copts + cc_helper.get_copts(ctx, "copts", feature_configuration, additional_make_variable_substitutions),
        conly_flags = cc_helper.get_copts(ctx, "conlyopts", feature_configuration, additional_make_variable_substitutions),
        cxx_flags = cc_helper.get_copts(ctx, "cxxopts", feature_configuration, additional_make_variable_substitutions),
