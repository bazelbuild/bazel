...
_EMPTY_NATIVE_LIBRARY_INFO = CcNativeLibraryInfo(libraries_to_link = depset())
...
def _create_cc_info(
        *,
        compilation_context = cc_internal.empty_compilation_context(),
        linking_context = _EMPTY_LINKING_CONTEXT,
        debug_context = _EMPTY_DEBUG_CONTEXT,
        cc_native_library_info = _EMPTY_NATIVE_LIBRARY_INFO):
    return dict(
        compilation_context = compilation_context,
        linking_context = linking_context,
        _debug_context = debug_context,
        _legacy_transitive_native_libraries = cc_native_library_info.libraries_to_link,
    )
