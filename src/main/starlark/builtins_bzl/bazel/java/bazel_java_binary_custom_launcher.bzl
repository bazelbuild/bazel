...
"""Defines a java_binary rule class that is executable, and has a custom launcher,
so doesn't have launcher flag resolution.
...
java_binary = make_java_binary(executable = True, resolve_launcher_flag = False, has_launcher = True)

java_test = make_java_test(resolve_launcher_flag = False, has_launcher = True)
