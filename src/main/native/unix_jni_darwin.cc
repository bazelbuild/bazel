...
//
// This may return NULL if `os_log_create` is not supported on this version of macOS.
// Use `log_if_possible` to log when supported.
...
static void SleepCallBack(void *refcon, io_service_t service,
  ...
  switch (message_type) {
    ...
    case kIOMessageSystemWillNotSleep:
      log_if_possible("suspend anomaly cancelled due to kIOMessageSystemWillNotSleep");
      --state->suspend_count;
      break;
