...
public @interface Option {
  ...
  /**
   * A help string for the usage information. Note that this should be in plain text or markdown
   * (no HTML tags, for example). HTML syntax will be escaped in `bazel help everything-as-html`.
   */
  String help() default "";
