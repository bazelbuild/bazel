...
public abstract class ConstraintCollection
  ...
  public final static class Builder {
    ...
    private ImmutableList.Builder<ConstraintValueInfo> constraintValues = new ImmutableList.Builder<>();
    ...
    public ConstraintCollection build() {
      ...
      return new AutoValue_ConstraintCollection(
          ...
          constraintValues.stream()
                            .collect(
                            toImmutableMap(ConstraintValueInfo::constraint, Function.identity())));
    }
  }
