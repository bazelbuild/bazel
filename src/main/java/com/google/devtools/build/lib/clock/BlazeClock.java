 ...
 * Profiler.
 *
 * <p>Note that {@link Clock#nanoTime} readings are relative to an unspecified reference time, so
 * returned values are only meaningful when compared to each other. A {@link TimeAnchor} maps them
 * onto the wall-clock timeline and back.
 */
@ThreadSafe
