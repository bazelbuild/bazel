...
public class ActionExecutionFunction implements SkyFunction, CompletionReceiver {
  ...
  public SkyValue compute(SkyKey skyKey, Environment env)
    ...
    if (checkedInputs != null) {
      ...
      if (skyframeActionExecutor.actionFileSystemSupport() != ActionFileSystemSupport.NONE) {
  ...
  private OutputStore newOutputStore(ContinuationState state) {
    Preconditions.checkState(
        skyframeActionExecutor.actionFileSystemSupport() == ActionFileSystemSupport.NONE
            || state.actionFileSystem != null, "actionFileSystem must not be null");

    if (skyframeActionExecutor.actionFileSystemSupport() == ActionFileSystemSupport.FULL) {
