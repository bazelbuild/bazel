...
public class GrpcRemoteOutputService implements OutputService, ActionResultDownloader {
  ...
  public GrpcRemoteOutputService(StateAcrossBuilds stateAcrossBuilds, ReferenceCountedChannel channel, String outputBaseId, PathFragment outputPathPrefix, String instanceName, DigestFunction.Value digestFunction) {
  ...
  private class GrpcBatchStat implements BatchStat {
    ...
    public List<FileStatusWithDigest> batchStat(boolean includeDigest,
      ...
      try {
        responses = blockingStub.batchStat(builder.build());
