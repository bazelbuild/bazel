...
final class PlatformProperties {
   ...
   */
  static final String PERSISTENT_WORKER_KEY = "persistentWorkerKey";
   ...
   * expecting for the action this platform property is bound to. It is omitted for the default
   * {@code proto} protocol.
   */
  static final String PERSISTENT_WORKER_PROTOCOL = "persistentWorkerProtocol";
