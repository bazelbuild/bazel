...
public final class NinjaVariableValue {
  /**
   * List of functions for computing parts of the variable value.
   * For the case of text part, the function just returns the text literal.
   * For the case of variable reference, function calls the value expander, passed to it as an
   * argument, to get the variable value, and returns it.
   *
   * {@link NinjaVariableValue.Builder#addVariable(String)}
   */
  private final ImmutableList<Function<Function<String, String>, String>> parts;

  private NinjaVariableValue(
      ImmutableList<Function<Function<String, String>, String>> parts) {
    this.parts = parts;
  }
