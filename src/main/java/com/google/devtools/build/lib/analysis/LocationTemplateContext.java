...
final class LocationTemplateContext implements TemplateContext {
  ...
  private LocationTemplateContext(
      ...
      boolean execPaths,
      ImmutableMap<RepositoryName, RepositoryName> repositoryMapping, boolean windowsPath) {
  ...
  public String lookupFunctionImpl(String name, String param) throws ExpansionException {
    try {
