      ...
      switch (c) {
        ...
        case ':':
          ...
          switch (content[r]) {
            ...
            case '\r':
              if (w > 0) {
                // After enable C++20 Modules, GCC produces .d file with multiple output files.
                // We only care about the first output file.
                // Example of .d file generated by GCC
                //
                // foo.pic.o: \
                //  foo.cpp \
                //  bazel-out/k8-fastbuild/bin/bar.pic.gcm
                // foo.pic.o: \
                //  bar.c++-module
                // CXX_IMPORTS += bar.c++-module
                //
