...
public final class ParameterFileWriteAction extends AbstractFileWriteAction {
  ...
  protected void computeKey(
    ...
    commandLine.addToFingerprint(actionKeyContext, artifactExpander, CoreOptions.OutputPathsMode.OFF, fp);
  }
  ...
  public String describeKey() {
    ...
    try {
      ...
      commandLine.addToFingerprint(new ActionKeyContext(), null, CoreOptions.OutputPathsMode.OFF, fp);
