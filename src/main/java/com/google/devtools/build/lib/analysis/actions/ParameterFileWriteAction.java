...
public final class ParameterFileWriteAction extends AbstractFileWriteAction {
   ...
   * @param configuration the configuration for this action
   */
  public ParameterFileWriteAction(
      ActionOwner owner,
      NestedSet<Artifact> inputs,
    ...
    this(
        ...
        makeExecutable,
        mnemonic,
        configuration::modifiedExecutionInfo,
        PathMappers.getOutputPathsMode(configuration));
  }

  private ParameterFileWriteAction(
      ActionOwner owner,
      NestedSet<Artifact> inputs,
      Artifact output,
      CommandLine commandLine,
    ...
    this.usePathStripping =
        PathMappers.getEffectiveOutputPathsMode(
                outputPathsMode,
                getMnemonic(),
                modifiedExecutionInfo.apply(ImmutableMap.of(), getMnemonic()))
