...
public class SkylarkRepositoryContext
  ...
  private SkylarkExecutionResult executeRemote(
    ...
    try (SilentCloseable c = Profiler.instance().profile(ProfilerTask.STARLARK_REPOSITORY_FN, profileArgsDesc("remote", arguments))) {
  ...
  public SkylarkExecutionResult execute(
    ...
    try (SilentCloseable c =
        Profiler.instance().profile(ProfilerTask.STARLARK_REPOSITORY_FN, profileArgsDesc("local", args))) {
