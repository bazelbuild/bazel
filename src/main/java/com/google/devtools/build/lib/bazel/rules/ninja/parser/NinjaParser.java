    ...
    switch (token) {
      ...
      case BUILD:
        ...
        if (declarationStart == offset) {
          ...
          int fragmentStart = declarationStart - byteFragmentAtOffset.getOffset()
              - fragment.getStartIncl();
          targetFragment = new ByteFragmentAtOffset(byteFragmentAtOffset.getOffset(),
