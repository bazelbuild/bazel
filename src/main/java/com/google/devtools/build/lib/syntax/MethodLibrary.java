...
public class MethodLibrary {
  ...
  @SkylarkCallable(
      ...
      parameters = {
        ...
        @Param(name = "start", type = Integer.class, doc = "start index.", defaultValue = "0", named = true)
      },
      useEnvironment = true)
  public MutableList<?> enumerate(SkylarkList<?> input, Integer start, Environment env) throws EvalException {
    int count = start;
