...
/**
 * Ninja declarations consumer: an instance will be created per a fragment of Ninja file, to avoid
 * synchronization while parsing independent values.
 *
 * Populates the {@link NinjaFileParseResult} with variables and rules.
 */
public class NinjaDeclarationConsumer implements DeclarationConsumer {
  private final NinjaPipeline pipeline;
  private final NinjaFileParseResult parseResult;

  public NinjaDeclarationConsumer(
