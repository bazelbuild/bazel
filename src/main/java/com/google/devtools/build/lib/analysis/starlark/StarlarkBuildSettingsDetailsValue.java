 ...
 *     that setting, including the default of the referenced flag even when it isn't set in the
 *     configuration. Host flag aliases also contribute entries when neither flag is set.
