...
/**
 * This exception gets thrown if {@link Action#execute(ExecutorEngine, ActionExecutionContext)} is
 * unsuccessful. Typically these are re-raised ExecException throwables.
 */
@ThreadSafe
