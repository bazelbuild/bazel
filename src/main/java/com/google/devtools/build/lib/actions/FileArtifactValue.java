...
public abstract class FileArtifactValue implements SkyValue, HasDigest {
   ...
   * its root in {@link RootCodecDependencies} and relativizing.
   */
  ...
  private static final class ResolvedSymlinkArtifactValueCodec
    ...
    public void serialize(
      ...
      ImmutableList<Root> roots =
          context.getDependency(RootCodecDependencies.class).getLikelyPopularRoots();
      ...
      throw new SerializationException(resolvedPath + " is not under any popular roots: " + roots);
    }
    ...
    public ResolvedSymlinkArtifactValue deserialize(
      ...
      Root root =
          context.getDependency(RootCodecDependencies.class).getLikelyPopularRoots().get(rootIndex);
