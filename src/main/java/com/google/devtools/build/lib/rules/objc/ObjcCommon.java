...
public final class ObjcCommon {
  ...
  static class Builder {
    ...
    private Optional<Artifact> swiftModule = Optional.absent();
    ...
    /**
     * Sets the .swiftmodule file generated by this rule to be propagated to direct dependents.
     */
    Builder setSwiftModule(Artifact swiftModule) {
      this.swiftModule = Optional.of(swiftModule);
      return this;
    }
