...
public final class ObjcCompilationContext implements StarlarkValue {
  ...
  ObjcCompilationContext(
    ...
    this.implementationCcCompilationContexts = ImmutableList.copyOf(implementationCcCompilationContexts);
  }
  ...
  @StarlarkMethod(name = "implementation_cc_compilation_contexts", documented = false, structField = true)
