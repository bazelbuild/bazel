...
/**
 * Validates the result of {@link SingleExtensionEvalFunction}. This is done in a
 * separate SkyFunction so that the unvalidated value can be cached, avoiding a re-evaluation of the
