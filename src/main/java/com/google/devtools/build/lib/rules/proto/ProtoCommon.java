...
public class ProtoCommon {
  ...
  private static NestedSet<Pair<Artifact, String>> computeStrictImportableProtosImportPathsForDependents(
      ImmutableList<ProtoInfo> protoDeps, ImmutableList<Pair<Artifact, String>> sourceImportPathPairs) {
  ...
  public static ProtoInfo createProtoInfo(
    ...
    ImmutableList<ProtoInfo> deps = ImmutableList.copyOf(
    ...
    if (library == null) {
      String contextProtoSourceRoot =
          ruleContext
              ...
              .getPathString();
      library = createLibraryWithoutVirtualSourceRoot(contextProtoSourceRoot, originalDirectProtoSources);
    }
    ...
    NestedSet<Artifact> dependenciesDescriptorSets =
        computeDependenciesDescriptorSets(deps);
   ...
   */
  private static NestedSet<Pair<Artifact, String>> computeExportedProtos(ImmutableList<ProtoInfo> exports) {
    NestedSetBuilder<Pair<Artifact, String>> result = NestedSetBuilder.stableOrder();
