...
/**
 * Intermediate tree representation of a list of lexicographically sorted list of files. Each
 * node in the tree represents either a directory or file.
 */
class InputTree {
  ...
  public abstract static class Node {
    ...
    public boolean equals(Object o) {
      ...
      Node other = (Node) o;
      return pathSegment.equals(other.pathSegment);
    }
  }
  ...
  public static class FileNode extends Node {
    ...
    public boolean equals(Object o) {
      ...
      return super.equals(o) && input.equals(other.input) && digest.equals(other.digest);
    }
  }
  ...
  @VisibleForTesting
  public List<DirectoryNode> directoryNodesAtDepth(int depth) {
    List<DirectoryNode> directoryNodes = new ArrayList<>();
    visit((PathFragment dirname, List<FileNode> files, List<DirectoryNode> dirs) -> {
  ...
  @VisibleForTesting
  public List<FileNode> fileNodesAtDepth(int depth) {
  ...
  private static int build(
    ...
    for (Map.Entry<PathFragment, ActionInput> e : inputs.entrySet()) {
      ...
      FileArtifactValue metadata = Preconditions.checkNotNull(metadataProvider.getMetadata(input),
          "missing metadata for " + input.getExecPathString());
