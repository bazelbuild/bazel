...
final class DirectoryTree {
  ...
  static class FileNode extends Node {
    ...
    static FileNode createExecutable(
        String pathSegment, VirtualActionInput virtualActionInput, Digest digest, boolean toolInput) {
      return new FileNode(pathSegment, virtualActionInput, digest, /* isExecutable= */ true, toolInput);
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash(super.hashCode(), path, virtualActionInput, digest, toolInput, isExecutable);
    }
