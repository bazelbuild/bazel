...
public abstract class FileSystem {
   ...
   * specification.
   */
  public abstract boolean isSymbolicLink(PathFragment path);
   ...
   */
  public abstract boolean isDirectory(PathFragment path, boolean followSymlinks);

  /**
   * Returns true iff {@code path} denotes an existing regular or special file. See {@link
   * Path#isFile(Symlinks)} for specification.
   */
  public abstract boolean isFile(PathFragment path, boolean followSymlinks);

  /**
   * Returns true iff {@code path} denotes a special file. See {@link Path#isSpecialFile(Symlinks)}
   * for specification.
   */
  public abstract boolean isSpecialFile(PathFragment path, boolean followSymlinks);
