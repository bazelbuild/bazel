...
public final class RemoteModule extends BlazeModule {
  ...
  public void beforeCommand(CommandEnvironment env) throws AbruptExitException {
    ...
    try {
      credentials =
          createCredentials(CredentialHelperEnvironment.newBuilder()
              ...
              env.getRuntime().getFileSystem(), authAndTlsOptions, remoteOptions);
    } catch (IOException e) {
  ...
  static Credentials createCredentials(
    ...
    Credentials credentials =
        GoogleAuthUtils.newCredentials(
            credentialHelperEnvironment, credentialCache, commandLinePathFactory, fileSystem,
            authAndTlsOptions);
