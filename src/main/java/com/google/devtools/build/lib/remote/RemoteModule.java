...
public final class RemoteModule extends BlazeModule {
  ...
  private final RepositoryRemoteExecutorFactoryDelegate
      repositoryRemoteExecutorFactoryDelegate = new RepositoryRemoteExecutorFactoryDelegate();
    ...
    try {
      ...
      if (enableRemoteExecution) {
        ...
        repositoryRemoteExecutorFactoryDelegate.init(
            new RemoteRepositoryRemoteExecutorFactory(remoteCache, remoteExecutor, digestUtil,
                repoContext, remoteOptions.remoteInstanceName, remoteOptions.remoteAcceptCached));
      } else {
        if (enableDiskCache) {
          cacheClient =
  ...
  private static class RepositoryRemoteExecutorFactoryDelegate implements
