  ...
  public void beforeCommand(CommandEnvironment env) throws AbruptExitException {
    ...
    try {
      ...
      if (enableBlobStoreCache) {
        Retrier retrier = new Retrier(() -> new Backoff() {
          @Override
        ...
        }, (e) -> false, retryScheduler, RemoteRetrier.ALLOW_ALL_CALLS);
        cache =
      ...
      if (remoteOptions.remoteExecutor != null) {
        ...
        RemoteRetrier retrier =
            new RemoteRetrier(
                remoteOptions, RemoteRetrier.RETRIABLE_GRPC_ERRORS, retryScheduler,
                Retrier.ALLOW_ALL_CALLS);
        if (logger != null) {
          ch = ClientInterceptors.intercept(ch, logger);
        }
