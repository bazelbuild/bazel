...
@OptionsClass
public abstract class SandboxOptions extends OptionsBase {
  ...
  public abstract boolean getSandboxDebug();
  ...
  public abstract String getSandboxBase();
  ...
  public abstract boolean getSandboxFakeHostname();
  ...
  public abstract boolean getSandboxFakeUsername();
  ...
  public abstract boolean getSandboxExplicitPseudoterminal();
  ...
  public abstract List<PathFragment> getSandboxTmpfsPath();
  ...
  public abstract List<ImmutableMap.Entry<String, String>> getSandboxAdditionalMounts();
  ...
  @Option(
      ...
      effectTags = {OptionEffectTag.HOST_MACHINE_RESOURCE_OPTIMIZATIONS, OptionEffectTag.EXECUTION},
      help = "No-op")
  public abstract boolean getSandboxfsMapSymlinkTargets();
  ...
  public abstract TriState getUseWindowsSandbox();
  ...
  @Option(
      ...
      help =
          "Registers a sandbox backend: a sandbox strategy implemented by an external binary that"
              ...
              + " The binary is launched lazily as '<binary> [args...] serve' (see"
              + " --sandbox_backend_opt). A backend reports available iff its binary exists and is"
              + " executable; otherwise it declines per-spawn so Bazel falls through to the next"
              + " strategy in --spawn_strategy.")
  ...
  @Option(
      ...
      effectTags = {OptionEffectTag.EXECUTION},
      help =
          "Appends one launch argument to a sandbox backend's server command line. Value is"
              + " <name>=<arg>, matching a backend registered with --sandbox_backend. Repeat to"
              + " pass multiple arguments; each occurrence contributes exactly one token (no"
              + " quoting or splitting). Arguments are opaque to Bazel and forwarded verbatim to"
              + " the backend binary via the Negotiate handshake (not as process arguments).")
  ...
  public abstract boolean getDockerUseCustomizedImages();
  ...
  public abstract boolean getDockerVerbose();
  ...
  @Option(
      ...
      help =
          "If enabled, Bazel will pass the --privileged flag to 'docker run' when running actions. "
              ...
              + "hermeticity.")
  public abstract boolean getDockerPrivileged();
  ...
  @Option(
      ...
      help =
          "Allow network access by default for actions; this may not work with all sandboxing "
              + "implementations.")
  public abstract boolean getDefaultSandboxAllowNetwork();
  ...
  public abstract int getAsyncTreeDeleteIdleThreads();
  ...
  public abstract boolean getReuseSandboxDirectories();
  ...
  public abstract boolean getUseHermetic();
  ...
  public abstract int getMemoryLimitMb();
  ...
  public ImmutableMap<String, Double> getLimitsMap() {
    return ImmutableMap.<String, Double>builder()
        .put("memory", (double) getMemoryLimitMb())
        .putAll(getLimits())
        .buildKeepingLast();
  }
  ...
  public abstract RegexPatternOption getEnforceResources();
  ...
  @Option(
      ...
      help =
          "If true, a loopback device will be set up in the linux-sandbox network namespace for"
              + " local actions.")
  public abstract boolean getSandboxEnableLoopbackDevice();
