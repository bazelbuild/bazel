...
public interface ProtoToolchainInfoApi<FilesToRunProviderApiT extends FilesToRunProviderApi<? extends FileApi>> extends StructApi {
  ...
  @StarlarkBuiltin(
      name = "Provider",
      doc = "",
      // This object is documented via the ProtoToolchainInfo documentation and the docuemntation of its
      // callable function.
      documented = false)
  interface Provider<FilesToRunProviderApiT extends FilesToRunProviderApi<? extends FileApi>> extends ProviderApi {
    @StarlarkMethod(
        name = NAME,
