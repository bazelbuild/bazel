...
@AutoCodec
public final class ModuleExtensionRepoMappingEntriesValue implements SkyValue {
  ...
  public static class Key extends AbstractSkyKey<ModuleExtensionId> {
    ...
    private static final SkyKeyInterner<ModuleExtensionRepoMappingEntriesValue.Key> interner = SkyKey.newInterner();
