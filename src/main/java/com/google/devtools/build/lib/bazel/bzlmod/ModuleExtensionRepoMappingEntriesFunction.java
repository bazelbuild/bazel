...
/**
 * A SkyFunction that computes the {@link RepositoryMapping#entries()} for the repos generated by
 * a module extension. While the repos differ in {@link RepositoryMapping#ownerRepo()}, the entries
...
public class ModuleExtensionRepoMappingEntriesFunction implements SkyFunction {
  ...
  private ModuleExtensionRepoMappingEntriesValue computeRepoMappingEntries(
      ModuleExtensionId extensionId, SingleExtensionEvalValue extensionEvalValue,
      BazelDepGraphValue bazelDepGraphValue) {
    ...
    ModuleKey moduleKey = bazelDepGraphValue.getCanonicalRepoNameLookup()
