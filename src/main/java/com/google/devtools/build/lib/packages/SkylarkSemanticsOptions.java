...
public class SkylarkSemanticsOptions extends OptionsBase implements Serializable {
  ...
  @Option(
      ...
      deprecationWarning = "This behavior is on by default and the flag is a no-op. You can remove its usage",
      help = "This flag is a no-op. The use of the `repo_mapping` attribute in repository rules is enabled by default.")
