 ...
 * SequencedSkyframeExecutor to schedule test execution sequentially after non-test actions. This
...
public class ExclusiveTestStrategy implements TestActionContext {
  ...
  public TestResult newCachedTestResult(
      TestRunnerAction action, TestResultData cached) throws IOException {
    return parent.newCachedTestResult(action, cached);
  }
