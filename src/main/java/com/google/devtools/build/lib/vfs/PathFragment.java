...
public abstract sealed class PathFragment
  ...
  /**
   * Compares this path fragment to another path fragment as sequences of segments.
   *
   * <p>This order has the property that the children of a directory directly succeed it.
   */
  @Override
