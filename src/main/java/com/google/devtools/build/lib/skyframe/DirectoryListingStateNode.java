 ...
 *
 * <p>This class is an implementation detail of {@link DirectoryListingNode}.
 */
final class DirectoryListingStateNode implements Node {

  private final CompactSortedDirents compactSortedDirents;

  private DirectoryListingStateNode(Collection<Dirent> dirents) {
    this.compactSortedDirents = CompactSortedDirents.create(dirents);
  }

  @VisibleForTesting
  public static DirectoryListingStateNode createForTesting(Collection<Dirent> dirents) {
    return new DirectoryListingStateNode(dirents);
  }

  public static DirectoryListingStateNode create(RootedPath dirRootedPath) throws IOException {
  ...
  static NodeKey key(RootedPath rootedPath) {
    return new NodeKey(NodeTypes.DIRECTORY_LISTING_STATE, rootedPath);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof DirectoryListingStateNode)) {
      return false;
    }
    DirectoryListingStateNode other = (DirectoryListingStateNode) obj;
