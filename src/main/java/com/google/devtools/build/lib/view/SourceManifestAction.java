...
public class SourceManifestAction extends AbstractFileWriteAction {
  ...
  public void writeOutputFile(OutputStream out, ErrorEventListener listener,
    ...
    writeFile(out, runfiles.getRunfilesInputs(root, listener, getOwner().getLocation()));
  }
  ...
  public static enum ManifestType implements ManifestWriter {
     ...
     * output is a valid input to {@link com.google.devtools.build.lib.view.SymlinkTreeAction}.
     */
    SOURCE_SYMLINKS {
      @Override
