...
public class RepoOutputFormatter {
  ...
  public void print(String key, RepoDefinition repoDefinition) {
    if (outputFormat == OutputFormat.TEXT) {
      printStarlark(key, repoDefinition);
    } else if (outputFormat == OutputFormat.STREAMED_JSONPROTO) {
      printProtoJson(key, repoDefinition);
    } else if (outputFormat == OutputFormat.STREAMED_PROTO) {
      printStreamedProto(key, repoDefinition);
    }
  }

  private void printStarlark(String key, RepoDefinition repoDefinition) {
    printer.printf("## %s:\n", key);
