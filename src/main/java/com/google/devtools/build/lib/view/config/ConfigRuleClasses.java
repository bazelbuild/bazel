...
public class ConfigRuleClasses {
  ...
  public static final class ConfigSettingRule implements RuleDefinition {
    ...
    public RuleClass build(RuleClass.Builder builder, RuleDefinitionEnvironment env) {
      final String whyNonconfigurable = "part of the rule that *triggers* configurable attributes";
      return builder
          .add(attr(SETTINGS_ATTRIBUTE, STRING_DICT).mandatory()
              .nonconfigurable(whyNonconfigurable))
          .add(attr("tags", Type.STRING_LIST)
              .undocumented("expected of all rules but not important here")
              .nonconfigurable(whyNonconfigurable))
