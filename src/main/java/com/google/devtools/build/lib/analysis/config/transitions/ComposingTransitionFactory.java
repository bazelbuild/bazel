 ...
 */
@AutoValue
public abstract class ComposingTransitionFactory<T extends TransitionFactory.Data> implements TransitionFactory<T> {
  ...
  private static <T extends TransitionFactory.Data> boolean isFinal(TransitionFactory<T> transitionFactory) {
