 ...
 *       command line with the help of
 *       {@link PathStripper#createForAction(boolean, String, PathFragment)}. Action logic should
 ...
 *       staging for execution, with the help of
 *       {@link PathStripper#createForExecutor(Spawn, PathFragment)}.
 * </ol>
 *
...
public final class PathStripper {
   ...
   * @param outputRoot       the root path where outputs are written (e.g. "bazel-out"). Actions
   *                         that don't strip outputs can set this to null.
   */
   ...
   *                   "bazel-out/k8-fastbuild/bin/foo" are reduced to "bazel-out/bin/foo". Else
   *                   they're unchanged.
   ...
   * The executor should use this to correctly stage an action for execution.
   */
