...
/**
 * Node that stores {@link BuildInfoCollection}s generated by {@link BuildInfoFactory} instances.
 * These collections are used during analysis (see {@code CachingAnalysisEnvironment}).
 */
public class BuildInfoCollectionNode extends ActionLookupNode {
  private final BuildInfoCollection collection;

  BuildInfoCollectionNode(BuildInfoCollection collection) {
  ...
  /** Key for BuildInfoCollectionNodes. */
  public static class BuildInfoKeyAndConfig extends ActionLookupKey {
    ...
    @Override
    NodeType getType() {
      return NodeTypes.BUILD_INFO_COLLECTION;
    }
