...
public class GenQueryPackageProviderFactory {
  ...
  @Nullable
  public static GenQueryPackageProvider constructPackageMap(
  ...
  static class BrokenQueryScopeException extends Exception {
