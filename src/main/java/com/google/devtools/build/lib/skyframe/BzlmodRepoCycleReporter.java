...
public class BzlmodRepoCycleReporter implements CyclesReporter.SingleCycleReporter {
  ...
  private static final Predicate<SkyKey> IS_FILE = SkyFunctions.isSkyFunction(FileValue.FILE);
  ...
  public boolean maybeReportCycle(
    ...
    if (Iterables.all(
            ...
            Predicates.or(
                ...
                IS_FILE_STATE))
        && Iterables.any(
            cycle, Predicates.or(IS_REPO_RULE, IS_EXTENSION_IMPL))) {
      ...
      Function<Object, String> printer =
          rawInput -> {
            ...
            } else if (input instanceof FileValue.Key fileKey) {
