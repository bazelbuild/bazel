  ...
  @Option(
      ...
      help =
          "Enables remote cache key scrubbing with the supplied configuration file, which must be a"
              ...
              + "This feature is intended to facilitate sharing a remote cache between actions"
              ...
              + "Scrubbing does not affect how an action is executed, only how its remote cache"
              + " key is computed for the purpose of retrieving or storing an action result."
