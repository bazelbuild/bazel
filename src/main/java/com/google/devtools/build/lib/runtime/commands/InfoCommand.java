  ...
  private static Map<String, InfoItem> getHardwiredInfoItemMap(
    ...
    List<InfoItem> hardwiredInfoItems =
        ImmutableList.<InfoItem>of(
            ...
            new ClientEnv(),
            new BlazeBinInfoItem(productName, commandOptions),
            new BlazeGenfilesInfoItem(productName, commandOptions),
            new BlazeTestlogsInfoItem(productName, commandOptions),
