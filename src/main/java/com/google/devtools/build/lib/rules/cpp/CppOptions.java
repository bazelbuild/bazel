...
public class CppOptions extends FragmentOptions {
  ...
  @Option(
    ...
    help =
        "If enabled, all C++ artifacts (except .def and .obj) generated by cc_library on Windows "
            + "will be renamed to name_{hash} where hash is caculated based on "
            + "the RepositoryName and the package path. This option is useful "
