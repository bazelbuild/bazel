...
public interface RewindableRepoFileSystem {
   ...
   * remote cache.
   *
   * <p>If the file can be recovered by rewinding (in the sense of {@code --rewind_lost_inputs}) the
   * Skyframe node that fetches the repository containing it, returns the canonical name of that
   * repository. Otherwise, returns null.
   */
  @Nullable
