...
public abstract class RepositoryValue implements SkyValue {
  ...
  public static final class SuccessfulRepositoryValue extends RepositoryValue {
     ...
     */
    public SuccessfulRepositoryValue(RepositoryName repositoryName, RepositoryDirectoryValue repository) {
  ...
  public static RepositoryValue success(RepositoryName repositoryName, RepositoryDirectoryValue repository) {
  ...
  public static RepositoryValue notFound(RepositoryName repositoryName) {
    // TODO(ulfjack): Store the cause here? The two possible causes are that the external package contains errors, or
    // that the repository with the given name does not exist.
