...
@AutoValue
public abstract class ProtoToolchainInfo extends NativeInfo implements ProtoToolchainInfoApi<FilesToRunProvider> {
  ...
  public static class ProtoToolchainInfoProvider extends BuiltinProvider<ProtoToolchainInfo> implements ProtoToolchainInfoApi.Provider<FilesToRunProvider> {
