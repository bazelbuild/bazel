...
public interface AnalysisEnvironment extends ActionRegistry {
   ...
   *
   * <p><b>DO NOT USE</b> in rule implementations. Use {@code
   * RuleContext#getPackageRelativeArtifact(PathFragment, ArtifactRoot)} or {@code
   * RuleContext#getUniqueDirectoryArtifact(String, PathFragment, ArtifactRoot)}, or, if there is
   * really no other way, {@code RuleContext#getShareableArtifact(PathFragment, ArtifactRoot)}
   * instead.
   *
   ...
   * method on {@code RuleContext} mentioned above.
   */
