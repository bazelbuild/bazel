...
public final class TreeNodeRepository extends TreeTraverser<TreeNodeRepository.TreeNode> {
  ...
  public static final Symlinks symlinkPolicy = Symlinks.NOFOLLOW;
   ...
   * <ol>
   *   <li>The node is a leaf that represents an artifact file.</li>
   *   <li>The node is a directory optionally associated with an artifact (an "artifact directory").</li>
   *   <li>The node is a leaf that is the descendant of an artifact directory.
   *   In this case, the node is associated with a BasicActionInput, not a full Artifact.</li>
   * </ol>
   */
  @Immutable
  @ThreadSafe
  ...
  private static final TreeNode EMPTY_NODE = new TreeNode(ImmutableList.<TreeNode.ChildEntry>of(), null);
   ...
   */
  public TreeNode buildFromActionInputs(SortedMap<PathFragment, ActionInput> sortedMap) throws IOException {
