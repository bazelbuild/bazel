...
public class ModuleFileGlobals {
  ...
  */
  ...
  @StarlarkMethod(
      name = "override_repo",
      doc =
          "Makes one or more repos in the scope of the current module visible in the scope of the"
              + " given module extension under the specified names. This can be used both to make"
              + " new repos visible to other repos generated by the extension and to override repos"
      ...
      extraPositionals =
          @Param(
              name = "args",
              doc =
                  "The names of the repos to make visible to the other repositories generated by"
                      + " the extension."),
      extraKeywords =
          @Param(
              name = "kwargs",
              doc =
                  "The names of the repos to make visible to the other repositories generated by"
                      + " the extension, where the values are the names of repos in the scope of"
                      + " the current module and the keys are the names under which they will be"
                      + " visible in the scope of the extension."),
      useStarlarkThread = true)
