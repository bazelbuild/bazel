...
public interface RemotePathResolver {
   ...
   * ActionInput}.
   */
  SortedMap<PathFragment, ActionInput> getInputMapping(SpawnExecutionContext context, boolean willAccessRepeatedly)
  ...
  class DefaultRemotePathResolver implements RemotePathResolver {
    ...
    @Override
    public SortedMap<PathFragment, ActionInput> getInputMapping(SpawnExecutionContext context, boolean willAccessRepeatedly)
        throws IOException, ForbiddenActionInputException {
  ...
  class SiblingRepositoryLayoutResolver implements RemotePathResolver {
    ...
    public SortedMap<PathFragment, ActionInput> getInputMapping(SpawnExecutionContext context, boolean willAccessRepeatedly)
      ...
      return context.getInputMapping(PathFragment.create(checkNotNull(getWorkingDirectory())), willAccessRepeatedly);
    }
