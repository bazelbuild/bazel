...
public interface RemotePathResolver {
   ...
   */
  PathFragment localPathToExecPath(Path localPath);
  ...
  class DefaultRemotePathResolver implements RemotePathResolver {
    ...
    @Override
    public PathFragment localPathToExecPath(Path localPath) {
      return localPath.relativeTo(execRoot);
    }
  }
  ...
  class SiblingRepositoryLayoutResolver implements RemotePathResolver {
    ...
    @Override
    public PathFragment localPathToExecPath(Path localPath) {
      return localPath.relativeTo(getBase());
    }
  }
