...
public final class InstrumentedFilesCollector {
  ...
  private NestedSet<Artifact> instrumentationMetadataFiles;
  private NestedSet<Artifact> instrumentedFiles;
  ...
  /**
   * Fills the instrumentedFiles and instrumentationMetadataFiles attributes.
   *
   * <p>Invokes {@link #collect} with builders for the sets as parameters for construction
   * of the sets.
   */
