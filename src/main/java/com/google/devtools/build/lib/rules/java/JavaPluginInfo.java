...
public abstract class JavaPluginInfo extends NativeInfo
  ...
  private static final JavaPluginInfo EMPTY_BUILTIN =
      new AutoValue_JavaPluginInfo(
          ImmutableList.of(), JavaPluginData.empty(), JavaPluginData.empty(), LEGACY_BUILTINS_PROVIDER);
  ...
  public static class RulesJavaProvider extends Provider {
    private RulesJavaProvider() {
      super(
          keyForBuild(Label.parseCanonicalUnchecked("//java/private:java_info.bzl")));
    }
  }
  ...
  public static JavaPluginInfo mergeWithoutJavaOutputs(JavaPluginInfo a, JavaPluginInfo b) {
    return a.isEmpty()
        ...
        : b.isEmpty()
            ? a
            : mergeWithoutJavaOutputs(ImmutableList.of(a, b), a.providerType());
  }

  public static JavaPluginInfo mergeWithoutJavaOutputs(
      Iterable<JavaPluginInfo> providers, com.google.devtools.build.lib.packages.Provider providerType) {
  ...
  static JavaPluginInfo fromStarlarkJavaInfo(StructImpl javaInfo)
    ...
    return new AutoValue_JavaPluginInfo(
        ImmutableList.of(), plugins, apiGeneratingPlugins, /* builtin= */ providerType);
  }
}
