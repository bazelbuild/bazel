...
public class CommandEnvironment {
  ...
  /**
   * Returns the repository environment created from specific client environment variables ({@code PATH}
   * and on Windows {@code PATH_EXT}), {@code --repo_env}, and {@code --action_env=NAME=VALUE} (when
   * {@code --incompatible_repo_env_ignores_action_env=false}).
   */
