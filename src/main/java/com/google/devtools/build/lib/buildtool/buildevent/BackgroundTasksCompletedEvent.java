...
public record BackgroundTasksCompletedEvent(int total, int succeeded) implements BuildEvent {
  @Override
  ...
  public BuildEventStreamProtos.BuildEvent asStreamProto(BuildEventContext context)
    ...
    var backgroundTasksCompletedEvent =
        BuildEventStreamProtos.BackgroundTasksCompletedEvent.newBuilder()
            .setTotal(total)
            .setSucceeded(succeeded)
            .build();
    return GenericBuildEvent.protoChaining(this)
        .setBackgroundTasksCompleted(backgroundTasksCompletedEvent)
        .build();
  }
}
