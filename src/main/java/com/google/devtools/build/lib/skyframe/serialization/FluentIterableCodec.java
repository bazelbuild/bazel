...
/** An {@link ObjectCodec} for {@link FluentIterable}. */
@SuppressWarnings("rawtypes") // Deliberate erasure of FluentIterable.
final class FluentIterableCodec implements ObjectCodec<FluentIterable> {
