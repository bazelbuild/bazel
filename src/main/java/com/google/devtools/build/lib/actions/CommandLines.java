    ...
    public ImmutableList<CommandLineAndParamFileInfo> unpack() {
      return ImmutableList.of(
          new CommandLineAndParamFileInfo(
              toCommandLine(part1, /* hasExecutablePath= */ true), null));
    }
  }
    ...
    public ImmutableList<CommandLineAndParamFileInfo> unpack() {
      return ImmutableList.of(
          new CommandLineAndParamFileInfo(
              toCommandLine(part1, /* hasExecutablePath= */ true), null),
          new CommandLineAndParamFileInfo(
              toCommandLine(part2, /* hasExecutablePath= */ false), part2ParamFileInfo));
    }
  }
    ...
    public ImmutableList<CommandLineAndParamFileInfo> unpack() {
      return ImmutableList.of(
          new CommandLineAndParamFileInfo(
              toCommandLine(part1, /* hasExecutablePath= */ true), null),
          new CommandLineAndParamFileInfo(
              toCommandLine(part2, /* hasExecutablePath= */ false), null),
          new CommandLineAndParamFileInfo(
              toCommandLine(part3, /* hasExecutablePath= */ false), null));
    }
  }
    ...
    public ImmutableList<CommandLineAndParamFileInfo> unpack() {
      return ImmutableList.of(
          ...
          new CommandLineAndParamFileInfo(
              toCommandLine(part2, /* hasExecutablePath= */ false), part2ParamFileInfo),
          new CommandLineAndParamFileInfo(
              toCommandLine(part3, /* hasExecutablePath= */ false), part3ParamFileInfo));
    }
  }
