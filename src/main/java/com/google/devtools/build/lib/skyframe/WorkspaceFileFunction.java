...
public class WorkspaceFileFunction implements SkyFunction {
  ...
  public SkyValue compute(SkyKey skyKey, Environment env)
    ...
    Optional<RootedPath> resolvedFile = Preconditions.checkNotNull(
  ...
  private static StarlarkFile parseWorkspaceFile(RootedPath workspaceFile, FileOptions options, Environment env)
