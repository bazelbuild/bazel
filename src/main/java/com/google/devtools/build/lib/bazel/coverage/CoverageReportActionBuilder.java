...
public final class CoverageReportActionBuilder {
    ...
    if (!coverageArtifacts.isEmpty()) {
      ...
      Artifact lcovArtifact =
          factory.getDerivedArtifact(
              ...
              artifactOwner);
      Action lcovFileAction =
          generateLcovFileWriteAction(lcovArtifact, coverageArtifacts, actionOwner);
  ...
  private static FileWriteAction generateLcovFileWriteAction(
      Artifact lcovArtifact, ImmutableList<Artifact> coverageArtifacts, ActionOwner actionOwner) {
