...
public final class CppCompileActionTemplate implements ActionTemplate<CppCompileAction> {
  ...
  public Iterable<CppCompileAction> generateActionForInputArtifacts(
    ...
    for (TreeFileArtifact inputTreeFileArtifact : sources) {
      try {
        ...
        expandedActions.add(
            createAction(inputTreeFileArtifact, outputTreeFileArtifact, dotdFileArtifact, privateHeaders));
  ...
  private CppCompileAction createAction(
    ...
    buildVariables.overrideStringVariable(
        CompileBuildVariables.SOURCE_FILE.getVariableName(), sourceTreeFileArtifact.getExecPathString());
    buildVariables.overrideStringVariable(
        CompileBuildVariables.OUTPUT_FILE.getVariableName(), outputTreeFileArtifact.getExecPathString());
    buildVariables.overrideStringVariable(
        CompileBuildVariables.OUTPUT_OBJECT_FILE.getVariableName(), outputTreeFileArtifact.getExecPathString());
    buildVariables.overrideStringVariable(
        CompileBuildVariables.DEPENDENCY_FILE.getVariableName(), dotdFileArtifact.getExecPathString());
