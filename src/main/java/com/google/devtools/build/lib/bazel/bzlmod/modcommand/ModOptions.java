...
@OptionsClass
public abstract class ModOptions extends OptionsBase {
  ...
  @Option(
      ...
      help =
          ...
          """)
  public abstract ImmutableList<ModuleArg> getModulesFrom();

  public abstract void setModulesFrom(ImmutableList<ModuleArg> value);
  ...
  @Option(
      ...
      help =
          ...
          """)
  public abstract boolean getIncludeUnused();

  public abstract void setIncludeUnused(boolean value);
  ...
  public abstract ImmutableList<ExtensionArg> getExtensionFilter();

  public abstract void setExtensionFilter(ImmutableList<ExtensionArg> value);
  ...
  @Option(
      ...
      help =
          ...
          """)
  public abstract ExtensionShow getExtensionInfo();

  public abstract void setExtensionInfo(ExtensionShow value);
  ...
  public abstract ModuleArg getBaseModule();

  public abstract void setBaseModule(ModuleArg value);
  ...
  public abstract ImmutableList<ModuleArg> getExtensionUsages();

  public abstract void setExtensionUsages(ImmutableList<ModuleArg> value);
  ...
  public abstract boolean getCycles();

  public abstract void setCycles(boolean value);
  ...
  @Option(
      ...
      help =
          "Include built-in modules in the dependency graph. Disabled by default because it is"
              + " quite noisy.")
  public abstract boolean getIncludeBuiltin();

  public abstract void setIncludeBuiltin(boolean value);
  ...
  public abstract void setCharset(Charset value);
  ...
  public abstract void setOutputFormat(OutputFormat value);
  ...
  @Option(
      ...
      help =
          ...
          """)
  public abstract boolean getAllRepos();

  public abstract void setAllRepos(boolean value);
  ...
  @Option(
      ...
      help =
          ...
          """)
  public abstract boolean getAllVisibleRepos();
  ...
  static ModOptions getDefaultOptions() {
    ModOptions options = Options.getDefaults(ModOptions.class);
    options.setDepth(Integer.MAX_VALUE);
    options.setCycles(false);
    options.setIncludeUnused(false);
    options.setVerbose(false);
    options.setModulesFrom(
        ImmutableList.of(ModuleArg.SpecificVersionOfModule.create(ModuleKey.ROOT)));
    options.setCharset(Charset.UTF8);
    options.setOutputFormat(OutputFormat.TEXT);
    options.setExtensionFilter(null);
    options.setExtensionInfo(ExtensionShow.HIDDEN);
    return options;
  }
}
