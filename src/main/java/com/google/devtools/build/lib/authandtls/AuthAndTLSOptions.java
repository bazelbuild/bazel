...
public class AuthAndTLSOptions extends OptionsBase {
  ...
  @Option(
      ...
      effectTags = {OptionEffectTag.UNKNOWN},
      help =
          "Configures a credential helper conforming to the <a href=\"https://github.com/EngFlow/credential-helper-spec\">Credential Helper Specification</a> to use for retrieving authorization credentials for "
