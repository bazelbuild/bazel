...
public interface JavaInfoApi <FileT extends FileApi> extends StructApi {
  ...
  @SkylarkCallable(
      ...
      doc = "Returns a transitive set of Jars required on the target's runtime classpath. Returns the same as "
          + "<code><a class=\"anchor\" href=\"JavaInfo.html#transitive_runtime_deps\">JavaInfo.transitive_runtime_deps</a></code> "
          + "for legacy reasons.",
      structField = true
  )
  ...
  @SkylarkCallable(
      ...
      doc = "Returns the transitive set of Jars required to build the target. Returns the same as "
          + "<code><a class=\"anchor\" href=\"JavaInfo.html#transitive_deps\">JavaInfo.transitive_deps</a></code> "
          + "for legacy reasons.",
      structField = true)
  ...
  @SkylarkCallable(
      name = "compile_jars",
      doc =
          "Returns the Jars required by this target directly at compile time. They can be interface jars "
          + "(ijar or hjar), regular jars or both, depending on whether rule implementations chose to create "
          + "interface jars or not.",
      structField = true)
  ...
  @SkylarkCallable(
      ...
      doc =
          "Returns the regular, full compile time Jars required by this target directly. They can be"
              + " <ul><li> the corresponding regular Jars of the interface Jars returned by"
              + " <code><a class=\"anchor\" href=\"JavaInfo.html#compile_jars\">JavaInfo.compile_jars</a></code></li>"
              + "<li> the regular (full) Jars returned by"
              + " <code><a class=\"anchor\" href=\"JavaInfo.html#compile_jars\">JavaInfo.compile_jars</a></code></li></ul>"
              + "<p>Note: <code><a class=\"anchor\" href=\"JavaInfo.html#compile_jars\">JavaInfo.compile_jars</a></code> "
              + "can return a mix of interface Jars and regular Jars."
              + "<p>Only use this method if interface Jars don't work with your rule set(s) (e.g. some Scala targets)"
              + " If you're working with Java-only targets it's preferable to use interface Jars via "
              + "<code><a class=\"anchor\" href=\"JavaInfo.html#compile_jars\">JavaInfo.compile_jars</a></code></li>",
      structField = true)
  ...
  @SkylarkCallable(
      name = "source_jars",
      doc = "Returns a list of Jars with all the source files (including those generated by annotations) of the target "
              + " itself, i.e. NOT including the sources of the transitive dependencies.",
      structField = true
  )
  ...
  @SkylarkCallable(
    ...
    doc = "Returns the transitive set of Jars required to build the target. Returns the same as "
          + "<code><a class=\"anchor\" href=\"JavaInfo.html#transitive_compile_time_jars\">JavaInfo.transitive_compile_time_jars</a></code> "
          + "for legacy reasons.",
    structField = true
  )
  ...
  @SkylarkCallable(
    ...
    doc = "Returns the transitive set of Jars required on the target's runtime classpath. Returns the same as "
            + "<code><a class=\"anchor\" href=\"JavaInfo.html#transitive_runtime_jars\">JavaInfo.transitive_runtime_jars</a></code>"
            + " for legacy reasons.",
    structField = true
  )
  ...
  @SkylarkCallable(
    ...
    doc = "Returns the Jars containing source files of the current target and all of its transitive dependencies.",
    structField = true
  )
