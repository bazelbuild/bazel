...
import com.google.devtools.build.lib.skyframe.SequencedSkyframeExecutor.SkyframeTransitivePackageLoader;
...
final class SkyframeLabelVisitor implements TransitivePackageLoader {
  ...
  public void trimErrorTracking() {
    // Skyframe will incrementally update error bits and root causes, so we should not clear that
    // state here.
  }
}
