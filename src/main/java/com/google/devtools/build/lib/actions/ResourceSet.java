...
public class ResourceSet implements ResourceSetOrBuilder {
   ...
   * resources in order. Entries in later maps replace earlier ones and this set's resources;
   * {@code localTestCount} and {@code workerKey} are preserved. Returns {@code this} if all
   * override maps are empty.
   */
  @SafeVarargs
