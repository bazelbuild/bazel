...
/** Prints a label with type and configuration pair per result. */
public class LabelKindAndConfigurationOutputFormatterCallback extends CqueryThreadsafeCallback {

  private ConfiguredTargetAccessor configuredTargetAccessor;

  public LabelKindAndConfigurationOutputFormatterCallback(
    ...
    this.configuredTargetAccessor = configuredTargetAccessor;
  }
  ...
  public void processOutput(Iterable<ConfiguredTarget> partialResult) {
    for (ConfiguredTarget configuredTarget : partialResult) {
      ...
      StringBuilder output =
          new StringBuilder()
              .append(configuredTargetAccessor.getTargetKind(configuredTarget))
              .append(' ')
