...
public record SingleExtensionValue(
  ...
  /**
   * Returns the canonical repo name for a repo generated by an extension. All names in {@link
   * #canonicalRepoNameToInternalNames} follow this format.
   */
  public static RepositoryName repositoryName(String extensionUniqueName, String internalName) {
