...
final class StarlarkPath implements StarlarkValue {
  ...
  @StarlarkMethod(
      ...
      extraPositionals = @Param(
          name = "relative_paths",
          doc = "Zero or more relative path strings to append to this path with path separators"
              + "added as needed."
      )
  )
  public StarlarkPath getChild(Tuple relativePaths) throws EvalException {
    return new StarlarkPath(
        path.getRelative(String.join(Character.toString(PathFragment.SEPARATOR_CHAR),
