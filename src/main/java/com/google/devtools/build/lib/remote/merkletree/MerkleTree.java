...
public class MerkleTree {
   ...
   *
   * @param inputs a map of path to input. The map is required to be sorted lexicographically
   *               by paths. Inputs of type tree artifacts are not supported and are expected
   *               to have been expanded before.
   * @param metadataProvider provides metadata for all {@link ActionInput}s in {@code inputs},
   *                         as well as any {@link ActionInput}s being discovered via directory
   *                         expansion.
