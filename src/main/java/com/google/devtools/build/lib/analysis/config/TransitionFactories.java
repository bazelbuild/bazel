...
public final class TransitionFactories {
  ...
  public static <T extends TransitionFactory.Data> TransitionFactory<T> of(ConfigurationTransition transition) {
  ...
  public static <T extends TransitionFactory.Data> TransitionFactory<T> split(SplitTransition splitTransition) {
  ...
  @AutoValue
  abstract static class IdentityFactory<T extends TransitionFactory.Data> implements TransitionFactory<T> {
  ...
  @AutoValue
  abstract static class SplitTransitionFactory<T extends TransitionFactory.Data> implements TransitionFactory<T> {
