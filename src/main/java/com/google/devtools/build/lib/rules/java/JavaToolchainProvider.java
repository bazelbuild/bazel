...
public final class JavaToolchainProvider extends StarlarkInfoWrapper {
  ...
  public static final StarlarkProviderWrapper<JavaToolchainProvider> RULES_JAVA_PROVIDER = new RulesJavaProvider();
  ...
  private static class RulesJavaProvider extends Provider {
    private RulesJavaProvider() {
      super(
          keyForBuild(Label.parseCanonicalUnchecked("//java/common/rules:java_toolchain.bzl")));
    }
  }
