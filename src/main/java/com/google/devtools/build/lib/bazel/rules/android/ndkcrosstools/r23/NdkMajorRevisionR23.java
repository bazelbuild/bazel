...
/** Logic specific to Android NDK R23. */
public class NdkMajorRevisionR23 implements NdkMajorRevision {
  private final String clangVersion;

  public NdkMajorRevisionR23(String clangVersion) {
  ...
  public CrosstoolRelease crosstoolRelease(
    ...
    return AndroidNdkCrosstoolsR23.create(ndkPaths, stlImpl, hostPlatform, clangVersion);
  }

  @Override
  public ApiLevel apiLevel(EventHandler eventHandler, String name, String apiLevel) {
    return new ApiLevelR23(eventHandler, name, apiLevel);
  }
}
