...
final class RemoteRewoundActionSynchronizer implements RewoundActionSynchronizer {
  /** A cancellable task that operates on the outputs of an action. */
  public interface Cancellable {
    /**
     * Cancels the task and returns only once it no longer accesses the outputs of the action it has
     * been registered for, which are about to be regenerated by a rewound execution of that action.
     *
     * <p>May be called after the task has completed, in which case it returns immediately.
     */
