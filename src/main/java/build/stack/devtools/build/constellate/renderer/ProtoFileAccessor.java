...
/**
 * Helper to handle Proto file I/O. This abstraction is useful for tests which
 * don't involve actual
 * file I/O.
 */
public interface ProtoFileAccessor {
   ...
   *
   * @param inputPathString the path of the input raw
   *                        {@link StarlarkLanguageProtos} file.
   */
  ...
  /**
   * Creates a {@link FileOutputStream} and writes the bytes to the output
   * location.
   *
