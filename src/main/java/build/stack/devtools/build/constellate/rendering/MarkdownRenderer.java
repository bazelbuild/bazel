...
/**
 * Produces output in markdown form.
 */
public class MarkdownRenderer {
  // TODO(kendalllane): Refactor MarkdownRenderer to take in something other than
  // filepaths.
  ...
  /**
   * Returns a markdown header string that should appear at the top of
   * StarlarkBazel's output, providing a
  ...
  /**
   * Returns a markdown rendering of rule documentation for the given rule
   * information object with
   * the given rule name.
   */
  ...
  /**
   * Returns a markdown rendering of provider documentation for the given provider
   * information
  ...
  /**
   * Returns a markdown rendering of a user-defined function's documentation for
   * the function info
   * object.
   */
  ...
  /**
   * Returns a markdown rendering of aspect documentation for the given aspect
   * information object
