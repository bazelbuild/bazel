...
/**
 * Proxy implementation of {@link StarlarkRuleFunctionsApi}.
 *
 * <p>
 ...
 * </p>
 */
public class ProxyStarlarkRuleFunctionsApi<FileApiT> implements StarlarkRuleFunctionsApi<FileApiT extends FileApi>
{
   ...
   *                         information will be added
   */
  public ProxyStarlarkRuleFunctionsApi(
  ...
  public ProviderApi provider(String doc, Object fields, StarlarkThread thread)
    ...
    logger.atInfo().log("FakeAPI: provider %s: %s", 
  ...
  public StarlarkCallable rule(
    ...
    logger.atInfo().log("FakeAPI: rule %s (aka %s): %s",
  ...
  public StarlarkAspectApi aspect(
    ...
    logger.atInfo().log("FakeAPI: aspect %s: %s",
        wrapper.getIdentifierFunction().getName(),
        wrapper.getLocation());
