...
public class FakeDeepStructure extends FakeProviderApi implements Structure, StarlarkCallable, StarlarkIndexable {
  ...
  public Object call(StarlarkThread thread, Tuple args, Dict<String, Object> kwargs) {
    logger.atInfo().log("%s: args=%s, kwargs=%s", thread.getCallerLocation(), args, kwargs);
