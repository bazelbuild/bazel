...
public @interface StarlarkBuiltin {
  ...
  /**
   * If non-empty, the {@link net.starlark.java.syntax.StarlarkType#typeRepr string representation}
   * of the auto-generated {@link net.starlark.java.syntax.StarlarkType} for this builtin. If empty,
   * the auto-generated type name is the same as {@link #name()}.
   *
   ...
   *
   * <ul>
   *   <li>For any class implementing this class or interface, and whose most-derived {@link
   *       StarlarkBuiltin} annotation is *not* this one, the Starlark type auto-generated by {@link
   *       net.starlark.java.eval.CallUtils} will be marked as assignable to a {@link
   *       net.starlark.java.syntax.Types.StructType}.
   *   <li>For any class or interface whose most-derived {@link StarlarkBuiltin} annotation *is*
   *       this one, the corresponding Starlark type will be plain {@code struct} (a type assignable
   *       to and from any other struct type).
   * </ul>
   */
