...
public @interface StarlarkBuiltin {
  ...
  /**
   * Whether this class or interface denotes a struct. If true, has two effects:
   *
   * <ul>
   *   <li>For any class implementing this type, the Starlark type auto-generated by {@link
   *       net.starlark.java.eval.CallUtils} will be marked as assignable to a {@link
   *       net.starlark.java.syntax.Types.StructType}.
   *   <li>When translating a {@link StarlarkMethod} annotation into a Starlark type, returns/args
