...
public class StarlarkDict<K, V>
  ...
  private StarlarkDict(@Nullable Mutability mutability, LinkedHashMap<K, V> contents) {
    this.mutability = mutability == null ? Mutability.IMMUTABLE : mutability;
    this.contents = contents;
  }

  private StarlarkDict(@Nullable Mutability mutability) {
   ...
   */
  static <K, V> StarlarkDict<K, V> wrap(@Nullable Mutability mutability, LinkedHashMap<K, V> contents) {
    return new StarlarkDict<>(mutability, contents);
  }

  /** Returns a new empty dict with the specified mutability. */
  public static <K, V> StarlarkDict<K, V> of(@Nullable Mutability mu) {
    return new StarlarkDict<>(mu);
  }

  public static <K, V> StarlarkDict<K, V> copyOf(@Nullable Mutability mu,
      Map<? extends K, ? extends V> m) {
    if (mu == null && m instanceof StarlarkDict && ((StarlarkDict) m).isImmutable()) {
      @SuppressWarnings("unchecked")
      StarlarkDict<K, V> dict = (StarlarkDict<K, V>) m; // safe
      return dict;
    }

    StarlarkDict<K, V> dict = new StarlarkDict<>(mu);
  ...
  public static <K, V> StarlarkDict<K, V> immutableCopyOf(Map<? extends K, ? extends V> m) {
    return copyOf(null, m);
  }

  /** Returns a new empty StarlarkDict.Builder. */
  ...
  public void update(Object pairs, Dict<String, Object> kwargs, StarlarkThread thread)
    ...
    StarlarkDict.update("update", dict, pairs, kwargs);
  }
   ...
   */
  @Override
  public V removeEntry(Object key) throws EvalException {
    Starlark.checkMutable(this);
  ...
  public static final class Builder<K, V> {
     ...
     */
    public StarlarkDict<K, V> build(@Nullable Mutability mu) {
      int n = items.size() / 2;
    ...
    public StarlarkDict<K, V> buildImmutable() {
      return build(null);
    }
  }
}
