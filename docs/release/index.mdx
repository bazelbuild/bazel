...
| Bazel 8 | Maintenance| [8.8.1](https://github.com/bazelbuild/bazel/releases/tag/8.8.1) | Dec 2027 |
...
*   Rolling releases can ship incompatible changes. Incompatible flags are
    ...
    should follow our [backward compatibility policy](/release/backward-compatibility).
...
Bazel versions, please check out the [Rule Compatibility](/release/rule-compatibility) page.
