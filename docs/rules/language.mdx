...
[lists](/rules/lib/core/list) and [dicts](/rules/lib/core/dict). Changes to mutable
...
[Native functions](/reference/be/functions) and [native rules](/reference/be/overview#language-specific-native-rules) are global symbols in
