...
IMPORTANT: This tutorial is for [*legacy macros*](/versions/8.1.0/extending/legacy-macros). If
...
creating a [rule](/versions/8.1.0/extending/rules). Rules give you more control and flexibility.
...
"/versions/8.1.0//other/package:image.png"`, or even `src = select(...)`?
...
if possible, instead using [symbolic macros](/versions/8.1.0/extending/macros), which have
