...
description is available in [Output directory layout](/versions/8.1.0/remote/output-directories).
...
4.  Starlark rules can also define their own options (see
    [here](/versions/8.1.0/extending/config))
...
available [here](/versions/8.1.0/reference/skyframe).
...
3.  Storing state between restarts, either using
    ...
    [`StateMachine`s](/versions/8.1.0/contribute/statemachine-guide) were introduced for a
...
[here](/versions/8.1.0/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available [here](/versions/8.1.0/rules/language).
...
[here](/versions/8.1.0/extending/aspects). A good
...
[here](/versions/8.1.0/extending/platforms))
...
[here](/versions/8.1.0/extending/toolchains)).
...
[visibility](/versions/8.1.0/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/8.1.0/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/8.1.0/query/guide)
...
[external dependencies overview](/versions/8.1.0/external/overview) for more up-to-date
information.
