...
Several SkyFunction classes implement the [toolchain resolution](/versions/6.0.0/extending/toolchains) process:
...
As discussed in [Toolchains and Configurations](/versions/6.0.0/extending/toolchains#toolchains_and_configurations),
