...
*   *Recommended*: [Use Bazelisk](/versions/6.0.0/install/bazelisk)
*   [Use our custom APT repository](#install-on-ubuntu)
*   [Use the binary installer](#binary-installer)
*   [Compile Bazel from source](/versions/6.0.0/install/compile-source)
...
*   Access the [bash completion script](/versions/6.0.0/install/completion#bash)
*   Install the [zsh completion script](/versions/6.0.0/install/completion#zsh)
