...
[Bazelisk](/versions/6.0.0/install/bazelisk) is the recommended way to install Bazel on [Ubuntu Linux](/versions/6.0.0/install/ubuntu), [macOS](/versions/6.0.0/install/os-x), and [Windows](/versions/6.0.0/install/windows).
...
*   [Fedora 25, 26, 27, 28, and CentOS 7](/versions/6.0.0/install/redhat)
...
*   [openSUSE](/versions/6.0.0/install/suse)
...
For other platforms, you can try to [compile from source](/versions/6.0.0/install/compile-source).
