...
![bep-graph](/versions/6.0.0/docs/images/bep-graph.png "BEP graph")
...
pairs. When building with [aspects](/versions/6.0.0/extending/aspects) enabled, Bazel
...
event, which matches the structure of a Starlark [Depset](/versions/6.0.0/extending/depsets).
...
![namedsetoffiles-bep-graph](/versions/6.0.0/docs/images/namedsetoffiles-bep-graph.png "NamedSetOfFiles BEP graph")
