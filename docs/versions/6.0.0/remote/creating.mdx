...
[Persistent workers](/versions/6.0.0/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/6.0.0/remote/multiplex).
...
[Implementing persistent workers](/versions/6.0.0/remote/persistent#implementation).
