...
[LTS major version](/versions/6.0.0/release/versioning#lts-releases) are fully backward-compatible.
...
* [For Bazel users - how to update Bazel](/versions/6.0.0/install/bazelisk)
* [For contributors - best practices for incompatible changes](/versions/6.0.0/contribute/breaking-changes)
