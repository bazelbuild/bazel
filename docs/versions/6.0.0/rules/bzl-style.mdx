...
[Starlark](/versions/6.0.0/rules/language) is a
...
*   Follow [testing guidelines](/versions/6.0.0/rules/testing).
...
Since
[Starlark is not Python](/versions/6.0.0/rules/language#differences-with-python),
...
See also [macros](/versions/6.0.0/extending/macros#conventions).
...
*   Pass information between your rules using a well-defined
    [provider](/versions/6.0.0/extending/rules#providers) interface. Declare and document provider
    fields.
*   Design your rule with extensibility in mind. Consider that other rules might
    ...
    actions you create.
*   Follow [performance guidelines](/versions/6.0.0/rules/performance) in your rules.
