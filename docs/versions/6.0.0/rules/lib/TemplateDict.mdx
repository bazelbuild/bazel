      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
            ...
            <td>
                          <code>callable</code>;
                                     required<br/>
                          A Starlark function accepting a single argument and returning a String. This function is applied to each item of the depset specified in the <code>values</code> parameter
            </td>
          </tr>
                  <tr>
