...
<ul>
    ...
    <a href="#to_list">to_list</a>
      ...
      <h2 id="to_list">to_list</h2>
        <p><pre class="rule-signature"><a class="anchor" href="list">list</a> depset.to_list()</pre></p>
