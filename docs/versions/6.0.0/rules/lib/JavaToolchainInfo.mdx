...
<ul>
    ...
    The artifact that enforces One-Version compliance of java binaries.

         May return <code>None</code>.

        <h2 id="single_jar">single_jar</h2>
        <p><pre class="rule-signature"><a class="anchor" href="File.html">File</a> JavaToolchainInfo.single_jar</pre></p>
