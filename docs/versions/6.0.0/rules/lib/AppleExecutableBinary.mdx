...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="binary">binary</h2>
        <p><pre class="rule-signature"><a class="anchor" href="File.html">File</a> AppleExecutableBinary.binary</pre></p>

    The executable binary file output by apple_binary.


        <h2 id="cc_info">cc_info</h2>
        <p><pre class="rule-signature"><a class="anchor" href="CcInfo.html">CcInfo</a> AppleExecutableBinary.cc_info</pre></p>

    A provider which contains information about the transitive dependencies linked into the binary.


        <h2 id="objc">objc</h2>
        <p><pre class="rule-signature"><a class="anchor" href="ObjcProvider.html">ObjcProvider</a> AppleExecutableBinary.objc</pre></p>

    A provider which contains information about the transitive dependencies linked into the binary.


        <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> AppleExecutableBinary.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> AppleExecutableBinary.to_proto()</pre></p>
