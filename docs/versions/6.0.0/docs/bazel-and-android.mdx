...
*  [Tutorial: Building an Android app](/versions/6.0.0/start/android-app ). This
...
*  [Android rules](/versions/6.0.0/reference/be/android). The Build Encyclopedia describes the rules
   for building and testing Android apps with Bazel.
*  [Integration with Android Studio](/versions/6.0.0/install/ide). Bazel is compatible with
   Android Studio using the [Android Studio with Bazel](https://ij.bazel.build/)
   plugin.
*  [`mobile-install` for Android](/versions/6.0.0/docs/mobile-install). Bazel's `mobile-install`
...
*  [Android instrumentation testing](/versions/6.0.0/docs/android-instrumentation-test) on
   emulators and devices.
*  [Android NDK integration](/versions/6.0.0/docs/android-ndk). Bazel supports compiling to
   native code through direct NDK integration and the C++ rules.
*  [Android build performance](/versions/6.0.0/docs/android-build-performance). This page
