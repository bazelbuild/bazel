...
[built-in repository rules](/versions/6.0.0/reference/be/workspace) and a set of
[embedded Starlark repository rules](/versions/6.0.0/rules/lib/repo/index).
Users can also write [custom repository rules](/versions/6.0.0/extending/repo)
