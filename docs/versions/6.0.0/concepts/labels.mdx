...
[target patterns](/versions/6.0.0/run/build#specifying-build-targets).
...
[Bazel Query Language](/versions/6.0.0/query/language).
...
outputs as described in the [Build Encyclopedia](/versions/6.0.0/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/6.0.0/reference/be/overview) for a
...
[General Rules: genrule](/versions/6.0.0/reference/be/general#genrule).
...
[Bazel Query tool](/versions/6.0.0/query/quickstart) operates.

<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/6.0.0/concepts/build-ref">
