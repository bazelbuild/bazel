...
description is available in [Output directory layout](/versions/6.0.0/remote/output-directories).
...
4.  Starlark rules can also define their own options (see
    [here](/versions/6.0.0/extending/config))
...
available [here](/versions/6.0.0/reference/skyframe).
...
[here](/versions/6.0.0/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available
[here](/versions/6.0.0/rules/language).
...
[here](/versions/6.0.0/extending/aspects). A good
...
[here](/versions/6.0.0/extending/platforms))
...
[here](/versions/6.0.0/extending/toolchains)).
...
[visibility](/versions/6.0.0/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/6.0.0/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/6.0.0/query/quickstart)
...
[Build Event Protocol](/versions/6.0.0/remote/bep)
