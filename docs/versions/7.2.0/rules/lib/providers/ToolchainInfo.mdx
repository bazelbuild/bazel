...
Provider returned by <a href="/versions/7.2.0/docs/toolchains#defining-toolchains">toolchain rules</a> to share data with <a href="/versions/7.2.0/docs/toolchains#writing-rules-that-use-toolchains">rules which depend on toolchains</a>. Read about <a href='/versions/7.2.0/docs/toolchains'>toolchains</a> for more information.
...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> ToolchainInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> ToolchainInfo.to_proto()</pre></p>
