...
<ul>
    ...
    Checks if a target exists in a package group.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> PackageSpecificationInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> PackageSpecificationInfo.to_proto()</pre></p>
