...
See the
[Bazel](/versions/7.2.0/start/) and [Starlark](/versions/7.2.0/extending/concepts) documentation for
...
To analyze the targets, use the [`cquery`](/versions/7.2.0/query/cquery) ("configured
...
[`exports_files`](/versions/7.2.0/reference/be/functions#exports_files):
...
*   Take a look at the [reference documentation for rules](/versions/7.2.0/extending/rules#contents).
*   Get familiar with [depsets](/versions/7.2.0/extending/depsets).
