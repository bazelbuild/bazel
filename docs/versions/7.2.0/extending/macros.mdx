...
[loading phase](/versions/7.2.0/extending/concepts#evaluation-model), macros don't exist anymore,
...
Note: `$@` is a [Make variable](/versions/7.2.0/reference/be/make-variables#predefined_genrule_variables)
...
instantiated from the [native](/versions/7.2.0/rules/lib/toplevel/native) module:
...
macro), use the function [native.package_name()](/versions/7.2.0/rules/lib/toplevel/native#package_name).
...
[`Label`](/versions/7.2.0/rules/lib/builtins/Label#Label) constructor:
...
*   You can also use [print](/versions/7.2.0/rules/lib/globals/all#print) for debugging. It displays
...
If you want to throw an error, use the [fail](/versions/7.2.0/rules/lib/globals/all#fail) function.
