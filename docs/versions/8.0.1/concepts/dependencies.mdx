...
<table class="cyan">
  ...
  <tr>
    <td><pre>rule(name = "a", srcs = "a.in", deps = "//b:b",)</pre></td>
    <td><pre>rule(name = "b", srcs = "b.in", deps = "//c:c",)</pre></td>
  </tr>
  <tr class="alt">
  ...
  <tr>
    <td><pre>import b; b.foo();</pre></td>
    <td><pre>import c; function foo() &#123; c.bar(); &#125;</pre></td>
  </tr>
  <tr>
    <td><figure>
        <img src="/versions/8.0.1/docs/images/a_b_c.svg"
...
<table class="cyan">
  ...
  <tr>
    <td><pre>import b; import c; b.foo(); c.garply();</pre></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><figure>
    ...
    <td><figure>
        <img src="/versions/8.0.1/docs/images/a_b_c_ac.svg"
...
<table class="cyan">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><pre>rule(name = "b", srcs = "b.in", <strong>deps = "//d:d",</strong>)</pre></td>
  </tr>
  <tr class="alt">
    <td>&nbsp;</td>
    <td><code>b / b.in</code></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><pre>import d; function foo() &#123; d.baz(); &#125;</pre></td>
  </tr>
  <tr>
    <td><figure>
        <img src="/versions/8.0.1/docs/images/ab_c.svg"
    ...
    <td><figure>
        <img src="/versions/8.0.1/docs/images/a_b_a_c.svg"
...
more details, see
[Attributes common to all rules](/versions/8.0.1/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/8.0.1/reference/be/).
...
[`glob()`](/versions/8.0.1/reference/be/functions#glob) function. (Use `**` to force the
...
conform to the [label syntax](/versions/8.0.1/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/8.0.1/reference/be/functions#glob) function produces an invalid labels
