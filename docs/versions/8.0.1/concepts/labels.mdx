...
name](/versions/8.0.1/external/overview#canonical-repo-name), which is unique within
...
labels with an [*apparent* repo name](/versions/8.0.1/external/overview#apparent-repo-name),
which looks like:
...
[target patterns](/versions/8.0.1/run/build#specifying-build-targets).
...
[Bazel Query Language](/versions/8.0.1/query/language).
...
outputs as described in the [Build Encyclopedia](/versions/8.0.1/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/8.0.1/reference/be/overview) for a
...
[General Rules: genrule](/versions/8.0.1/reference/be/general#genrule).
...
<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.0.1/concepts/build-ref">
