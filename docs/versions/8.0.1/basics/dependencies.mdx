...
[![Transitive
dependencies](/versions/8.0.1/images/transitive-dependencies.png)](/versions/8.0.1/images/transitive-dependencies.png)
...
overview](/versions/8.0.1/external/overview) for more details.
