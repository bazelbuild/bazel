...
* Consulting a [Bazel community expert](/versions/8.0.1/community/experts)

## Understand Bazel's support level

Please read the [release page](/versions/8.0.1/release) to understand Bazel's release model and
