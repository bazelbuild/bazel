...
<head>
  ...
  <meta name="book_path" value="/versions/8.0.1/_book.yaml">
</head>
<body>
...
<a href="https://bazel.build/versions/8.0.1/docs/sandboxing">sandboxing documentation</a>.
...
see <a href="https://bazel.build/versions/8.0.1/run/scripts#output-base-option">Choosing the output base</a>.
</aside>
