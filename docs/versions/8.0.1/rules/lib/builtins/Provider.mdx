...
* It is a *key* to access a provider instance on a [Target](/versions/8.0.1/rules/lib/builtins/Target)
...
Create a new `Provider` using the [provider](/versions/8.0.1/rules/lib/globals/bzl#provider) function.