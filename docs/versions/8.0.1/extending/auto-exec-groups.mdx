...
Rule `my_rule` registers two toolchain types. This means that the [Toolchain Resolution](https://bazel.build/versions/8.0.1/extending/toolchains#toolchain-resolution) used
