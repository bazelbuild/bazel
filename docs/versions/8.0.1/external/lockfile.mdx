...
[`--lockfile_mode`](/versions/8.0.1/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/8.0.1/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/8.0.1/release/backward-compatibility)
