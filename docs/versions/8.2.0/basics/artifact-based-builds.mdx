...
[build configurations](/versions/8.2.0/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/8.2.0/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/8.2.0/docs/sandboxing)_. On supported
