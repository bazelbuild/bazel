...
[recommended rules](/versions/8.2.0/rules).
...
After a review by the [Bazel core team](/versions/8.2.0/contribute/policy), it
...
*   The ruleset follows the best practices and is performant (see
    [the performance guide](/versions/8.2.0/rules/performance)).
