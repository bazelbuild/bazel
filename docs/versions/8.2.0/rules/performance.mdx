...
See the [depset overview](/versions/8.2.0/extending/depsets) page for more information.
...
The [JSON trace profile](/versions/8.2.0/advanced/performance/json-trace-profile) can be very
useful to quickly understand what Bazel spent time on during the invocation.

The [`--experimental_command_profile`](https://bazel.build/versions/8.2.0/reference/command-line-reference#flag--experimental_command_profile)
...
The [`--starlark_cpu_profile`](https://bazel.build/versions/8.2.0/reference/command-line-reference#flag--starlark_cpu_profile)
