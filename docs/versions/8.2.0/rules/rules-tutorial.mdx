...
See the
[Bazel](/versions/8.2.0/start/) and [Starlark](/versions/8.2.0/extending/concepts) documentation for
...
To analyze the targets, use the [`cquery`](/versions/8.2.0/query/cquery) ("configured
...
[`exports_files`](/versions/8.2.0/reference/be/functions#exports_files):
...
*   Take a look at the [reference documentation for rules](/versions/8.2.0/extending/rules#contents).
*   Get familiar with [depsets](/versions/8.2.0/extending/depsets).
