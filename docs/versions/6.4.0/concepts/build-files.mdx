...
For more details, see [Hermeticity](/versions/6.4.0/concepts/hermeticity).
...
The first argument of `load` is a [label](/versions/6.4.0/concepts/labels) identifying a
...
You can use [load visibility](/versions/6.4.0/concepts/visibility#load-visibility) to restrict
...
[Build Encyclopedia](/versions/6.4.0/reference/be/overview), but it is possible
...
<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/6.4.0/concepts/labels">
        <span class="material-icons" aria-hidden="true">arrow_back</span>Labels</a>
    </td>
    <td><a class="button button-with-icon button-primary"
           href="/versions/6.4.0/concepts/dependencies">
