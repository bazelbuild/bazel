...
* Targets can be [skipped](/versions/6.4.0/docs/platforms#skipping-incompatible-targets) in the
...
To learn how to use the configuration flags, see the [Bazel and Java](/versions/6.4.0/docs/bazel-and-java) manual.
...
[toolchains documentation](/versions/6.4.0/docs/toolchains) for a good walkthrough.
