...
This object holds information about the environment in which the build is running. See the <a href='https://bazel.build/versions/6.4.0/rules/rules#configurations'>Rules page</a> for more on the general concept of configurations.
