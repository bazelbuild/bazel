...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> ProtoRegistryProvider.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> ProtoRegistryProvider.to_proto()</pre></p>
