...
A container of information regarding a set of files required at runtime execution. This object should be passed via <a href="DefaultInfo.html">DefaultInfo</a> in order to tell the build system about the runfiles needed by the outputs produced by the rule. <p>See <a href="https://bazel.build/versions/6.4.0/rules/rules#runfiles">runfiles guide</a> for details.
