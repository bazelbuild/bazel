...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="proto">proto</h2>
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> CcToolchainConfigInfo.proto</pre></p>

    Returns CToolchain text proto from the CcToolchainConfigInfo data.


        <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> CcToolchainConfigInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> CcToolchainConfigInfo.to_proto()</pre></p>
