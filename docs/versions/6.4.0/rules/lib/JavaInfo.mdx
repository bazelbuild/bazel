      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
            ...
            <td>
                          <code><a class="anchor" href="list.html">sequence</a> of <a class="anchor" href="JavaInfo.html">JavaInfo</a>s</code>;
                                     default = []<br/>
                          Libraries to make available for users of this library. See also <a class="anchor" href="/versions/6.4.0/reference/be/java.html#java_library.exports">java_library.exports</a>.
            </td>
          </tr>
                  <tr>
