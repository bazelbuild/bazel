...
A provider that indicates what output groups a rule has.<br>See <a href="https://bazel.build/versions/6.4.0/rules/rules#requesting_output_files">Requesting output files</a> for more information.
...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="OutputGroupInfo">OutputGroupInfo</h2>
        <p><pre class="rule-signature"><a class="anchor" href="OutputGroupInfo.html">OutputGroupInfo</a> OutputGroupInfo(**kwargs)</pre></p>

    Instantiate this provider with <br><pre class=language-python>OutputGroupInfo(group1 = &lt;files&gt;, group2 = &lt;files&gt;...)</pre>See <a href="https://bazel.build/versions/6.4.0/rules/rules#requesting_output_files">Requesting output files </a> for more information.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> OutputGroupInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> OutputGroupInfo.to_proto()</pre></p>
