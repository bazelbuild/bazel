...
See the [depset overview](/versions/6.4.0/rules/depsets) page for more information.
...
[`--profile`](/versions/6.4.0/docs/user-manual#profile) flag, for example
...
![Example profile](/versions/6.4.0/rules/profile.png "Example profile")
