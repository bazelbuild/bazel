...
[Persistent workers](/versions/6.4.0/docs/persistent-workers) can make your build faster. If
...
[multiplex sandboxing](/versions/6.4.0/docs/multiplex-worker).
...
[Implementing persistent workers](/versions/6.4.0/docs/persistent-workers#implementation).
