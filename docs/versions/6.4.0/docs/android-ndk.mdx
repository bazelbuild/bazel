...
![Example results](/versions/6.4.0/docs/images/android_ndk.png "Build graph results")
...
`--linkopt` in the [User Manual](/versions/6.4.0/docs/user-manual#cxxopt).
...
[platforms](/versions/6.4.0/docs/platforms) and
[toolchains](/versions/6.4.0/docs/toolchains). If your
...
use [Bazel wild-cards](/versions/6.4.0/docs/build#specifying-build-targets) like
`/...` and `:all`.
