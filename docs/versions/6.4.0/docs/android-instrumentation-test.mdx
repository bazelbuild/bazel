...
![Running Android instrumentation tests in parallel](/versions/6.4.0/docs/images/android_test.gif "Android instrumentation test")

**Figure 1.** Running parallel Android instrumentation tests.

[`android_instrumentation_test`](/versions/6.4.0/reference/be/android#android_instrumentation_test)
...
![The target dependency graph on an Android instrumentation test](/versions/6.4.0/docs/images/android_instrumentation_test.png "Target dependency graph")
