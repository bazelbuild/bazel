...
*  [Tutorial: Building a C++ project](/versions/6.4.0/tutorials/cpp)
*  [C++ common use cases](/versions/6.4.0/tutorials/cpp-use-cases)
*  [C/C++ rules](/versions/6.4.0/reference/be/c-cpp)
*  [C++ toolchain configuration](/versions/6.4.0/docs/cc-toolchain-config-reference)
*  [Tutorial: Configuring C++ toolchains](/versions/6.4.0/tutorials/cc-toolchain-config)
*  [Integrating with C++ rules](/versions/6.4.0/docs/integrating-with-rules-cc)
...
*  Each `BUILD` file should contain one [`cc_library`](/versions/6.4.0/reference/be/c-cpp#cc_library)
...
*  For legacy or `third_party` code that requires includes pointing outside the
   ...
   use the [`include_prefix`](/versions/6.4.0/reference/be/c-cpp#cc_library.include_prefix) and
   [`strip_include_prefix`](/versions/6.4.0/reference/be/c-cpp#cc_library.strip_include_prefix)
