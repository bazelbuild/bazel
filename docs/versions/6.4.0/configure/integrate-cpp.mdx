...
to [platforms](/versions/6.4.0/docs/platforms) and
[toolchains](/versions/6.4.0/docs/toolchains), you
...
[`Label`](/versions/6.4.0/rules/lib/attr#label)
...
to get the
[`CcToolchainInfo`](/versions/6.4.0/rules/lib/CcToolchainInfo).
...
* `FeatureConfiguration` - returned by [cc_common.configure_features](/versions/6.4.0/rules/lib/cc_common#configure_features)
* cc toolchain config variables - returned by
  [cc_common.create_compile_variables](/versions/6.4.0/rules/lib/cc_common#create_compile_variables)
  or
  [cc_common.create_link_variables](/versions/6.4.0/rules/lib/cc_common#create_link_variables).

There still are tool-specific getters, such as
[compiler_executable](/versions/6.4.0/rules/lib/CcToolchainInfo#compiler_executable).
...
[`CcInfo`](/versions/6.4.0/rules/lib/CcInfo),
a provider containing [`CompilationContext`](/versions/6.4.0/rules/lib/CompilationContext)
and
[`LinkingContext`](/versions/6.4.0/rules/lib/LinkingContext).
