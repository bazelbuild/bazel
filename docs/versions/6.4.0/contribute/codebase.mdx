...
description is available in [Output directory layout](/versions/6.4.0/remote/output-directories).
...
4.  Starlark rules can also define their own options (see
    [here](/versions/6.4.0/rules/config))
...
available [here](/versions/6.4.0/reference/skyframe).
...
[here](/versions/6.4.0/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available
[here](/versions/6.4.0/rules/language).
...
[here](/versions/6.4.0/rules/aspects). A good
...
3.  `AspectParameters` is a way to parameterize an aspect that is propagated down
...
[here](/versions/6.4.0/docs/platforms))
...
[here](/versions/6.4.0/docs/toolchains)).
...
[visibility](/versions/6.4.0/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/6.4.0/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/6.4.0/docs/query-how-to)
...
[Build Event Protocol](/versions/6.4.0/remote/bep)
