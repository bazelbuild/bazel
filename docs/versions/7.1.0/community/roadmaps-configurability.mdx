...
We also support
[`cquery`](https://bazel.build/versions/7.1.0/query/cquery), [`Starlark
configuration`](https://bazel.build/extending/config),
and
[`select()`](https://bazel.build/versions/7.1.0/docs/configurable-attributes).
...
<div class="padbottom"></div>
<span class="etabox">paused</span>**C++ rules use the new [platformsfall API](https://bazel.build/versions/7.1.0/concepts/platforms)**
