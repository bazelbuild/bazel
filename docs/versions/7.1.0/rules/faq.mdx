...
See the [Rules page](/versions/7.1.0/extending/rules#requesting-output-files) for more information.
...
[runfiles](/versions/7.1.0/extending/rules#runfiles). Instead of using the `path` field, use
...
[set the default outputs](/versions/7.1.0/extending/rules#requesting-output-files).
