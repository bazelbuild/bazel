...
<ul>
  <li>
    <a href="/versions/7.1.0/reference/be/common-definitions">Common definitions</a>
    <ul>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#sh-tokenization">Bourne shell tokenization</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#label-expansion">Label expansion</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#typical-attributes">Typical attributes for most rules</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#common-attributes">Common attributes for all rules</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#common-attributes-tests">Common attributes for tests</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#common-attributes-binaries">Common attributes for binaries</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#configurable-attributes">Configurable attributes</a></li>
      <li><a href="/versions/7.1.0/reference/be/common-definitions#implicit-outputs">Implicit output targets</a></li>
    </ul>
  </li>
  <li>
    <a href="/versions/7.1.0/reference/be/make-variables">"Make" variables</a>
    <ul class="be-toc">
      <li><a href="/versions/7.1.0/reference/be/make-variables#use">Use</a></li>
...
<ul class="be-toc">
  <li><a href="/versions/7.1.0/reference/be/functions.html#package">package</a></li>
  <li><a href="/versions/7.1.0/reference/be/functions.html#package_group">package_group</a></li>

  <li><a href="/versions/7.1.0/reference/be/functions.html#exports_files">exports_files</a></li>
  <li><a href="/versions/7.1.0/reference/be/functions.html#glob">glob</a></li>
  <li><a href="/versions/7.1.0/reference/be/functions.html#select">select</a></li>
  <li><a href="/versions/7.1.0/rules/lib/globals/workspace#workspace">workspace</a></li>
</ul>
...
<a href="/versions/7.1.0/rules/rules#recommended-rules">recommended rules</a>.
