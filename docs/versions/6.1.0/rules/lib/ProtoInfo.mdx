...
Encapsulates information provided by <a href="/versions/6.1.0/reference/be/protocol-buffer#proto_library">proto_library.</a><p>Please consider using `load("@rules_proto//proto:defs.bzl", "ProtoInfo")` to load this symbol from <a href="https://github.com/bazelbuild/rules_proto">rules_proto</a>.</p>
