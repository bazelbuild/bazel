...
[build configurations](/versions/6.1.0/docs/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/6.1.0/rules/rules).
...
conflicts impossible by using _[sandboxing](/versions/6.1.0/docs/sandboxing)_. On supported
