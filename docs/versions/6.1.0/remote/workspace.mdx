...
[Workspace rules](/versions/6.1.0/reference/be/workspace) allow the developer to add dependencies to
...
introduced through
[`repository_ctx`](/versions/6.1.0/rules/lib/repository_ctx) which allows interacting
...
[`repository_ctx`](/versions/6.1.0/rules/lib/repository_ctx).
