...
[Remote Execution Overview](/versions/6.1.0/docs/remote-execution) first.
...
[Bazel profiling features](/versions/6.1.0/rules/performance#performance-profiling)
to look at how long typical cache hits take.

Dynamic execution can be used with local sandboxed strategy as well as with
[persistent workers](/versions/6.1.0/docs/persistent-workers). Persistent workers will
automatically run with sandboxing when used with dynamic execution, and cannot
use [multiplex workers](/versions/6.1.0/docs/multiplex-worker). On Darwin and Windows systems,
...
[remote execution system](/versions/6.1.0/docs/remote-execution). It is not currently
...
the use of [persistent workers](/versions/6.1.0/docs/persistent-workers), or those that run
...
[performance profiling](/versions/6.1.0/rules/performance#performance-profiling)
...
<img width="596px" alt="Profiling data with poor dynamic execution performance"
 src="/versions/6.1.0/docs/images/dyn-trace-alldynamic.png">
</p>
...
<img width="596px" alt="Profiling data with better dynamic execution performance"
 src="/versions/6.1.0/docs/images/dyn-trace-javaconly.png">
</p>
