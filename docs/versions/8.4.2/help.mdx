...
* Consulting a [Bazel community expert](/versions/8.4.2/community/experts)

## Understand Bazel's support level

Please read the [release page](/versions/8.4.2/release) to understand Bazel's release model and
