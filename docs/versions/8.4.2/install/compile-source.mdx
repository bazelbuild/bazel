...
GitHub. See [Installing Bazel](/versions/8.4.2/install). (Or you can [build from scratch (bootstrap)](#bootstrap-bazel).)
...
2.  Unpack the distribution archive somewhere on disk.
    ...
    [release key](https://bazel.build/versions/8.4.2/bazel-release.pub.gpg) 3D5919B448457EE0.
