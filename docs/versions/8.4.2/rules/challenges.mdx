...
changes such as changes to file attributes. [Sandboxing](/versions/8.4.2/docs/sandboxing)
...
have designed [Skyframe](/versions/8.4.2/reference/skyframe) to handle this
...
[depset](/versions/8.4.2/rules/lib/depset)
