...
| --- | --- |
| `name` | [string](/versions/8.4.2/rules/lib/core/string); required  Name of the target. It should be a Starlark identifier, matching pattern '[A-Za-z\_][A-Za-z0-9\_]\*'. |
...
| `fragments` | [sequence](/versions/8.4.2/rules/lib/core/list) of [string](/versions/8.4.2/rules/lib/core/string)s; default is `[]`  List of configuration fragments that are available to the implementation of the analysis test. |
| `toolchains` | [sequence](/versions/8.4.2/rules/lib/core/list); default is `[]`  The set of toolchains the test requires. See the [rule](/versions/8.4.2/rules/lib/globals/bzl#rule) call. |
| `attr_values` | [dict](/versions/8.4.2/rules/lib/core/dict) of [string](/versions/8.4.2/rules/lib/core/string)s; default is `{}`  Dictionary of attribute values to pass to the implementation. |
...
[testing.ExecutionInfo](/versions/8.4.2/rules/lib/providers/ExecutionInfo) provider key/constructor
