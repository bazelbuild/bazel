...
Methods available in BUILD files. See also the Build Encyclopedia for extra [functions](/versions/8.4.2/reference/be/functions) and build rules, which can also be used in BUILD files.
...
| Parameter | Description |
| --- | --- |
| `name` | [string](/versions/8.4.2/rules/lib/core/string); required  The name of the target. |
...
| Parameter | Description |
| --- | --- |
| `kwargs` | required  See the [`package()`](/versions/8.4.2/reference/be/functions#package) function in the Build Encyclopedia for applicable arguments. |
...
| Parameter | Description |
| --- | --- |
| `x` | [dict](/versions/8.4.2/rules/lib/core/dict); required |
...
| Parameter | Description |
| --- | --- |
| `include` | [sequence](/versions/8.4.2/rules/lib/core/list) of [string](/versions/8.4.2/rules/lib/core/string)s; required  The list of glob patterns to include in subpackages scan. |
