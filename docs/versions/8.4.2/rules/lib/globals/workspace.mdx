...
| --- | --- |
| `name` | [string](/versions/8.4.2/rules/lib/core/string); required  The label under '//external' to serve as the alias name |
| `actual` | [string](/versions/8.4.2/rules/lib/core/string); or `None`; default is `None`  The real label to be aliased |
...
| Parameter | Description |
| --- | --- |
| `platform_labels` | [sequence](/versions/8.4.2/rules/lib/core/list) of [string](/versions/8.4.2/rules/lib/core/string)s; required  The target patterns to register. |
...
| Parameter | Description |
| --- | --- |
| `toolchain_labels` | [sequence](/versions/8.4.2/rules/lib/core/list) of [string](/versions/8.4.2/rules/lib/core/string)s; required  The target patterns to register. |
...
| Parameter | Description |
| --- | --- |
| `name` | [string](/versions/8.4.2/rules/lib/core/string); required  the name of the workspace. Names must start with a letter and can only contain letters, numbers, underscores, dashes, and dots. |