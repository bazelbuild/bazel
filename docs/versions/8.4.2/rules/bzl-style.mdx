...
[Starlark](/versions/8.4.2/rules/language) is a
...
*   Follow [testing guidelines](/versions/8.4.2/rules/testing).
...
Since
[Starlark is not Python](/versions/8.4.2/rules/language#differences-with-python),
...
See also [macros](/versions/8.4.2/extending/macros#conventions).
...
*   Pass information between your rules using a well-defined
    [provider](/versions/8.4.2/extending/rules#providers) interface. Declare and document provider
    fields.
*   Design your rule with extensibility in mind. Consider that other rules might
    ...
    actions you create.
*   Follow [performance guidelines](/versions/8.4.2/rules/performance) in your rules.
