...
[![Transitive
dependencies](/versions/8.4.2/images/transitive-dependencies.png)](/versions/8.4.2/images/transitive-dependencies.png)
...
overview](/versions/8.4.2/external/overview) for more details.
