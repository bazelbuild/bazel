...
[build configurations](/versions/8.4.2/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/8.4.2/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/8.4.2/docs/sandboxing)_. On supported
