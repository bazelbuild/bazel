...
[`android_instrumentation_test`](/versions/8.4.2/reference/be/android#android_instrumentation_test)
...
![The target dependency graph on an Android instrumentation test](/versions/8.4.2/docs/images/android_instrumentation_test.png "Target dependency graph")
