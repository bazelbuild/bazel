...
[target](https://bazel.build/versions/8.4.2/reference/glossary#target)
`//mypkg:target`.
...
The [`select()`](/versions/8.4.2/reference/be/functions#select) function
chooses among different alternative values for a configurable attribute based
on which [`config_setting`](/versions/8.4.2/reference/be/general#config_setting)
or [`constraint_value`](/versions/8.4.2/reference/be/platforms-and-toolchains#constraint_value)
...
[loading and analysis phases](https://bazel.build/versions/8.4.2/rules/concepts#evaluation-model)).
...
[this FAQ](https://bazel.build/versions/8.4.2/docs/configurable-attributes#faq)
...
See [Configurable Build Attributes](https://bazel.build/versions/8.4.2/docs/configurable-attributes) for a detailed overview.
...
[labels](/versions/8.4.2/concepts/labels) identify *targets*,
...
the [BUILD Concept Reference](/versions/8.4.2/concepts/build-ref).