...
`deps` must point to [`proto_library`](/versions/8.4.2/reference/be/protocol-buffer#proto_library) rules.
...
| `deps` | List of [labels](/versions/8.4.2/concepts/labels); default is `[]` The list of [`proto_library`](/versions/8.4.2/reference/be/protocol-buffer#proto_library) rules to generate C++ code for. |
...
| --- | --- |
| `name` | [Name](/versions/8.4.2/concepts/labels#target-names); required  A unique name for this target. |
| `deps` | List of [labels](/versions/8.4.2/concepts/labels); default is `[]` The list of [`proto_library`](/versions/8.4.2/reference/be/protocol-buffer#proto_library) rules to generate Java code for. |
