...
* `COMPILATION_MODE`:
  `fastbuild`, `dbg`, or `opt`. ([more details](https://bazel.build/versions/8.4.2/docs/user-manual#flag--compilation_mode))
...
[TemplateVariableInfo](/versions/8.4.2/rules/lib/providers/TemplateVariableInfo)
