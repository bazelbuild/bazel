...
[`REPO.bazel` file](/versions/8.4.2/external/overview#repo.bazel) at the root of your repo.
...
This function defines a set of [packages](/versions/8.4.2/concepts/build-ref#packages)
...
[visibility](/versions/8.4.2/reference/be/common-definitions#common.visibility)
attribute.
...
[visibility of files](/versions/8.4.2/concepts/visibility#source-file-target-visibility).
...
function. The [licenses](/versions/8.4.2/reference/be/common-definitions#common.licenses)
...
4. Labels are not allowed to cross the package boundary and glob does
   ...
   [--deleted\_packages](/versions/8.4.2/docs/user-manual#flag--deleted_packages)
   flag.
...
[configurable](/versions/8.4.2/reference/be/common-definitions#configurable-attributes).
