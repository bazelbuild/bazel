...
See the [User's Guide](/versions/8.4.2/docs/build#specifying-build-targets) for the
...
:   If true, enables the <code>isolate</code> parameter in the <a href="https://bazel.build/versions/8.4.2/rules/lib/globals/module#use\_extension"><code>use\_extension</code></a> function.
