...
[`--lockfile_mode`](/versions/8.4.2/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/8.4.2/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/8.4.2/release/backward-compatibility)
