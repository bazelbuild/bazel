...
*   `@<repo_name>`: The repo with the given [apparent name](/versions/8.5.1/external/overview#apparent-repo-name) in the context of the `--base_module`.

*   `@@<repo_name>`: The repo with the given [canonical name](/versions/8.5.1/external/overview#canonical-repo-name).
