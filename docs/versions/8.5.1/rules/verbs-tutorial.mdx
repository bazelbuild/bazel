...
[Macros](/versions/8.5.1/extending/macros) are the heart of this pattern. Macros are used like
...
[`ctx.actions.expand_template`](/versions/8.5.1/rules/lib/builtins/actions#expand_template)
