...
| --- | --- |
| `compilation_context` | [CompilationContext](/versions/8.5.1/rules/lib/builtins/CompilationContext); or `None`; default is `None`  The `CompilationContext`. |
| `linking_context` | [LinkingContext](/versions/8.5.1/rules/lib/builtins/LinkingContext); or `None`; default is `None`  The `LinkingContext`. |
