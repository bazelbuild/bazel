...
See the
[Bazel](/versions/8.5.1/start/) and [Starlark](/versions/8.5.1/extending/concepts) documentation for
...
When you call the [`rule`](/versions/8.5.1/rules/lib/globals#rule) function, you
must define a callback function. The logic will go there, but you
can leave the function empty for now. The [`ctx`](/versions/8.5.1/rules/lib/builtins/ctx) argument
...
[`ctx.label`](/versions/8.5.1/rules/lib/builtins/ctx#label)
...
[API reference](/versions/8.5.1/rules/lib/builtins/ctx).
...
To analyze the targets, use the [`cquery`](/versions/8.5.1/query/cquery) ("configured
...
creating an action. Use [`ctx.actions.write`](/versions/8.5.1/rules/lib/builtins/actions#write),
...
the documentation of [`attr.string`](/versions/8.5.1/rules/lib/toplevel/attr#string).
You may also use other types of attributes, such as [boolean](/versions/8.5.1/rules/lib/toplevel/attr#bool)
or [list of integers](/versions/8.5.1/rules/lib/toplevel/attr#int_list).

## Dependencies

Dependency attributes, such as [`attr.label`](/versions/8.5.1/rules/lib/toplevel/attr#label)
and [`attr.label_list`](/versions/8.5.1/rules/lib/toplevel/attr#label_list),
...
[`Target`](/versions/8.5.1/rules/lib/builtins/Target) object. For example, view the files returned
by the target using [`Target.files`](/versions/8.5.1/rules/lib/builtins/Target#modules.Target.files).
...
[`exports_files`](/versions/8.5.1/reference/be/functions#exports_files):
...
*   Take a look at the [reference documentation for rules](/versions/8.5.1/extending/rules#contents).
*   Get familiar with [depsets](/versions/8.5.1/extending/depsets).
