...
[Persistent workers](/versions/8.5.1/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/8.5.1/remote/multiplex).
...
[Implementing persistent workers](/versions/8.5.1/remote/persistent#implementation).
