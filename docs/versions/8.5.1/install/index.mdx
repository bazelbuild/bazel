...
[Bazelisk](/versions/8.5.1/install/bazelisk) is the recommended way to install Bazel on [Ubuntu Linux](/versions/8.5.1/install/ubuntu), [macOS](/versions/8.5.1/install/os-x), and [Windows](/versions/8.5.1/install/windows).

You can find available Bazel releases on our [release page](/versions/8.5.1/release).
...
*   [openSUSE](/versions/8.5.1/install/suse)
...
For other platforms, you can try to [compile from source](/versions/8.5.1/install/compile-source).
