...
For more details, see [Hermeticity](/versions/8.5.1/basics/hermeticity).
...
The first argument of `load` is a [label](/versions/8.5.1/concepts/labels) identifying a
...
You can use [load visibility](/versions/8.5.1/concepts/visibility#load-visibility) to restrict
...
[Build Encyclopedia](/versions/8.5.1/reference/be/overview), but it is possible
...
<table class="columns">
  <tr>
    <td>
      <a class="button button-with-icon button-primary" href="/versions/8.5.1/concepts/labels"><span class="material-icons" aria-hidden="true">arrow_back</span>Labels</a>
    </td>
    <td>
      <a class="button button-with-icon button-primary" href="/versions/8.5.1/concepts/dependencies">Dependencies<span class="material-icons icon-after" aria-hidden="true">arrow_forward</span></a>
    </td>
  </tr>
</table>
