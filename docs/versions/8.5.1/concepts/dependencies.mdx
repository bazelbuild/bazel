...
function foo() {
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.5.1/docs/images/a_b_c.svg"
...
<table class="cyan">
  ...
  <tr>
    ...
    <td>
      <figure>
        <img src="/versions/8.5.1/docs/images/a_b_c_ac.svg"
...
rule(
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.5.1/docs/images/ab_c.svg"
    ...
    <td>
      <figure>
        <img src="/versions/8.5.1/docs/images/a_b_a_c.svg"
...
more details, see
[Attributes common to all rules](/versions/8.5.1/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/8.5.1/reference/be/).
...
<div><span class="compare-worse">Not recommended</span> — <code>data = ["//data/regression:unittest/."]</code></div>

<div><span class="compare-worse">Not recommended</span> — <code>data = ["testdata/."]</code></div>
...
[`glob()`](/versions/8.5.1/reference/be/functions#glob) function. (Use `**` to force the
`glob()` to be recursive.)

<div><span class="compare-better">Recommended</span> — <code>data = glob(["testdata/**"])</code></div>
...
conform to the [label syntax](/versions/8.5.1/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/8.5.1/reference/be/functions#glob) function produces an invalid labels
  ...
  <tr>
    <td>
      <a class="button button-with-icon button-primary"
           href="/versions/8.5.1/concepts/build-files">
        <span class="material-icons" aria-hidden="true">arrow_back</span>BUILD files
      </a>
    </td>
    <td>
      <a class="button button-with-icon button-primary"
           href="/versions/8.5.1/concepts/visibility">
