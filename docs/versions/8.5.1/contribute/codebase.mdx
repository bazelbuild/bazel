...
description is available in [Output directory layout](/versions/8.5.1/remote/output-directories).
...
4.  Starlark rules can also define their own options (see
    [here](/versions/8.5.1/extending/config))
...
available [here](/versions/8.5.1/reference/skyframe).
...
3.  Storing state between restarts, either using
    ...
    [`StateMachine`s](/versions/8.5.1/contribute/statemachine-guide) were introduced for a
...
[here](/versions/8.5.1/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available [here](/versions/8.5.1/rules/language).
...
[here](/versions/8.5.1/extending/aspects). A good
...
[here](/versions/8.5.1/extending/platforms))
...
[here](/versions/8.5.1/extending/toolchains)).
...
[visibility](/versions/8.5.1/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/8.5.1/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/8.5.1/query/guide)
...
[external dependencies overview](/versions/8.5.1/external/overview) for more up-to-date
information.
