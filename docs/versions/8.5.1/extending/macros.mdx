...
[`macro()`](https://bazel.build/versions/8.5.1/rules/lib/globals/bzl.html#macro) function with
...
[parameters](https://bazel.build/versions/8.5.1/rules/lib/toplevel/attr#parameters),
...
The [visibility](/versions/8.5.1/concepts/visibility) system helps protect the implementation
...
[default visibility](/versions/8.5.1/reference/be/functions#package.default_visibility) does
...
[visibility page](/versions/8.5.1/concepts/visibility#symbolic-macros) for more details.
