...
[`--instrumentation_filter`](/versions/8.5.1/reference/command-line-reference#flag--instrumentation_filter)
...
[`--instrument_test_targets`](/versions/8.5.1/reference/command-line-reference#flag--instrument_test_targets)
flag is required.
...
[target]`](/versions/8.5.1/reference/command-line-reference#coverage). This runs the
