      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
            ...
            <td>
                  ...
                  <tr>
            <td id="compile.conly_flags">
              <code>conly_flags</code>
            </td>
            <td>
                                     default is <code>[]</code><br/>
    ...
    Returns link variables used for linking actions.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
            ...
            <td>
                                     default is <code>False</code><br/>
                          True when creating dynamic library, False when executable or static library. Caller is responsible for keeping this in sync with action name used. This field will be removed once Skylark issues are fixed.
            </td>
          </tr>
                  <tr>
