...
## Understanding task-based build systems {:#task-based-build-systems}
...
depends on using the depends attribute. These dependencies form an acyclic graph,
as seen in Figure 1.

[![Acrylic graph showing dependencies](/versions/7.7.0/images/task-dependencies.png)](/images/task-dependencies.png)
...
## The dark side of task-based build systems {:#dark-side-build-systems}
...
### Difficulty of parallelizing build steps {:#parallel-build-difficulty}
...
### Difficulty performing incremental builds {:#incremental-build-difficulty}
...
### Difficulty maintaining and debugging scripts {:#difficulty-scripts}
