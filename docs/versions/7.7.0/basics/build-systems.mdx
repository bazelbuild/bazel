...
## What is a build system? {:#what-is-build-system}
...
### Can't I just use a compiler? {:#use-compiler}
...
file system (perhaps a library shared by several projects). It also only knows
...
### What about shell scripts? {:#shell-scripts}
