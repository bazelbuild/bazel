...
[`--lockfile_mode`](/versions/7.7.0/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/7.7.0/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/7.7.0/release/backward-compatibility)
