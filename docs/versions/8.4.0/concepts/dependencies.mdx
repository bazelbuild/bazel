...
function foo() {
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.4.0/docs/images/a_b_c.svg"
...
<table class="cyan">
  ...
  <tr>
    ...
    <td>
      <figure>
        <img src="/versions/8.4.0/docs/images/a_b_c_ac.svg"
...
<table class="cyan">
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.4.0/docs/images/ab_c.svg"
    ...
    <td>
      <figure>
        <img src="/versions/8.4.0/docs/images/a_b_a_c.svg"
...
more details, see
[Attributes common to all rules](/versions/8.4.0/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/8.4.0/reference/be/).
...
[`glob()`](/versions/8.4.0/reference/be/functions#glob) function. (Use `**` to force the
...
conform to the [label syntax](/versions/8.4.0/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/8.4.0/reference/be/functions#glob) function produces an invalid labels
...
<table class="columns">
  <tr>
    ...
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.4.0/concepts/visibility">
