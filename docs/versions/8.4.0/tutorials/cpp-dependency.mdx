...
This command tells Bazel to look for all dependencies for the target
...
Then you can generate and view the graph by piping the text output command
straight to xdot:
...
![Dependency graph for 'hello-world'](/versions/8.4.0/docs/images/cpp-tutorial-stage1.png "Dependency graph")

**Figure 1.** Dependency graph for `hello-world` displays a single target with a
single source file.
