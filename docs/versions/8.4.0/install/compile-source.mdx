...
GitHub. See [Installing Bazel](/versions/8.4.0/install). (Or you can [build from
...
2.  Unpack the distribution archive somewhere on disk.
    ...
    [release key](https://bazel.build/versions/8.4.0/bazel-release.pub.gpg) 3D5919B448457EE0.
