...
*   *Recommended*: [Use Bazelisk](/versions/8.4.0/install/bazelisk)
...
*   [Compile Bazel from source](/versions/8.4.0/install/compile-source)
...
*   Access the [bash completion script](/versions/8.4.0/install/completion#bash)
*   Install the [zsh completion script](/versions/8.4.0/install/completion#zsh)
