...
[`--lockfile_mode`](/versions/7.5.0/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/7.5.0/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/7.5.0/release/backward-compatibility)
