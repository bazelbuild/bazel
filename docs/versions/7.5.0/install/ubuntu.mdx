...
*   [Compile Bazel from source](/versions/7.5.0/install/compile-source)
...
*   Access the [bash completion script](/versions/7.5.0/install/completion#bash)
*   Install the [zsh completion script](/versions/7.5.0/install/completion#zsh)
