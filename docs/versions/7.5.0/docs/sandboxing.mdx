...
[Persistent workers](/versions/7.5.0/remote/persistent) run in a generic sandbox if you pass
...
sandboxes [persistent workers](/versions/7.5.0/remote/persistent).
...
-   Sandboxing effectively disables any cache the tool may have. You can
    mitigate this by using [persistent workers](/versions/7.5.0/remote/persistent), at
    the cost of weaker sandbox guarantees.

-   [Multiplex workers](/versions/7.5.0/remote/multiplex) require explicit worker support
