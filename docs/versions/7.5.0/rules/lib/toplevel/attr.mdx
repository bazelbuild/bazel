...
<ul>
    ...
    Creates a schema for an attribute holding a dictionary, where the keys and values are strings.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../builtins/Attribute.html">Attribute</a> attr.string_keyed_label_dict(allow_empty=True, *, default={}, doc=None, allow_files=None, allow_rules=None, providers=[], flags=[], mandatory=False, cfg=None, aspects=[])</pre></p>
