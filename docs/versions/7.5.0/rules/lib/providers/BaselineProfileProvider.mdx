...
<h1 class="page-title" id="modules.BaselineProfileProvider">BaselineProfileProvider</h1>

{% dynamic setvar source_file "src/main/java/com/google/devtools/build/lib/starlarkbuildapi/android/BaselineProfileProviderApi.java" %}
{% dynamic setvar version "7.5.0" %}
{% dynamic setvar original_path "/rules/lib/providers/BaselineProfileProvider" %}
...
<ul>
    <li>
    <a href="#BaselineProfileProvider">BaselineProfileProvider</a>
  </li>
      <li>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="BaselineProfileProvider">BaselineProfileProvider</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/BaselineProfileProvider.html">BaselineProfileProvider</a> BaselineProfileProvider(files, art_profile_zip=None)</pre></p>

    The <code>BaselineProfileProvider</code> constructor.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
                  <tr>
            <td id="BaselineProfileProvider.files">
              <code>files</code>
            </td>
            <td>
                          <a class="anchor" href="../builtins/depset.html">depset</a> of <a class="anchor" href="../builtins/File.html">File</a>s;
                                     required<br/>
                          Transitive baseline profile files.
            </td>
          </tr>
                  <tr>
            <td id="BaselineProfileProvider.art_profile_zip">
              <code>art_profile_zip</code>
            </td>
            <td>
                          <a class="anchor" href="../builtins/File.html">File</a>; or <code>None</code>;
                                     default is <code>None</code><br/>
                          The final ART profile zip to be packaged in the APK. Optional, only used for migration purposes.
            </td>
          </tr>
                </tbody>
      </table>
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> BaselineProfileProvider.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> BaselineProfileProvider.to_proto()</pre></p>
