...
<h1 class="page-title" id="modules.AppleExecutableBinary">AppleExecutableBinary</h1>

{% dynamic setvar source_file "src/main/java/com/google/devtools/build/lib/starlarkbuildapi/objc/AppleExecutableBinaryApi.java" %}
{% dynamic setvar version "7.5.0" %}
{% dynamic setvar original_path "/rules/lib/providers/AppleExecutableBinary" %}
...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="binary">binary</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../builtins/File.html">File</a> AppleExecutableBinary.binary</pre></p>

    The executable binary file output by apple_binary.


        <h2 id="cc_info">cc_info</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/CcInfo.html">CcInfo</a> AppleExecutableBinary.cc_info</pre></p>

    A provider which contains information about the transitive dependencies linked into the binary.


        <h2 id="objc">objc</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/ObjcProvider.html">ObjcProvider</a> AppleExecutableBinary.objc</pre></p>

    <b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>A provider which contains information about the transitive dependencies linked into the binary.


        <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AppleExecutableBinary.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AppleExecutableBinary.to_proto()</pre></p>
