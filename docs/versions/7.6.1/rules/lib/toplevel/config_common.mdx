...
| --- | --- |
| `name` | [string](/versions/7.6.1/rules/lib/core/string); or [Label](/versions/7.6.1/rules/lib/builtins/Label); required  The toolchain type that is required. |
| `mandatory` | [bool](/versions/7.6.1/rules/lib/core/bool); default is `True`  Whether the toolchain type is mandatory or optional. |