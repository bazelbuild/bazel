...
A specific constraint setting that may be used to define a platform. See [Defining Constraints and Platforms](/versions/7.6.1/docs/platforms#defining-constraints-and-platforms) for more information.
