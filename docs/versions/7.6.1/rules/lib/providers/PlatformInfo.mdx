...
Provides access to data about a specific platform. See [Defining Constraints and Platforms](/versions/7.6.1/docs/platforms#defining-constraints-and-platforms) for more information.
