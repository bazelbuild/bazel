...
| --- | --- |
| `specs` | [depset](/versions/7.6.1/rules/lib/builtins/depset) of [File](/versions/7.6.1/rules/lib/builtins/File)s; required  Transitive proguard specs. |

## to\_json

```
string ProguardSpecProvider.to_json()
```
...
```
string ProguardSpecProvider.to_proto()
```
