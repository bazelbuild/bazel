...
[`depset`](/versions/7.6.1/rules/lib/builtins/depset) of [`File`](/versions/7.6.1/rules/lib/builtins/File) objects representing instrumented source files for this target and its dependencies.
