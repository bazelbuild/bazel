...
| --- | --- |
| `files` | [depset](/versions/7.6.1/rules/lib/builtins/depset) of [File](/versions/7.6.1/rules/lib/builtins/File)s; required  Transitive baseline profile files. |
| `art_profile_zip` | [File](/versions/7.6.1/rules/lib/builtins/File); or `None`; default is `None`  The final ART profile zip to be packaged in the APK. Optional, only used for migration purposes. |
