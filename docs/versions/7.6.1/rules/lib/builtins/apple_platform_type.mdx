...
Specific instances of this type can be retrieved by accessing the fields of the [apple\_common.platform\_type](/versions/7.6.1/rules/lib/toplevel/apple_common#platform_type):
...
Platform types can be converted to a lowercase string (e.g., `ios` or `macos`) using the [str](/versions/7.6.1/rules/lib/globals/all#str) function.