...
Expands directories created by [`ctx.actions.declare_directory`](/versions/7.6.1/rules/lib/builtins/actions#declare_directory) during the execution phase. This is useful to expand directories in [`map_each`](/versions/7.6.1/rules/lib/builtins/Args#add_all.map_each).
