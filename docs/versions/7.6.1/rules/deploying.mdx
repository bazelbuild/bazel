...
for the [Go rules](https://github.com/bazelbuild/rules_go#setup), this
looks like:
...
[toolchain](/versions/7.6.1/extending/toolchains) rules,
...
using [selects](/versions/7.6.1/reference/be/functions#select)).
