...
changes such as changes to file attributes. [Sandboxing](/versions/7.6.1/docs/sandboxing)
...
have designed [Skyframe](/versions/7.6.1/reference/skyframe) to handle this
...
[depset](/versions/7.6.1/rules/lib/builtins/depset)
