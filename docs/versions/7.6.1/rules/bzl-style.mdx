...
[Starlark](/versions/7.6.1/rules/language) is a
...
*   Follow [testing guidelines](/versions/7.6.1/rules/testing).
...
Since
[Starlark is not Python](/versions/7.6.1/rules/language#differences-with-python),
...
See also [macros](/versions/7.6.1/extending/macros#conventions).
...
*   Pass information between your rules using a well-defined
    [provider](/versions/7.6.1/extending/rules#providers) interface. Declare and document provider
    fields.
*   Design your rule with extensibility in mind. Consider that other rules might
    ...
    actions you create.
*   Follow [performance guidelines](/versions/7.6.1/rules/performance) in your rules.
