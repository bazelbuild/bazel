...
[build configurations](/versions/7.6.1/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/7.6.1/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/7.6.1/docs/sandboxing)_. On supported
