...
4.  To view build results, click **Details** for the RBE (Ubuntu
    ...
    ![Example results](/versions/7.6.1/docs/images/rbe-ci-1.png "Example results")
...
5.  (Optional) Set the **bazel test (RBE (Ubuntu 16.04))** check as a test
    ...
    ![Branch protection rules settings](/versions/7.6.1/docs/images/rbe-ci-2.png "Branch protection rules")
...
*   **Build or test targets are using rules that are incompatible with remote
    execution.** See
    [Adapting Bazel Rules for Remote Execution](/versions/7.6.1/remote/rules) for
...
You must include a [Bazel platform](/versions/7.6.1/extending/platforms) configuration in your
