...
Tests are run using [`bazel test`](/versions/7.6.1/docs/user-manual#test).
...
[`timeout`](/versions/7.6.1/reference/be/common-definitions#test.timeout) attribute according
...
test's [`size`](/versions/7.6.1/reference/be/common-definitions#test.size) as follows:
...
[Common definitions](/versions/7.6.1/reference/be/common-definitions#common-attributes-tests).
...
specification [here](/versions/7.6.1/reference/be/common-definitions#common-attributes-tests). If
...
[`--test_sharding_strategy`](/versions/7.6.1/reference/command-line-reference#flag--test_sharding_strategy)
and [`shard_count`](/versions/7.6.1/reference/be/common-definitions#common-attributes-tests) to
...
[`--incompatible_check_sharding_support`](/versions/7.6.1/reference/command-line-reference#flag--incompatible_check_sharding_support)
...
<table>
  ...
  <tr>
    ...
    <td>total
      <a href="/versions/7.6.1/reference/be/common-definitions#test.shard_count"><code>shard count</code></a>,
  ...
  <tr>
    ...
    <td>value of
      <a href="/versions/7.6.1/docs/user-manual#flag--test_filter"><code>--test_filter</code></a>,
      if specified</td>
    <td>optional</td>
  </tr>
  <tr>
...
[Bazel Build Encyclopedia on the `tags` attribute](/versions/7.6.1/reference/be/common-definitions#common.tags).
