...
dependencies](/versions/7.6.1/docs/external) required to build your project.
...
Bazel](/versions/7.6.1/docs/android-ndk).
...
mobile-install`](/versions/7.6.1/docs/user-manual#mobile-install) command. This command uses
