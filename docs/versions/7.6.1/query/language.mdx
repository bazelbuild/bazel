...
<table>
  <tr>
    <td><figure>         <img src="/docs/images/somepath1.svg" alt="Somepath" />         <figcaption><code>somepath(S1 + S2, E)</code>, one possible result.</figcaption>       </figure> {{}"}{{}"}</td>
    <td><figure>         <img src="/docs/images/somepath2.svg" alt="Somepath" />         <figcaption><code>somepath(S1 + S2, E)</code>, another possible result.</figcaption>       </figure> {{}"}{{}"}</td>
    <td><figure>         <img src="/docs/images/allpaths.svg" alt="Allpaths" />         <figcaption><code>allpaths(S1 + S2, E)</code></figcaption>       </figure> {{}"}{{}"}</td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img src="/docs/images/out-ranked.svg" alt="Out ranked" /></td>
