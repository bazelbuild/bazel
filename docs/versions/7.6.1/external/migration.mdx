...
WORKSPACE](/versions/7.6.1/external/overview#workspace-shortcomings), Bzlmod is going to
...
*   **Bzlmod**
    ...
    registry](/versions/7.6.1/external/registry), you can simply depend on it with a
...
[`use_repo_rule`](/versions/7.6.1/external/module#use_repo_rule) or [module
extensions](/versions/7.6.1/external/extension).
...
deps](/versions/7.6.1/external/module#repository_names_and_strict_deps) for more details.
...
name](/versions/7.6.1/external/overview#apparent-repo-name) in MODULE.bazel, then `@foo`
