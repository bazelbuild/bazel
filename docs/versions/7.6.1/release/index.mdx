...
*   Rolling releases can ship incompatible changes. Incompatible flags are
    ...
    should follow our [backward compatibility policy](/versions/7.6.1/release/backward-compatibility).
...
Bazel versions, please check out the [Rule Compatibility](/versions/7.6.1/release/rule-compatibility) page.