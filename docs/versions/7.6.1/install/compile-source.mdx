...
GitHub. See [Installing Bazel](/versions/7.6.1/install). (Or you can [build from scratch (bootstrap)](#bootstrap-bazel).)
...
2.  Unpack the distribution archive somewhere on disk.
    ...
    [release key](https://bazel.build/versions/7.6.1/bazel-release.pub.gpg) 3D5919B448457EE0.
