...
Bazel has a [backward compatibility policy](/versions/7.6.1/release/backward-compatibility)
(see [guidance for rolling out incompatible changes](/versions/7.6.1/contribute/breaking-changes) if you
