...
*   *Recommended*: [Use Bazelisk](/versions/7.6.1/install/bazelisk)
...
*   [Compile Bazel from source](/versions/7.6.1/install/compile-source)
...
*   Access the [bash completion script](/versions/7.6.1/install/completion#bash)
*   Install the [zsh completion script](/versions/7.6.1/install/completion#zsh)
