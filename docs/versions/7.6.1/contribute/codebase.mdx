...
description is available in [Output directory layout](/versions/7.6.1/remote/output-directories).
...
4.  Starlark rules can also define their own options (see
    [here](/versions/7.6.1/extending/config))
...
available [here](/versions/7.6.1/reference/skyframe).
...
[here](/versions/7.6.1/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available [here](/versions/7.6.1/rules/language).
...
[here](/versions/7.6.1/extending/aspects). A good
...
[here](/versions/7.6.1/extending/platforms))
...
[here](/versions/7.6.1/extending/toolchains)).
...
[visibility](/versions/7.6.1/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/7.6.1/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/7.6.1/query/guide)
...
[Build Event Protocol](/versions/7.6.1/remote/bep)
...
[external dependencies overview](/versions/7.6.1/external/overview) for more up-to-date
information.
