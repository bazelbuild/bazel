...
![Example results](/versions/8.0.0/docs/images/android_ndk.png "Build graph results")
...
the labels of [`platform`](https://bazel.build/versions/8.0.0/reference/be/platforms-and-toolchains#platform)
...
`--linkopt` in the [User Manual](/versions/8.0.0/docs/user-manual#cxxopt).
...
use [Bazel wild-cards](/versions/8.0.0/run/build#specifying-build-targets) like
`/...` and `:all`.
