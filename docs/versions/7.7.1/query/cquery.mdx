...
phase](/versions/7.7.1/extending/concepts#evaluation-model),
...
documentation](/versions/7.7.1/query/language#target-patterns) for more information on target patterns.
