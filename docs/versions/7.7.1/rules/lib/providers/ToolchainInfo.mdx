...
Provider returned by [toolchain rules](/versions/7.7.1/docs/toolchains#defining-toolchains) to share data with [rules which depend on toolchains](/versions/7.7.1/docs/toolchains#writing-rules-that-use-toolchains). Read about [toolchains](/versions/7.7.1/docs/toolchains) for more information.
