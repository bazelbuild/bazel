...
A value for a constraint setting that can be used to define a platform. See [Defining Constraints and Platforms](/versions/7.7.1/docs/platforms#defining-constraints-and-platforms) for more information.
...
```
string ConstraintValueInfo.to_json()
```
...
```
string ConstraintValueInfo.to_proto()
```
