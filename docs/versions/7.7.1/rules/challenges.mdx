...
changes such as changes to file attributes. [Sandboxing](/versions/7.7.1/docs/sandboxing)
...
have designed [Skyframe](/versions/7.7.1/reference/skyframe) to handle this
...
[depset](/versions/7.7.1/rules/lib/depset)
