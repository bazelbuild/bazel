...
function foo() {
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/7.7.1/docs/images/a_b_c.svg"
...
<table class="cyan">
  ...
  <tr>
    ...
    <td>
      <figure>
        <img src="/versions/7.7.1/docs/images/a_b_c_ac.svg"
...
<table class="cyan">
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/7.7.1/docs/images/ab_c.svg"
    ...
    <td>
      <figure>
        <img src="/versions/7.7.1/docs/images/a_b_a_c.svg"
...
more details, see
[Attributes common to all rules](/versions/7.7.1/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/7.7.1/reference/be/).
...
[`glob()`](/versions/7.7.1/reference/be/functions#glob) function. (Use `**` to force the
...
conform to the [label syntax](/versions/7.7.1/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/7.7.1/reference/be/functions#glob) function produces an invalid labels
...
<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/7.7.1/concepts/build-files">
        <span class="material-icons" aria-hidden="true">arrow_back</span>BUILD files</a>
    </td>
    <td><a class="button button-with-icon button-primary"
           href="/versions/7.7.1/concepts/visibility">
