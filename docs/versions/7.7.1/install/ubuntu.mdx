...
*   [Compile Bazel from source](/versions/7.7.1/install/compile-source)
...
*   Access the [bash completion script](/versions/7.7.1/install/completion#bash)
*   Install the [zsh completion script](/versions/7.7.1/install/completion#zsh)
