...
[Bazelisk](/versions/7.7.1/install/bazelisk) is the recommended way to install Bazel on [Ubuntu Linux](/versions/7.7.1/install/ubuntu), [macOS](/versions/7.7.1/install/os-x), and [Windows](/versions/7.7.1/install/windows).
...
*   [openSUSE](/versions/7.7.1/install/suse)
...
For other platforms, you can try to [compile from source](/versions/7.7.1/install/compile-source).
