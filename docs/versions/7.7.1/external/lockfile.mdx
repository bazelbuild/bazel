...
[`--lockfile_mode`](/versions/7.7.1/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/7.7.1/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/7.7.1/release/backward-compatibility)
