...
[Persistent workers](/versions/7.7.1/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/7.7.1/remote/multiplex).
...
[Implementing persistent workers](/versions/7.7.1/remote/persistent#implementation).
