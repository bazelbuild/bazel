...
Bazel is evolving. Minor versions released as part of an [LTS major version](/versions/7.7.1/release#bazel-versioning) are fully backward-compatible. New major LTS
releases may contain incompatible changes that require some migration effort.
For more information about Bazel's release model, please check out the [Release Model](/versions/7.7.1/release) page.
...
*   [For Bazel users - how to update Bazel](/versions/7.7.1/install/bazelisk)
*   [For contributors - best practices for incompatible changes](/versions/7.7.1/contribute/breaking-changes)
