...
Bazel in the
[`buildtools` directory](https://github.com/bazelbuild/buildtools).
...
[![Transitive dependencies](/versions/7.7.1/images/transitive-dependencies.png)](/versions/7.7.1/images/transitive-dependencies.png)
...
[enforces strict transitive dependencies](https://blog.bazel.build/2017/06/28/sjd-unused_deps.html)
...
[One-Version Rule](https://opensource.google/docs/thirdparty/oneversion/)
