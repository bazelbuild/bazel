...
1.  [Install Bazel](/versions/7.7.1/install) if you have not already done so.

2.  If you're not familiar with Bazel and its concepts, complete the
    [iOS app tutorial](/versions/7.7.1/start/ios-app)). You should understand the Bazel
...
[Working with external dependencies](/versions/7.7.1/docs/external).
...
[Workspaces, packages, and targets](/versions/7.7.1/concepts/build-ref).
...
Add an [`objc_library`](/versions/7.7.1/reference/be/objective-c#objc_library)
...
Note: You can use the [`glob`](/versions/7.7.1/reference/be/functions#glob)
