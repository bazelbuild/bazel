...
[recommended rules](/versions/7.6.0/rules).
...
After a review by the [Bazel core team](/versions/7.6.0/contribute/policy), it
...
*   The ruleset follows the best practices and is performant (see
    [the performance guide](/versions/7.6.0/rules/performance)).
