...
Provider returned by <a href="/versions/7.6.0/docs/toolchains#defining-toolchains">toolchain rules</a> to share data with <a href="/versions/7.6.0/docs/toolchains#writing-rules-that-use-toolchains">rules which depend on toolchains</a>. Read about <a href='/versions/7.6.0/docs/toolchains'>toolchains</a> for more information.
