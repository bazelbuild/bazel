...
*Recommended*: [Use Bazelisk](/versions/7.6.0/install/bazelisk)
...
*   [Build Bazel from source](/versions/7.6.0/install/compile-source)
...
You can also change your system `PATH` environment variable to make it permanent. Check out how to [set environment variables](/versions/7.6.0/configure/windows#set-environment-variables).
...
*   [Best practices on Windows](/versions/7.6.0/configure/windows#best-practices)
*   [Tutorials](/versions/7.6.0/start/#tutorials)
...
To build Bazel from scratch instead of installing, see [Compiling from source](/versions/7.6.0/install/compile-source).
