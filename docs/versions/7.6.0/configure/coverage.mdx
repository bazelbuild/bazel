...
[`--instrumentation_filter`](/versions/7.6.0/reference/command-line-reference#flag--instrumentation_filter)
...
[`--instrument_test_targets`](/versions/7.6.0/reference/command-line-reference#flag--instrument_test_targets)
flag is required.
...
[target]`](/versions/7.6.0/reference/command-line-reference#coverage). This runs the
