...
Each execution group has its own [toolchain](/versions/9.0.0/extending/toolchains) dependencies and
performs its own [toolchain resolution](/versions/9.0.0/extending/toolchains#toolchain-resolution).
...
[declare](/versions/9.0.0/rules/lib/globals/bzl#exec_group)
...
[`cfg`](/versions/9.0.0/rules/lib/toplevel/attr#label)
...
param of action generating methods, specifically [`ctx.actions.run`](/versions/9.0.0/rules/lib/builtins/actions#run) and
[`ctx.actions.run_shell`](/versions/9.0.0/rules/lib/builtins/actions#run_shell).
...
Rule authors will also be able to access the [resolved toolchains](/versions/9.0.0/extending/toolchains#toolchain-resolution)
...
* `test`: Test runner actions (for more details, see
  the [execution platform section of the Test Encylopedia](/versions/9.0.0/reference/test-encyclopedia#execution-platform)).
...
[`exec_properties`](/versions/9.0.0/reference/be/common-definitions#common-attributes)
...
[`exec_compatible_with`](/versions/9.0.0/reference/be/common-definitions#common-attributes) and
[`exec_group_compatible_with`](/versions/9.0.0/reference/be/common-definitions#common-attributes)
