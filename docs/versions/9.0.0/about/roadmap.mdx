...
[long term support (LTS)](https://bazel.build/versions/9.0.0/release/versioning) to you in late
2025.

## Full transition to Bzlmod

[Bzlmod](https://bazel.build/versions/9.0.0/docs/bzlmod) has been the standard external
...
[guide](https://bazel.build/versions/9.0.0/external/migration) and
...
use [transitions](https://bazel.build/versions/9.0.0/extending/config#user-defined-transitions)
cheaper and faster.
...
[exec configurations](https://bazel.build/versions/9.0.0/extending/rules#configurations) and
