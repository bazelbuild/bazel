...
[`android_instrumentation_test`](/versions/9.0.0/reference/be/android#android_instrumentation_test)
...
![The target dependency graph on an Android instrumentation test](/versions/9.0.0/docs/images/android_instrumentation_test.png "Target dependency graph")
