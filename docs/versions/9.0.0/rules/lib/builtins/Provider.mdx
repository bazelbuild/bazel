...
* It is a *key* to access a provider instance on a [Target](/versions/9.0.0/rules/lib/builtins/Target)
...
Create a new `Provider` using the [provider](/versions/9.0.0/rules/lib/globals/bzl#provider) function.