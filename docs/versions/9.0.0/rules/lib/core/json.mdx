...
| --- | --- |
| `x` | [string](/versions/9.0.0/rules/lib/core/string); required  JSON string to decode. |
...
| --- | --- |
| `x` | required |
| `prefix` | [string](/versions/9.0.0/rules/lib/core/string); default is `''` |
| `indent` | [string](/versions/9.0.0/rules/lib/core/string); default is `'\t'` |
...
| Parameter | Description |
| --- | --- |
| `s` | [string](/versions/9.0.0/rules/lib/core/string); required |
| `prefix` | [string](/versions/9.0.0/rules/lib/core/string); default is `''` |
| `indent` | [string](/versions/9.0.0/rules/lib/core/string); default is `'\t'` |