...
changes such as changes to file attributes. [Sandboxing](/versions/9.0.0/docs/sandboxing)
...
have designed [Skyframe](/versions/9.0.0/reference/skyframe) to handle this
