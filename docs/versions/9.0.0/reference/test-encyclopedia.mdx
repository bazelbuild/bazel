...
Tests are run using [`bazel test`](/versions/9.0.0/docs/user-manual#test).
...
[`timeout`](/versions/9.0.0/reference/be/common-definitions#test.timeout) attribute according
...
test's [`size`](/versions/9.0.0/reference/be/common-definitions#test.size) as follows:
...
[Common definitions](/versions/9.0.0/reference/be/common-definitions#common-attributes-tests).
...
specification [here](/versions/9.0.0/reference/be/common-definitions#common-attributes-tests). If
...
[`--test_sharding_strategy`](/versions/9.0.0/reference/command-line-reference#flag--test_sharding_strategy)
and [`shard_count`](/versions/9.0.0/reference/be/common-definitions#common-attributes-tests) to
...
[`--incompatible_check_sharding_support`](/versions/9.0.0/reference/command-line-reference#flag--incompatible_check_sharding_support)
...
<table>
  ...
  <tr>
    ...
    <td>total
      <a href="/versions/9.0.0/reference/be/common-definitions#test.shard_count"><code>shard count</code></a>,
  ...
  <tr>
    ...
    <td>value of
      <a href="/versions/9.0.0/docs/user-manual#flag--test_filter"><code>--test_filter</code></a>,
      if specified</td>
    <td>optional</td>
  </tr>
  <tr>
...
The [execution platform](/versions/9.0.0/extending/platforms) for a test action is determined
via [toolchain resolution](/versions/9.0.0/extending/toolchains#toolchain-resolution), just
like for any other action. Each test rule has an implicitly defined [`test` exec group](/versions/9.0.0/extending/exec-groups#exec-groups-for-native-rules) that,
...
See also the
[Bazel Build Encyclopedia on the `tags` attribute](/versions/9.0.0/reference/be/common-definitions#common.tags).
...
<table>
  ...
  <tr>
    ...
    <tr>
      <td><code>manual &ast;</code></td>
      <td>don't include test target in wildcard target patterns like
        <code>:...</code>, <code>:&ast;</code>, or <code>:all</code></td>
    </tr>
    <tr>
