...
For more details, see [Hermeticity](/versions/9.0.0/basics/hermeticity).
...
The first argument of `load` is a [label](/versions/9.0.0/concepts/labels) identifying a
...
You can use [load visibility](/versions/9.0.0/concepts/visibility#load-visibility) to restrict
...
[Build Encyclopedia](/versions/9.0.0/reference/be/overview), but it is possible
...
<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary" href="/versions/9.0.0/concepts/labels"><span class="material-icons" aria-hidden="true">arrow_back</span>Labels</a></td>
    <td><a class="button button-with-icon button-primary" href="/versions/9.0.0/concepts/dependencies">Dependencies<span class="material-icons icon-after" aria-hidden="true">arrow_forward</span></a></td>
  </tr>
</table>
