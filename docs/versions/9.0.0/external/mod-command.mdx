...
*   `@<repo_name>`: The repo with the given [apparent name](/versions/9.0.0/external/overview#apparent-repo-name) in the context of the `--base_module`.

*   `@@<repo_name>`: The repo with the given [canonical name](/versions/9.0.0/external/overview#canonical-repo-name).
...
*   `--verbose` *default: "false"*: Include in the output graph extra
    ...
    requested the new version if the reason was [Minimal Version Selection](/versions/9.0.0/external/module#version-selection).
