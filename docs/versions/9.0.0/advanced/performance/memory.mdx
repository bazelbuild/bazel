...
[`--host_jvm_args`](/versions/9.0.0/docs/user-manual#host-jvm-args),
...
[`--discard_analysis_cache`](/versions/9.0.0/docs/user-manual#discard-analysis-cache),
[`--nokeep_state_after_build`](/versions/9.0.0/reference/command-line-reference#flag--keep_state_after_build),
and
[`--notrack_incremental_state`](/versions/9.0.0/reference/command-line-reference#flag--track_incremental_state).
...
[Memory Profiling section](/versions/9.0.0/rules/performance#memory-profiling) of our
