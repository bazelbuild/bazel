...
[recommended rules](/versions/6.3.0/rules).
...
After a review by the [Bazel core team](/versions/6.3.0/contribute/contribution-policy), it
...
*   The ruleset follows the best practices and is performant (see
    [the performance guide](/versions/6.3.0/rules/performance)).
