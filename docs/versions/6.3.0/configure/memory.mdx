---
title: 'Running Bazel with Limited RAM'
---
...
[`--host_jvm_args`](/versions/6.3.0/docs/user-manual#host-jvm-args),
...
[`--discard_analysis_cache`](/versions/6.3.0/docs/user-manual#discard-analysis-cache),
