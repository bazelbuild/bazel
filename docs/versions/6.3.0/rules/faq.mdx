...
See the [Rules page](/versions/6.3.0/rules/rules#requesting-output-files) for more information.
...
[runfiles](/versions/6.3.0/rules/rules#runfiles). Instead of using the `path` field, use
...
[set the default outputs](/versions/6.3.0/rules/rules#requesting-output-files).
