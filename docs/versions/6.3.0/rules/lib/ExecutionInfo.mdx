...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="ExecutionInfo">ExecutionInfo</h2>
        <p><pre class="rule-signature"><a class="anchor" href="ExecutionInfo.html">ExecutionInfo</a> ExecutionInfo(requirements={}, exec_group='test')</pre></p>
    ...
    Creates an instance.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> ExecutionInfo.exec_group</pre></p>

    The name of the exec group that is used to execute the test.


        <h2 id="requirements">requirements</h2>
        <p><pre class="rule-signature"><a class="anchor" href="dict.html">dict</a> ExecutionInfo.requirements</pre></p>

    A dict indicating special execution requirements, such as hardware platforms.


        <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> ExecutionInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> ExecutionInfo.to_proto()</pre></p>
