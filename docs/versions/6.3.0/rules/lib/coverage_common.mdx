...
<ul>
    ...
    <a href="#instrumented_files_info">instrumented_files_info</a>
      ...
      <h2 id="instrumented_files_info">instrumented_files_info</h2>
        <p><pre class="rule-signature"><a class="anchor" href="InstrumentedFilesInfo.html">InstrumentedFilesInfo</a> coverage_common.instrumented_files_info(ctx, *, source_attributes=[], dependency_attributes=[], extensions=None, metadata_files=[])</pre></p>
