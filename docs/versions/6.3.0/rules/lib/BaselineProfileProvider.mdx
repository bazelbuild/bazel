...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="BaselineProfileProvider">BaselineProfileProvider</h2>
        <p><pre class="rule-signature"><a class="anchor" href="BaselineProfileProvider.html">BaselineProfileProvider</a> BaselineProfileProvider(files)</pre></p>
    ...
    The <code>BaselineProfileProvider</code> constructor.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> BaselineProfileProvider.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> BaselineProfileProvider.to_proto()</pre></p>
