...
*Recommended*: [Use Bazelisk](/versions/6.3.0/install/bazelisk)
...
*   [Build Bazel from source](/versions/6.3.0/install/compile-source)
...
You can also change your system `PATH` environment variable to make it permanent. Check out how to [set environment variables](/versions/6.3.0/docs/windows#set-environment-variables).
...
*   [Best practices on Windows](/versions/6.3.0/docs/windows#best-practices)
*   [Tutorials](/versions/6.3.0/start/getting-started#tutorials)
...
To build Bazel from scratch instead of installing, see [Compiling from source](/versions/6.3.0/install/compile-source).
