...
*   [Compile Bazel from source](/versions/6.3.0/install/compile-source)
...
*   Access the [bash completion script](/versions/6.3.0/install/completion#bash)
*   Install the [zsh completion script](/versions/6.3.0/install/completion#zsh)
