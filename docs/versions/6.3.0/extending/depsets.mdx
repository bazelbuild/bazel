...
[Depsets](/versions/6.3.0/rules/lib/depset) are a specialized data structure for efficiently
...
[depset](/versions/6.3.0/rules/lib/globals#depset) constructor: it accepts a list of direct
...
[to_list()](/versions/6.3.0/rules/lib/depset#to_list) method. It returns a list of all transitive
...
For more information about using depsets efficiently, see the [performance](/versions/6.3.0/rules/performance) page.

## API Reference

Please see [here](/versions/6.3.0/rules/lib/depset) for more details.
