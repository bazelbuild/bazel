...
Each execution group has its own [toolchain](/versions/6.3.0/docs/toolchains) dependencies and
performs its own [toolchain resolution](/versions/6.3.0/docs/toolchains#toolchain-resolution).
...
[declare](/versions/6.3.0/rules/lib/globals#exec_group)
...
[`cfg`](/versions/6.3.0/rules/lib/attr#label)
attribute param and the
[`config`](/versions/6.3.0/rules/lib/config)
...
[`ctx.actions.run_shell`](/versions/6.3.0/rules/lib/actions#run_shell).
...
Rule authors will also be able to access the [resolved toolchains](/versions/6.3.0/docs/toolchains#toolchain-resolution)
...
[`exec_properties`](/versions/6.3.0/reference/be/common-definitions#common-attributes)
