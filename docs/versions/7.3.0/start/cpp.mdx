...
While Bazel is a [build system](https://bazel.build/versions/7.3.0/basics/build-systems) that
...
Start by [installing Bazel](https://bazel.build/versions/7.3.0/install), if you haven’t
...
section to define some terms and set up your [workspace](https://bazel.build/versions/7.3.0/reference/glossary#workspace).
...
*   The <code>[`WORKSPACE` file](https://bazel.build/versions/7.3.0/reference/glossary#workspace-file)
...
*   One or more <code>[`BUILD` files](https://bazel.build/versions/7.3.0/reference/glossary#build-file)
...
[package](https://bazel.build/versions/7.3.0/reference/glossary#package). (More on packages
...
be found in [this guide](https://bazel.build/versions/7.3.0/reference/be/workspace).

### Understand the BUILD file

A `BUILD` file contains several different types of instructions for Bazel. Each
`BUILD` file requires at least one [rule](https://bazel.build/versions/7.3.0/reference/glossary#rule)
...
`BUILD` file is called a [target](https://bazel.build/versions/7.3.0/reference/glossary#target)
and points to a specific set of source files and [dependencies](https://bazel.build/versions/7.3.0/reference/glossary#dependency).
...
<code>[cc_binary rule](https://bazel.build/versions/7.3.0/reference/be/c-cpp#cc_binary)</code>.
...
![Dependency graph for hello-world displays a single target with a single source file.](/versions/7.3.0/docs/images/cpp-tutorial-stage1.png "Dependency graph for hello-world displays a single target with a single source file.")
...
(using Bazel's built-in <code>[cc_library rule](https://bazel.build/versions/7.3.0/reference/be/c-cpp#cc_library)</code>),
...
![Dependency graph for `hello-world` displays dependency changes after modification to the file.](/versions/7.3.0/docs/images/cpp-tutorial-stage2.png "Dependency graph for `hello-world` displays dependency changes after modification to the file.")
...
![Dependency graph for `hello-world` displays how the target in the main package depends on the target in the `lib` package.](/versions/7.3.0/docs/images/cpp-tutorial-stage3.png "Dependency graph for `hello-world` displays how the target in the main package depends on the target in the `lib` package.")
...
*   To keep focusing on C++, read about common [C++ build use cases](https://bazel.build/versions/7.3.0/tutorials/cpp-use-cases).
*   To get started with building other applications with Bazel, see the tutorials
for [Java](https://bazel.build/versions/7.3.0/start/java), [Android application](https://bazel.build/versions/7.3.0/start/android-app ),
or [iOS application](https://bazel.build/versions/7.3.0/start/ios-app)).
*   To learn more about working with local and remote repositories, read about
[external dependencies](https://bazel.build/versions/7.3.0/docs/external).
*   To learn more about Bazel’s other rules, see this [reference guide](https://bazel.build/versions/7.3.0/rules).
