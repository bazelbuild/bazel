...
<h1 class="page-title" id="modules.AndroidNeverLinkLibrariesProvider">AndroidNeverLinkLibrariesProvider</h1>

{% dynamic setvar source_file "src/main/java/com/google/devtools/build/lib/starlarkbuildapi/android/AndroidNeverLinkLibrariesProviderApi.java" %}
{% dynamic setvar version "7.3.0" %}
{% dynamic setvar original_path "/rules/lib/providers/AndroidNeverLinkLibrariesProvider" %}
{% include "_buttons.html" %}
<!-- {% raw %} -->

Information about neverlink libraries for Android targets.

<h2>Members</h2>
<ul>
    <li>
    <a href="#AndroidNeverLinkLibrariesProvider">AndroidNeverLinkLibrariesProvider</a>
  </li>
      <li>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="AndroidNeverLinkLibrariesProvider">AndroidNeverLinkLibrariesProvider</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/AndroidNeverLinkLibrariesProvider.html">AndroidNeverLinkLibrariesProvider</a> AndroidNeverLinkLibrariesProvider(transitive_neverlink_libraries)</pre></p>

    The <code>AndroidNeverLinkLibrariesProvider</code> constructor.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
                  <tr>
            <td id="AndroidNeverLinkLibrariesProvider.transitive_neverlink_libraries">
              <code>transitive_neverlink_libraries</code>
            </td>
            <td>
                          <a class="anchor" href="../builtins/depset.html">depset</a> of <a class="anchor" href="../builtins/File.html">File</a>s;
                                     required<br/>
                          The transitive neverlink libraries
            </td>
          </tr>
                </tbody>
      </table>
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AndroidNeverLinkLibrariesProvider.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AndroidNeverLinkLibrariesProvider.to_proto()</pre></p>
