...
<h1 class="page-title" id="modules.AppleDynamicFramework">AppleDynamicFramework</h1>

{% dynamic setvar source_file "src/main/java/com/google/devtools/build/lib/starlarkbuildapi/objc/AppleDynamicFrameworkInfoApi.java" %}
{% dynamic setvar version "7.3.0" %}
{% dynamic setvar original_path "/rules/lib/providers/AppleDynamicFramework" %}
...
<ul>
    ...
    <a href="#to_proto">to_proto</a>
      ...
      <h2 id="binary">binary</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../builtins/File.html">File</a> AppleDynamicFramework.binary</pre></p>
    ...
    The multi-architecture dylib binary of the dynamic framework. May be None if the rule providing the framework only specified framework imports.
        ...
        <h2 id="cc_info">cc_info</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/CcInfo.html">CcInfo</a> AppleDynamicFramework.cc_info</pre></p>

    A provider which contains information about the transitive dependencies linked into the dynamic framework.


        <h2 id="framework_dirs">framework_dirs</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../builtins/depset.html">depset</a> AppleDynamicFramework.framework_dirs</pre></p>

    The framework path names used as link inputs in order to link against the dynamic framework.


        <h2 id="framework_files">framework_files</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../builtins/depset.html">depset</a> AppleDynamicFramework.framework_files</pre></p>

    The full set of files that should be included as inputs to link against the dynamic framework.


        <h2 id="objc">objc</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/ObjcProvider.html">ObjcProvider</a> AppleDynamicFramework.objc</pre></p>

    <b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>A provider which contains information about the transitive dependencies linked into the dynamic framework.


        <h2 id="to_json">to_json</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AppleDynamicFramework.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> AppleDynamicFramework.to_proto()</pre></p>
