...
[Workspace rules](/versions/7.3.0/reference/be/workspace) allow the developer to add dependencies to
...
introduced through
[`repository_ctx`](/versions/7.3.0/rules/lib/builtins/repository_ctx) which allows interacting
...
[`repository_ctx`](/versions/7.3.0/rules/lib/builtins/repository_ctx).
