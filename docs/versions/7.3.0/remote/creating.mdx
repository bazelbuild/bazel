...
[Persistent workers](/versions/7.3.0/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/7.3.0/remote/multiplex).
...
[Implementing persistent workers](/versions/7.3.0/remote/persistent#implementation).
