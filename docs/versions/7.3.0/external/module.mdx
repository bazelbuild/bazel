...
See the [full list](/versions/7.3.0/rules/lib/globals/module) of directives available in `MODULE.bazel` files.
...
`MODULE.bazel` file from a [Bazel registry](/versions/7.3.0/external/registry) until it
...
[`--allow_yanked_versions`](/versions/7.3.0/reference/command-line-reference#flag--allow_yanked_versions)
...
The [`single_version_override`](/versions/7.3.0/rules/lib/globals/module#single_version_override)
...
A [`multiple_version_override`](/versions/7.3.0/rules/lib/globals/module#multiple_version_override)
...
*   [`archive_override`](/versions/7.3.0/rules/lib/globals/module#archive_override)
*   [`git_override`](/versions/7.3.0/rules/lib/globals/module#git_override)
*   [`local_path_override`](/versions/7.3.0/rules/lib/globals/module#local_path_override)
...
The [apparent name](/versions/7.3.0/external/overview#apparent-repo-name) of a repo backing a
module to its direct dependents defaults to its module name, unless the
`repo_name` attribute of the [`bazel_dep`](/versions/7.3.0/rules/lib/globals/module#bazel_dep)
...
The [canonical name](/versions/7.3.0/external/overview#canonical-repo-name) of a repo backing a
...
[`multiple_version_override`](/versions/7.3.0/rules/lib/globals/module#multiple_version_override)).
...
*    In BUILD and `.bzl` files, use
     [`Label.repo_name`](/versions/7.3.0/rules/lib/builtins/Label#repo_name) on a `Label` instance
...
*    When looking up runfiles, use
     [`$(rlocationpath ...)`](https://bazel.build/versions/7.3.0/reference/be/make-variables#predefined_label_variables)
...
[Module extensions](/versions/7.3.0/external/extension) can also introduce additional repos
