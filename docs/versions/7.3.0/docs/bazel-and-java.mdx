...
*   [Tutorial: Building a Java Project](/versions/7.3.0/start/java)
*   [Java rules](/versions/7.3.0/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/7.3.0/migrate/maven)
...
[Java language version flag](/versions/7.3.0/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/7.3.0/docs/user-manual#java_runtime_version).
...
In addition to [general Bazel best practices](/versions/7.3.0/configure/best-practices), below are
...
*   The sources should be a non-recursive [`glob`](/versions/7.3.0/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/7.3.0/extending/concepts) when building your Java
projects:

*   Main Java module: [`java_common`](/versions/7.3.0/rules/lib/toplevel/java_common)
*   Main Java provider: [`JavaInfo`](/versions/7.3.0/rules/lib/providers/JavaInfo)
*   Configuration fragment: [`java`](/versions/7.3.0/rules/lib/fragments/java)
*   Other modules:

    *   [`java_annotation_processing`](/versions/7.3.0/rules/lib/builtins/java_annotation_processing)
    *   [`java_compilation_info`](/versions/7.3.0/rules/lib/providers/java_compilation_info)
    *   [`java_output`](/versions/7.3.0/rules/lib/builtins/java_output)
    *   [`java_output_jars`](/versions/7.3.0/rules/lib/providers/java_output_jars)
    *   [`JavaRuntimeInfo`](/versions/7.3.0/rules/lib/providers/JavaRuntimeInfo)
    *   [`JavaToolchainInfo`](/versions/7.3.0/rules/lib/providers/JavaToolchainInfo)
...
[`--extra_toolchains`](/versions/7.3.0/docs/user-manual#extra-toolchains) flag.
