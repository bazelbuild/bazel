...
[build configurations](/versions/7.0.0/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/7.0.0/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/7.0.0/docs/sandboxing)_. On supported
