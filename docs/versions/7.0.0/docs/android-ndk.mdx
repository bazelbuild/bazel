...
![Example results](/versions/7.0.0/docs/images/android_ndk.png "Build graph results")
...
`--linkopt` in the [User Manual](/versions/7.0.0/docs/user-manual#cxxopt).
...
[platforms](/versions/7.0.0/extending/platforms) and
[toolchains](/versions/7.0.0/extending/toolchains). If your
...
use [Bazel wild-cards](/versions/7.0.0/run/build#specifying-build-targets) like
`/...` and `:all`.
