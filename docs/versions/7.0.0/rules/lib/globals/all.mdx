...
Methods available in all Bazel files, including .bzl files, BUILD, MODULE.bazel, and WORKSPACE.
...
<pre class="language-python">enumerate([24, 21, 84]) == [(0, 24), (1, 21), (2, 84)]</pre>
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <h2 id="fail">fail</h2>
        <p><pre class="rule-signature"><code>None</code> fail(msg=None, attr=None, *args)</pre></p>
