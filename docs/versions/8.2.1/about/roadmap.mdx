...
We plan to bring Bazel 8.0 [long term support (LTS)](https://bazel.build/versions/8.2.1/release/versioning) to you in late 2024.
The following features are planned to be implemented.

### Bzlmod: external dependency management system

[Bzlmod](https://bazel.build/versions/8.2.1/docs/bzlmod) automatically resolves transitive
...
[Bazel's external dependency management](https://docs.google.com/document/d/1moQfNcEIttsk6vYanNKIy3ZuK53hQUFq1b1r0rmsYVg/edit#heading=h.lgyp7ubwxmjc)
