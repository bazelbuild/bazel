...
If you are looking to contribute to Bazel, please read [Contributing to Bazel](/versions/8.2.1/contribute) instead.
...
Bazel's [core group of contributors](/versions/8.2.1/contribute/policy) has dedicated
...
*   [`team-Rules-CPP`](https://github.com/bazelbuild/bazel/labels/team-Rules-CPP) / [`team-Rules-ObjC`](https://github.com/bazelbuild/bazel/labels/team-Rules-ObjC): Issues for C++/Objective-C rules, including native Apple rule logic
    * Contact: [buildbreaker2021](https://github.com/buildbreaker2021)
