...
| --- | --- |
| `name` | [string](/versions/8.2.1/rules/lib/core/string); required |
...
| Parameter | Description |
| --- | --- |
| `include` | [sequence](/versions/8.2.1/rules/lib/core/list) of [string](/versions/8.2.1/rules/lib/core/string)s; required |
