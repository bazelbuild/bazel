...
For more details, see [Hermeticity](/versions/8.2.1/basics/hermeticity).
...
The first argument of `load` is a [label](/versions/8.2.1/concepts/labels) identifying a
...
You can use [load visibility](/versions/8.2.1/concepts/visibility#load-visibility) to restrict
...
[Build Encyclopedia](/versions/8.2.1/reference/be/overview), but it is possible
