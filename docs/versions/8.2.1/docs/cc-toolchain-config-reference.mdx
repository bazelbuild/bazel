...
[`CcToolchainConfigInfo`](/versions/8.2.1/rules/lib/providers/CcToolchainConfigInfo) is a provider that provides the necessary level of
...
[`toolchain_config`](/versions/8.2.1/reference/be/c-cpp#cc_toolchain.toolchain_config) attribute of the
[`cc_toolchain`](/versions/8.2.1/reference/be/c-cpp#cc_toolchain) to your rule.
You can create the `CcToolchainConfigInfo` by calling
[`cc_common.create_cc_toolchain_config_info()`](/versions/8.2.1/rules/lib/toplevel/cc_common#create_cc_toolchain_config_info).
...
1.  User specifies a `cc_toolchain_suite` target in the `BUILD` file and points
    ...
    [`--crosstool_top` option](/versions/8.2.1/docs/user-manual#flag--crosstool_top).
...
<table>
  ...
  <tr>
   <td>
     <code>preprocess-assemble</code>
   </td>
   <td>
     Assemble with preprocessing. Typically for <code>.S</code> files.
   </td>
  </tr>
  <tr>
   <td>
   ...
   <td>
     Assemble without preprocessing. Typically for <code>.s</code> files.
   </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
   <td>
     <code>cc-flags-make-variable</code>
   </td>
   <td>
     Propagates <code>CC_FLAGS</code> to genrules.
   </td>
  </tr>
  <tr>
   <td>
...
<table>
  ...
  <tr>
   <td>
     <code>c++-link-dynamic-library</code>
   </td>
   <td>
  ...
  <tr>
   <td>
     <code>c++-link-nodeps-dynamic-library</code>
   </td>
   <td>
     Link a shared library only containing <code>cc_library</code> sources.
   </td>
  </tr>
  <tr>
   <td>
     <code>c++-link-executable</code>
   </td>
   <td>
...
<table>
  ...
  <tr>
   <td>
     <code>c++-link-static-library</code>
   </td>
   <td>
...
<table>
  ...
  <tr>
   <td>
     <strong><code>source_file</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>input_file</code></strong>
   </td>
   <td>
     strip
   </td>
  ...
  <tr>
   <td>
     <strong><code>output_file</code></strong>
   </td>
   <td>
     compile, strip
   </td>
  ...
  <tr>
   <td>
     <strong><code>output_assembly_file</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>output_preprocess_file</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>include_paths</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>quote_include_paths</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>system_include_paths</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>dependency_file</code></strong>
   </td>
   <td>
     compile
   </td>
   <td>
     The <code>.d</code> dependency file generated by the compiler.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>preprocessor_defines</code></strong>
   </td>
   <td>
     compile
   </td>
   <td>
     Sequence of <code>defines</code>, such as <code>--DDEBUG</code>.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>pic</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>gcov_gcno_file</code></strong>
   </td>
   <td>
     compile
   </td>
   <td>
     The <code>gcov</code> coverage file.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>per_object_debug_info_file</code></strong>
   </td>
   <td>
     compile
   </td>
   <td>
     The per-object debug info (<code>.dwp</code>) file.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>stripopts</code></strong>
   </td>
   <td>
     strip
   </td>
   <td>
     Sequence of <code>stripopts</code>.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>legacy_compile_flags</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>user_compile_flags</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>unfiltered_compile_flags</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>sysroot</code></strong>
   </td>
   <td>&nbsp;</td>
   <td>
     The <code>sysroot</code>.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>runtime_library_search_directories</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>library_search_directories</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>libraries_to_link</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>def_file_path</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>linker_param_file</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>output_execpath</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>generate_interface_library</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>interface_library_builder_path</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>interface_library_input_path</code></strong>
   </td>
   <td>
     link
   </td>
   <td>
     Input for the interface library <code>ifso</code> builder tool.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>interface_library_output_path</code></strong>
   </td>
   <td>
     link
   </td>
   <td>
     Path where to generate interface library using the <code>ifso</code> builder tool.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>legacy_link_flags</code></strong>
   </td>
   <td>
     link
   </td>
   <td>
     Linker flags coming from the legacy <code>CROSSTOOL</code> fields.
   </td>
  </tr>
  <tr>
   <td>
     <strong><code>user_link_flags</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>linkstamp_paths</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>force_pic</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>strip_debug_symbols</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>is_cc_test</code></strong>
   </td>
   <td>
     link
   </td>
  ...
  <tr>
   <td>
     <strong><code>is_using_fission</code></strong>
   </td>
   <td>
     compile, link
   </td>
  ...
  <tr>
   <td>
     <strong><code>fdo_instrument_path</code></strong>
   </td>
   <td>
     compile, link
   </td>
  ...
  <tr>
   <td>
     <strong><code>fdo_profile_path</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>fdo_prefetch_hints_path</code></strong>
   </td>
   <td>
     compile
   </td>
  ...
  <tr>
   <td>
     <strong><code>cs_fdo_instrument_path</code></strong>
   </td>
   <td>
     compile, link
   </td>
...
<table>
  ...
  <tr>
   <td>
     <strong><code>opt | dbg | fastbuild</code></strong>
   </td>
   <td>
  ...
  <tr>
   <td>
     <strong><code>per_object_debug_info</code></strong>
   </td>
    <td>
  ...
  <tr>
   <td>
     <strong><code>supports_start_end_lib</code></strong>
   </td>
   <td>
  ...
  <tr>
   <td>
     <strong><code>supports_interface_shared_libraries</code></strong>
   </td>
   <td>
  ...
  <tr>
   <td>
     <strong><code>supports_dynamic_linker</code></strong>
   </td>
   <td>
  ...
  <tr>
   <td>
     <strong><code>static_link_cpp_runtimes</code></strong>
   </td>
   <td>
  ...
  <tr>
   <td>
     <strong><code>supports_pic</code></strong>
   </td>
   <td>
  ...
  <tr>
     <td>
       <strong><code>no_legacy_features</code></strong>
     </td>
     <td>
