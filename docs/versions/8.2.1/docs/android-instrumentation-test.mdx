...
_If you're new to Bazel, start with the [Building Android with Bazel](/versions/8.2.1/start/android-app) tutorial._

![Running Android instrumentation tests in parallel](/versions/8.2.1/docs/images/android_test.gif "Android instrumentation test")

**Figure 1.** Running parallel Android instrumentation tests.

[`android_instrumentation_test`](/versions/8.2.1/reference/be/android#android_instrumentation_test)
...
![The target dependency graph on an Android instrumentation test](/versions/8.2.1/docs/images/android_instrumentation_test.png "Target dependency graph")
