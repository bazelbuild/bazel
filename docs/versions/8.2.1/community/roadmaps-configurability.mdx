...
We also support
[`cquery`](https://bazel.build/versions/8.2.1/query/cquery), [`Starlark configuration`](https://bazel.build/versions/8.2.1/extending/config),
and
[`select()`](https://bazel.build/versions/8.2.1/docs/configurable-attributes).
...
<span class="etabox">Q3 2021</span>**Android rules use the new [platforms API](https://bazel.build/versions/8.2.1/concepts/platforms)**
...
<div class="padbottom"></div>
<span class="etabox">paused</span>**C++ rules use the new [platformsfall API](https://bazel.build/versions/8.2.1/concepts/platforms)**
