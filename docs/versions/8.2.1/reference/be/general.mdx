...
* [`values`](/versions/8.2.1/reference/be/general#config_setting.values),
  [`define_values`](/versions/8.2.1/reference/be/general#config_setting.define_values), and
  [`constraint_values`](/versions/8.2.1/reference/be/general#config_setting.constraint_values)
...
| `output_to_bindir` | Boolean; [nonconfigurable](/versions/8.2.1/reference/be/common-definitions#configurable-attributes); default is `False`  If set to True, this option causes output files to be written into the `bin` directory instead of the `genfiles` directory. |
