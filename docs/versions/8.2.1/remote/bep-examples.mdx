...
![bep-graph](/versions/8.2.1/docs/images/bep-graph.png "BEP graph")
...
pairs. When building with [aspects](/versions/8.2.1/extending/aspects) enabled, Bazel
...
event, which matches the structure of a Starlark [Depset](/versions/8.2.1/extending/depsets).
...
![namedsetoffiles-bep-graph](/versions/8.2.1/docs/images/namedsetoffiles-bep-graph.png "NamedSetOfFiles BEP graph")
