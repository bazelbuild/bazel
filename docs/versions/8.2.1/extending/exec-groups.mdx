...
Each execution group has its own [toolchain](/versions/8.2.1/extending/toolchains) dependencies and
performs its own [toolchain resolution](/versions/8.2.1/extending/toolchains#toolchain-resolution).
...
[declare](/versions/8.2.1/rules/lib/globals/bzl#exec_group)
...
[`cfg`](/versions/8.2.1/rules/lib/toplevel/attr#label)
...
param of action generating methods, specifically [`ctx.actions.run`](/versions/8.2.1/rules/lib/builtins/actions#run) and
[`ctx.actions.run_shell`](/versions/8.2.1/rules/lib/builtins/actions#run_shell).
...
Rule authors will also be able to access the [resolved toolchains](/versions/8.2.1/extending/toolchains#toolchain-resolution)
...
[`exec_properties`](/versions/8.2.1/reference/be/common-definitions#common-attributes)
