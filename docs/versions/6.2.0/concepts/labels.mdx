...
[target patterns](/versions/6.2.0/docs/build#specifying-build-targets).
...
[Bazel Query Language](/versions/6.2.0/reference/query).
...
outputs as described in the [Build Encyclopedia](/versions/6.2.0/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/6.2.0/reference/be/overview) for a
...
[General Rules: genrule](/versions/6.2.0/reference/be/general#genrule).
...
[Bazel Query tool](/versions/6.2.0/docs/query-how-to) operates.

<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/6.2.0/concepts/build-ref">
