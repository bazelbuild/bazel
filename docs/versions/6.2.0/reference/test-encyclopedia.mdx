...
Tests are run using [`bazel test`](/versions/6.2.0/docs/user-manual#test).
...
[`timeout`](/versions/6.2.0/reference/be/common-definitions#test.timeout) attribute according
...
test's [`size`](/versions/6.2.0/reference/be/common-definitions#test.size) as follows:
...
[Common definitions](/versions/6.2.0/reference/be/common-definitions#common-attributes-tests).
...
specification [here](/versions/6.2.0/reference/be/common-definitions#common-attributes-tests). If
...
[`--test_sharding_strategy`](/versions/6.2.0/docs/user-manual#running-executables) and
[`shard_count`](/versions/6.2.0/reference/be/common-definitions#common-attributes-tests) to enable
...
<table>
  ...
  <tr>
    ...
    <td>total
      <a href="/versions/6.2.0/reference/be/common-definitions#test.shard_count"><code>shard count</code></a>,
  ...
  <tr>
    ...
    <td>value of
      <a href="/versions/6.2.0/docs/user-manual#flag--test_filter"><code>--test_filter</code></a>,
      if specified</td>
    <td>optional</td>
  </tr>
  <tr>
...
[Bazel Build Encyclopedia on the `tags` attribute](/versions/6.2.0/reference/be/common-definitions#common.tags).
