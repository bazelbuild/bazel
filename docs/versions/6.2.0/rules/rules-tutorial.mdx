...
See the
[Bazel](/versions/6.2.0/start/getting-started) and [Starlark](/versions/6.2.0/rules/concepts) documentation for
...
To analyze the targets, use the [`cquery`](/versions/6.2.0/docs/cquery) ("configured
...
[`exports_files`](/versions/6.2.0/reference/be/functions#exports_files):
