...
functions and types, see the [Bazel API reference](/versions/6.2.0/rules/lib/starlark-overview).
...
[Native functions](/versions/6.2.0/reference/be/functions) and [native rules](
