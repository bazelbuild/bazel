...
*   [Tutorial: Building a Java Project](/versions/6.2.0/tutorials/java)
*   [Java rules](/versions/6.2.0/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/6.2.0/migrate/maven)
...
[Java language version flag](/versions/6.2.0/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/6.2.0/docs/user-manual#java_runtime_version).
...
In addition to [general Bazel best practices](/versions/6.2.0/docs/best-practices), below are
...
*   The sources should be a non-recursive [`glob`](/versions/6.2.0/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/6.2.0/rules/concepts) when building your Java
projects:

*   Main Java provider: [`java_common`](/versions/6.2.0/rules/lib/java_common)
*   Main Java module: [`JavaInfo`](/versions/6.2.0/rules/lib/JavaInfo)
*   Configuration fragment: [`java`](/versions/6.2.0/rules/lib/java)
*   Other modules:

    *   [`java_annotation_processing`](/versions/6.2.0/rules/lib/java_annotation_processing)
    *   [`java_compilation_info`](/versions/6.2.0/rules/lib/java_compilation_info)
    *   [`java_output`](/versions/6.2.0/rules/lib/java_output)
    *   [`java_output_jars`](/versions/6.2.0/rules/lib/java_output_jars)
    *   [`JavaRuntimeInfo`](/versions/6.2.0/rules/lib/JavaRuntimeInfo)
    *   [`JavaToolchainInfo`](/versions/6.2.0/rules/lib/JavaToolchainInfo)
...
[`--extra_toolchains`](/versions/6.2.0/docs/user-manual#extra-toolchains) flag.
