...
![Roadmap](/versions/6.2.0/docs/images/roadmap.png "Roadmap")
...
* For more information on updating your Bazel version, see
  [Updating Bazel](/versions/6.2.0/versions/updating-bazel).
* For more information on contributing updates to new Bazel releases, see
  [Contributing to Bazel](/versions/6.2.0/contribute).
