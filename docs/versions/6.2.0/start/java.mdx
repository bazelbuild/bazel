...
To prepare for the tutorial, first [Install Bazel](/versions/6.2.0/install) if
...
[`java_binary` rule](/versions/6.2.0/reference/be/java#java_binary). The rule tells Bazel to
...
uses [glob](/versions/6.2.0/reference/be/functions#glob) to pass a set of source files to Bazel
...
![Dependency graph of the target 'ProjectRunner'](/versions/6.2.0/docs/images/tutorial_java_01.svg)
...
![Dependency graph of the target 'runner'](/versions/6.2.0/docs/images/tutorial_java_03.svg)
...
As you remember, the [java_binary](/versions/6.2.0/reference/be/java#java_binary) build rule
...
*  [External Dependencies](/versions/6.2.0/docs/external) to learn more about working with
   local and remote repositories.

*  The [other rules](/versions/6.2.0/rules) to learn more about Bazel.

*  The [C++ build tutorial](/versions/6.2.0/tutorials/cpp) to get started with building
   C++ projects with Bazel.

*  The [Android application tutorial](/versions/6.2.0/tutorials/android-app) and
   [iOS application tutorial](/versions/6.2.0/tutorials/ios-app) to get started with
