...
We also support
[`cquery`](https://bazel.build/versions/8.1.1/query/cquery), [`Starlark configuration`](https://bazel.build/extending/config),
and
...
<span class="etabox">Q3 2021</span>**Android rules use the new [platforms API](https://bazel.build/concepts/platforms)**
