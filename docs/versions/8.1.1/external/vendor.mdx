...
to vendor, it accepts both [canonical repo name](/versions/8.1.1/external/overview#canonical-repo-name) and [apparent repo name](/versions/8.1.1/external/overview#apparent-repo-name).
...
[canonical repo names](/versions/8.1.1/external/overview#canonical-repo-name) as arguments:
...
[`local`](/versions/8.1.1/rules/lib/globals/bzl#repository_rule.local) or
[`configure`](/versions/8.1.1/rules/lib/globals/bzl#repository_rule.configure) set to true are
