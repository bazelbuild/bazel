...
We plan to bring Bazel 8.0 [long term support (LTS)](https://bazel.build/versions/8.1.1/release/versioning) to you in late 2024.
The following features are planned to be implemented.

### Bzlmod: external dependency management system

[Bzlmod](https://bazel.build/versions/8.1.1/docs/bzlmod) automatically resolves transitive
