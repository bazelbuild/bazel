...
[build configurations](/versions/8.1.1/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/8.1.1/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/8.1.1/docs/sandboxing)_. On supported
