...
file.](/versions/8.1.1/docs/images/cpp-tutorial-stage1.png "Dependency graph for hello-world
...
modification to the file.](/versions/8.1.1/docs/images/cpp-tutorial-stage2.png "Dependency
...
package.](/versions/8.1.1/docs/images/cpp-tutorial-stage3.png "Dependency graph for
...
*   To get started with building other applications with Bazel, see the
    tutorials for [Java](https://bazel.build/versions/8.1.1/start/java), [Android
