...
As part of [adapting Bazel rules for remote execution](/versions/8.1.1/remote/rules), you need to find such workspace rules
...
[Workspace rules](/versions/8.1.1/reference/be/workspace) allow the developer to add dependencies to
...
introduced through
[`repository_ctx`](/versions/8.1.1/rules/lib/builtins/repository_ctx) which allows interacting
...
[`repository_ctx`](/versions/8.1.1/rules/lib/builtins/repository_ctx).
