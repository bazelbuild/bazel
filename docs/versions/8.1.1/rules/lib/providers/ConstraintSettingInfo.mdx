...
A specific constraint setting that may be used to define a platform. See [Defining Constraints and Platforms](/versions/8.1.1/docs/platforms#constraints-platforms) for more information.
