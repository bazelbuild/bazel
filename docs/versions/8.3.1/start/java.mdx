...
To prepare for the tutorial, first [Install Bazel](/versions/8.3.1/install) if
...
[`java_binary` rule](/versions/8.3.1/reference/be/java#java_binary). The rule tells Bazel to
...
uses [glob](/versions/8.3.1/reference/be/functions#glob) to pass a set of source files to Bazel
...
![Dependency graph of the target 'ProjectRunner'](/versions/8.3.1/docs/images/tutorial_java_01.svg)
...
![Dependency graph of the target 'ProjectRunner' after adding a dependency](/versions/8.3.1/docs/images/tutorial_java_02.svg)
...
![Dependency graph of the target 'runner'](/versions/8.3.1/docs/images/tutorial_java_03.svg)
...
As you remember, the [java_binary](/versions/8.3.1/reference/be/java#java_binary) build rule
...
*  [External Dependencies](/versions/8.3.1/docs/external) to learn more about working with
   local and remote repositories.

*  The [other rules](/versions/8.3.1/rules) to learn more about Bazel.

*  The [C++ build tutorial](/versions/8.3.1/start/cpp) to get started with building
   C++ projects with Bazel.

*  The [Android application tutorial](/versions/8.3.1/start/android-app) and
   [iOS application tutorial](/versions/8.3.1/start/ios-app)) to get started with
