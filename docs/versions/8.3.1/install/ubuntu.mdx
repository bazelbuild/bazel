...
*   *Recommended*: [Use Bazelisk](/versions/8.3.1/install/bazelisk)
...
*   [Compile Bazel from source](/versions/8.3.1/install/compile-source)
...
*   Access the [bash completion script](/versions/8.3.1/install/completion#bash)
*   Install the [zsh completion script](/versions/8.3.1/install/completion#zsh)
