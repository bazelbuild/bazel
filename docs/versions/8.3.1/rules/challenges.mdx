...
changes such as changes to file attributes. [Sandboxing](/versions/8.3.1/docs/sandboxing)
...
have designed [Skyframe](/versions/8.3.1/reference/skyframe) to handle this
...
[depset](/versions/8.3.1/rules/lib/builtins/depset)
