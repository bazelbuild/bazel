...
* `COMPILATION_MODE`:
  `fastbuild`, `dbg`, or `opt`. ([more details](https://bazel.build/versions/8.3.1/docs/user-manual#flag--compilation_mode))
...
[TemplateVariableInfo](/versions/8.3.1/rules/lib/providers/TemplateVariableInfo)
