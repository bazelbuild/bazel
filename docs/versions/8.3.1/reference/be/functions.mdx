...
| `default_deprecation` | String; default is `""`  Sets the default [`deprecation`](/versions/8.3.1/reference/be/common-definitions#common.deprecation) message for all rules in this package. |
...
| `default_testonly` | Boolean; default is `False` except as noted  Sets the default [`testonly`](/versions/8.3.1/reference/be/common-definitions#common.testonly) property for all rules in this package.  In packages under `javatests` the default value is `True`. |
...
[visibility](/versions/8.3.1/reference/be/common-definitions#common.visibility)
attribute.
...
function. The [licenses](/versions/8.3.1/reference/be/common-definitions#common.licenses)
...
[configurable](/versions/8.3.1/reference/be/common-definitions#configurable-attributes).
