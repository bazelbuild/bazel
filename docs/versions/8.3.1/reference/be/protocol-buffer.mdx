...
`deps` must point to [`proto_library`](/versions/8.3.1/reference/be/protocol-buffer#proto_library) rules.
...
| `deps` | List of [labels](/versions/8.3.1/concepts/labels); default is `[]` The list of [`proto_library`](/versions/8.3.1/reference/be/protocol-buffer#proto_library) rules to generate C++ code for. |
...
| --- | --- |
| `name` | [Name](/versions/8.3.1/concepts/labels#target-names); required  A unique name for this target. |
| `deps` | List of [labels](/versions/8.3.1/concepts/labels); default is `[]` The list of [`proto_library`](/versions/8.3.1/reference/be/protocol-buffer#proto_library) rules to generate Java code for. |
