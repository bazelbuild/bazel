...
function foo() \{
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.3.1/docs/images/a_b_c.svg"
...
<table class="cyan">
  ...
  <tr>
    ...
    <td>
      <figure>
        <img src="/versions/8.3.1/docs/images/a_b_c_ac.svg"
...
<table class="cyan">
  ...
  <tr>
    <td>
      <figure>
        <img src="/versions/8.3.1/docs/images/ab_c.svg"
    ...
    <td>
      <figure>
        <img src="/versions/8.3.1/docs/images/a_b_a_c.svg"
...
more details, see
[Attributes common to all rules](/versions/8.3.1/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/8.3.1/reference/be/).
...
<p><span class="compare-worse">Not recommended</span> —
  <code>data = ["//data/regression:unittest/."]</code></p>

<p><span class="compare-worse">Not recommended</span> —
  <code>data = ["testdata/."]</code></p>
...
[`glob()`](/versions/8.3.1/reference/be/functions#glob) function. (Use `**` to force the
`glob()` to be recursive.)

<p><span class="compare-better">Recommended</span> —
  <code>data = glob(["testdata/**"])</code></p>
...
conform to the [label syntax](/versions/8.3.1/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/8.3.1/reference/be/functions#glob) function produces an invalid labels
...
<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.3.1/concepts/build-files"><span class="material-icons" aria-hidden="true">arrow_back</span>BUILD files</a></td>
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.3.1/concepts/visibility">Visibility<span class="material-icons icon-after" aria-hidden="true">arrow_forward</span></a></td>
  </tr>
</table>
