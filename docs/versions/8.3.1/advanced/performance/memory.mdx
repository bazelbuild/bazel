...
[`--host_jvm_args`](/versions/8.3.1/docs/user-manual#host-jvm-args),
...
[`--discard_analysis_cache`](/versions/8.3.1/docs/user-manual#discard-analysis-cache),
[`--nokeep_state_after_build`](/versions/8.3.1/reference/command-line-reference#flag--keep_state_after_build),
and
[`--notrack_incremental_state`](/versions/8.3.1/reference/command-line-reference#flag--track_incremental_state).
...
[Memory Profiling section](/versions/8.3.1/rules/performance#memory-profiling) of our
