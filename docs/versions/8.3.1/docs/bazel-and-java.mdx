...
*   [Tutorial: Building a Java Project](/versions/8.3.1/start/java)
*   [Java rules](/versions/8.3.1/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/8.3.1/migrate/maven)
...
[Java language version flag](/versions/8.3.1/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/8.3.1/docs/user-manual#java_runtime_version).
...
In addition to [general Bazel best practices](/versions/8.3.1/configure/best-practices), below are
...
*   The sources should be a non-recursive [`glob`](/versions/8.3.1/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/8.3.1/extending/concepts) when building your Java
projects:

*   Main Java module: [`java_common`](/versions/8.3.1/rules/lib/toplevel/java_common)
*   Main Java provider: [`JavaInfo`](/versions/8.3.1/rules/lib/providers/JavaInfo)
*   Configuration fragment: [`java`](/versions/8.3.1/rules/lib/fragments/java)
*   Other modules:

    *   [`java_annotation_processing`](/versions/8.3.1/rules/lib/builtins/java_annotation_processing)
    *   [`java_compilation_info`](/versions/8.3.1/rules/lib/providers/java_compilation_info)
    *   [`java_output_jars`](/versions/8.3.1/rules/lib/providers/java_output_jars)
    *   [`JavaRuntimeInfo`](/versions/8.3.1/rules/lib/providers/JavaRuntimeInfo)
    *   [`JavaToolchainInfo`](/versions/8.3.1/rules/lib/providers/JavaToolchainInfo)
...
[`--extra_toolchains`](/versions/8.3.1/docs/user-manual#extra-toolchains) flag.
