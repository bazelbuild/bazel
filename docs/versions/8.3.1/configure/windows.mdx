...
instructions, see [Install Bazel on Windows](/versions/8.3.1/install/windows).
...
To avoid hitting this issue, you can specify a short output directory for Bazel by the [\-\-output_user_root](/versions/8.3.1/reference/command-line-reference#flag--output_user_root) flag.
...
* [\-\-windows_enable_symlinks](/versions/8.3.1/reference/command-line-reference#flag--windows_enable_symlinks)
* [\-\-enable_runfiles](/versions/8.3.1/reference/command-line-reference#flag--enable_runfiles)
...
*   [The Visual C++ compiler](/versions/8.3.1/install/windows#install-vc).
...
*   [The Java SE Development Kit](/versions/8.3.1/install/windows#install-jdk)
...
*   The [Python interpreter](/versions/8.3.1/install/windows#install-python)
