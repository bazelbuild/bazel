...
[Persistent workers](/versions/UNSAFE_release-9.1.0/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/UNSAFE_release-9.1.0/remote/multiplex).
...
[Implementing persistent workers](/versions/UNSAFE_release-9.1.0/remote/persistent#implementation).
