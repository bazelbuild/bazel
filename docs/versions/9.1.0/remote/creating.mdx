...
[Persistent workers](/versions/9.1.0/remote/persistent) can make your build faster. If
...
[multiplex sandboxing](/versions/9.1.0/remote/multiplex).
...
[Implementing persistent workers](/versions/9.1.0/remote/persistent#implementation).
