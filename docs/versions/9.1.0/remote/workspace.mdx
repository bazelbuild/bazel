...
execution](/versions/9.1.0/remote/rules), you need to find such workspace rules
...
[Workspace rules](/versions/9.1.0/reference/be/workspace) allow the developer to add dependencies to
...
introduced through
[`repository_ctx`](/versions/9.1.0/rules/lib/builtins/repository_ctx) which allows interacting
