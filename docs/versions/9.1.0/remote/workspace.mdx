...
[Workspace rules](/versions/UNSAFE_release-9.1.0/reference/be/workspace) allow the developer to add dependencies to
...
introduced through
[`repository_ctx`](/versions/UNSAFE_release-9.1.0/rules/lib/builtins/repository_ctx) which allows interacting
