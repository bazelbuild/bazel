...
*   [Build Bazel from source](/versions/UNSAFE_release-9.1.0/install/compile-source)
...
You can also change your system `PATH` environment variable to make it permanent. Check out how to [set environment variables](/versions/UNSAFE_release-9.1.0/configure/windows#set-environment-variables).
...
*   [Best practices on Windows](/versions/UNSAFE_release-9.1.0/configure/windows#best-practices)
*   [Tutorials](/versions/UNSAFE_release-9.1.0/start/#tutorials)
...
To build Bazel from scratch instead of installing, see [Compiling from source](/versions/UNSAFE_release-9.1.0/install/compile-source).
