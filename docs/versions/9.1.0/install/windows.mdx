...
*   [Build Bazel from source](/versions/9.1.0/install/compile-source)
...
You can also change your system `PATH` environment variable to make it permanent. Check out how to [set environment variables](/versions/9.1.0/configure/windows#set-environment-variables).
...
*   [Best practices on Windows](/versions/9.1.0/configure/windows#best-practices)
*   [Tutorials](/versions/9.1.0/start/#tutorials)
...
guide](/versions/9.1.0/contribute/windows-chocolatey-maintenance) for more
...
guide](/versions/9.1.0/contribute/windows-scoop-maintenance) for more
information about the Scoop package.

### Build from source {#build-from-source}

To build Bazel from scratch instead of installing, see [Compiling from source](/versions/9.1.0/install/compile-source).
