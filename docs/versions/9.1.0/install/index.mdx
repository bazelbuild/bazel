...
[Bazelisk](/versions/UNSAFE_release-9.1.0/install/bazelisk) is the recommended way to install Bazel on [Ubuntu Linux](/versions/UNSAFE_release-9.1.0/install/ubuntu), [macOS](/versions/UNSAFE_release-9.1.0/install/os-x), and [Windows](/versions/UNSAFE_release-9.1.0/install/windows).

You can find available Bazel releases on our [release page](/versions/UNSAFE_release-9.1.0/release).
...
*   [openSUSE](/versions/UNSAFE_release-9.1.0/install/suse)
...
For other platforms, you can try to [compile from source](/versions/UNSAFE_release-9.1.0/install/compile-source).
