...
For practical use cases, see the [Bazel Query How-To](/versions/9.1.0/query/guide).
...
For more details, see the [aquery reference](/versions/9.1.0/query/aquery).
...
it doesn't correctly resolve [select statements](/versions/9.1.0/reference/be/functions#select)
...
For more details, see the [cquery reference](/versions/9.1.0/query/cquery).
...
* **Words**, such as "`foo/...`" or "`.*test rule`" or "`//bar/baz:all`". If a
  ...
  even though relative [target names](/versions/9.1.0/concepts/labels#target-names) may start
...
by [`bazel cquery`](/versions/9.1.0/query/cquery) and [`bazel aquery`](/versions/9.1.0/query/aquery).
...
- [Private attributes](/versions/9.1.0/extending/rules#private_attributes_and_implicit_dependencies)
- [Toolchain requirements](/versions/9.1.0/extending/toolchains#writing-rules-toolchains)
...
[toolchain documentation](/versions/9.1.0/extending/toolchains#writing-rules-toolchains).
...
see the [configurations](/versions/9.1.0/docs/user-manual#configurations)
...
[Skyframe](/versions/9.1.0/reference/skyframe) graph, rather than creating a new
...
For more details, see [Target Patterns](/versions/9.1.0/docs/user-manual#target-patterns), or
...
<table>
  <tr>
    <td>
      <figure>
        <img src="/versions/9.1.0/docs/images/somepath1.svg" alt="Somepath" />
...
<!-- digraph somepath1 {
  ...
  n10 -> n11;
    ...
    <td>
      <figure>
        <img src="/versions/9.1.0/docs/images/somepath2.svg" alt="Somepath" />
...
<!-- digraph somepath2 {
  ...
  n10 -> n11;
    ...
    <td>
      <figure>
        <img src="/versions/9.1.0/docs/images/allpaths.svg" alt="Allpaths" />
...
<table>
  <tr>
    <td><img src="/versions/9.1.0/docs/images/out-ranked.svg" alt="Out ranked" />
    </td>
    <td>
      <pre>
      minrank
...
If the build depends on rules from [external repositories](/versions/9.1.0/external/overview)
