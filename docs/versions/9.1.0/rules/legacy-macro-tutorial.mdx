...
IMPORTANT: This tutorial is for [*legacy macros*](/versions/UNSAFE_release-9.1.0/extending/legacy-macros). If
...
creating a [rule](/versions/UNSAFE_release-9.1.0/extending/rules). Rules give you more control and flexibility.
...
"/versions/UNSAFE_release-9.1.0//other/package:image.png"`, or even `src = select(...)`?
...
if possible, instead using [symbolic macros](/versions/UNSAFE_release-9.1.0/extending/macros), which have
