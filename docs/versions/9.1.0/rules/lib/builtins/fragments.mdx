...
See the [configuration fragment reference](../fragments) for a list of available fragments and the [rules documentation](https://bazel.build/versions/UNSAFE_release-9.1.0/extending/rules#configuration_fragments) for how to use them.