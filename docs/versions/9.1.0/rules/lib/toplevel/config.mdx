...
| --- | --- |
| `flag` | [bool](/versions/9.1.0/rules/lib/core/bool); default is `False` |
...
| Parameter | Description |
| --- | --- |
| `exec_group` | [string](/versions/9.1.0/rules/lib/core/string); or `None`; default is `None`  The name of the exec group whose execution platform this transition will use. If not provided, this exec transition will use the target's default execution platform. |
...
| Parameter | Description |
| --- | --- |
| `flag` | [bool](/versions/9.1.0/rules/lib/core/bool); default is `False`  Whether or not this build setting is callable on the command line. |
...
A string set-typed build setting. The value of this setting will be a [set](https://bazel.build/versions/9.1.0/rules/lib/core/set) of strings in Starlark. On the command line, pass a set using a comma-separated value like `--//my/setting=foo,bar`.
