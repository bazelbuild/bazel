...
| --- | --- |
| `flag` | [bool](../core/bool); default is `False` |
...
| Parameter | Description |
| --- | --- |
| `flag` | [bool](../core/bool); default is `False`  Whether or not this build setting is callable on the command line. |
...
A string set-typed build setting. The value of this setting will be a [set](https://bazel.build/versions/UNSAFE_release-9.1.0/rules/lib/core/set) of strings in Starlark. On the command line, pass a set using a comma-separated value like `--//my/setting=foo,bar`.
