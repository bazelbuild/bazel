...
| --- | --- |
| `target` | [Label](/versions/9.1.0/rules/lib/builtins/Label); or [string](/versions/9.1.0/rules/lib/core/string); required  A target which is checked if it exists inside the package group. |