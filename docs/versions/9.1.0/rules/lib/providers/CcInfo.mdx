...
| --- | --- |
| `compilation_context` | [CompilationContext](/versions/9.1.0/rules/lib/builtins/CompilationContext); or `None`; default is `None`  The `CompilationContext`. |
| `linking_context` | [struct](/versions/9.1.0/rules/lib/builtins/struct); or `None`; default is `None`  The `LinkingContext`. |
| `debug_context` | [struct](/versions/9.1.0/rules/lib/builtins/struct); or `None`; default is `None`  The `DebugContext`. |
