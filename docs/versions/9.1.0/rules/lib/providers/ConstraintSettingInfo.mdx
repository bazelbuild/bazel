...
A specific constraint setting that may be used to define a platform. See [Defining Constraints and Platforms](/versions/UNSAFE_release-9.1.0/docs/platforms#constraints-platforms) for more information.
