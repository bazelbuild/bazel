...
| --- | --- |
| `x` | required |
| `start` | [int](/versions/9.1.0/rules/lib/core/int); default is `unbound`  The start index of the list portion to inspect. |
| `end` | [int](/versions/9.1.0/rules/lib/core/int); default is `unbound`  The end index of the list portion to inspect. |
...
| Parameter | Description |
| --- | --- |
| `index` | [int](/versions/9.1.0/rules/lib/core/int); required  The index of the given position. |
...
| Parameter | Description |
| --- | --- |
| `i` | [int](/versions/9.1.0/rules/lib/core/int); default is `-1`  The index of the item. |
