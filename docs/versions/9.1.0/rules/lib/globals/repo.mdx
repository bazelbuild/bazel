...
| Parameter | Description |
| --- | --- |
| `kwargs` | required  The `repo()` function accepts exactly the same arguments as the [`package()`](/versions/UNSAFE_release-9.1.0/reference/be/functions#package) function in BUILD files. |