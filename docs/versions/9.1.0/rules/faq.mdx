...
See the [Rules page](/versions/UNSAFE_release-9.1.0/extending/rules#requesting-output-files) for more information.
...
[runfiles](/versions/UNSAFE_release-9.1.0/extending/rules#runfiles). Instead of using the `path` field, use
...
[set the default outputs](/versions/UNSAFE_release-9.1.0/extending/rules#requesting-output-files).
