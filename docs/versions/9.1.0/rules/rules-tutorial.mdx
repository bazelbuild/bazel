...
See the
[Bazel](/versions/UNSAFE_release-9.1.0/start/) and [Starlark](/versions/UNSAFE_release-9.1.0/extending/concepts) documentation for
...
To analyze the targets, use the [`cquery`](/versions/UNSAFE_release-9.1.0/query/cquery) ("configured
...
*   Take a look at the [reference documentation for rules](/versions/UNSAFE_release-9.1.0/extending/rules#contents).
*   Get familiar with [depsets](/versions/UNSAFE_release-9.1.0/extending/depsets).
