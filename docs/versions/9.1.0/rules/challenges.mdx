...
changes such as changes to file attributes. [Sandboxing](/versions/UNSAFE_release-9.1.0/docs/sandboxing)
...
have designed [Skyframe](/versions/UNSAFE_release-9.1.0/reference/skyframe) to handle this
...
[depset](/versions/UNSAFE_release-9.1.0/rules/lib/depset)
