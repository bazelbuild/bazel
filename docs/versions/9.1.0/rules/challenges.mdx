...
changes such as changes to file attributes. [Sandboxing](/versions/9.1.0/docs/sandboxing)
...
have designed [Skyframe](/versions/9.1.0/reference/skyframe) to handle this
...
[depset](/versions/9.1.0/rules/lib/depset)
