...
IMPORTANT: This tutorial is for [*symbolic macros*](/versions/UNSAFE_release-9.1.0/extending/macros) – the new
macro system introduced in Bazel 8. If you need to support older Bazel versions,
you will want to write a [legacy macro](/versions/UNSAFE_release-9.1.0/extending/legacy-macros) instead; take
