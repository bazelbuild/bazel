...
based on the [output base](/versions/UNSAFE_release-9.1.0/run/scripts#output-base-option), which by default is
...
[shutdown](/versions/UNSAFE_release-9.1.0/docs/user-manual#shutdown) command.
