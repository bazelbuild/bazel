...
[`--lockfile_mode`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#flag--lockfile_mode) to
...
*   Use [`bazelisk`](/versions/UNSAFE_release-9.1.0/install/bazelisk) to run Bazel, and include a
    ...
    change even between [backwards compatible](/versions/UNSAFE_release-9.1.0/release/backward-compatibility)
