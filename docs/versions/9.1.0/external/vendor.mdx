...
name](/versions/9.1.0/external/overview#canonical-repo-name) and [apparent repo
name](/versions/9.1.0/external/overview#apparent-repo-name).
...
[canonical repo names](/versions/9.1.0/external/overview#canonical-repo-name) as arguments:
...
[`local`](/versions/9.1.0/rules/lib/globals/bzl#repository_rule.local) or
[`configure`](/versions/9.1.0/rules/lib/globals/bzl#repository_rule.configure) set to true are
