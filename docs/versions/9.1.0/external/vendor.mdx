...
[canonical repo names](/versions/UNSAFE_release-9.1.0/external/overview#canonical-repo-name) as arguments:
...
[`local`](/versions/UNSAFE_release-9.1.0/rules/lib/globals/bzl#repository_rule.local) or
[`configure`](/versions/UNSAFE_release-9.1.0/rules/lib/globals/bzl#repository_rule.configure) set to true are
