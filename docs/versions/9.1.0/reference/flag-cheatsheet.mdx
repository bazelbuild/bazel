...
<a href="https://bazel.build/versions/9.1.0/docs/sandboxing">sandboxing documentation</a>.
...
see <a href="https://bazel.build/versions/9.1.0/run/scripts#output-base-option">Choosing the output base</a>.
</aside>
