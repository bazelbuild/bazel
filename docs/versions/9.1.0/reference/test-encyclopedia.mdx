...
Tests are run using [`bazel test`](/versions/UNSAFE_release-9.1.0/docs/user-manual#test).
...
[`timeout`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#test.timeout) attribute according
...
test's [`size`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#test.size) as follows:
...
[Common definitions](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes-tests).
...
specification [here](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes-tests). If
...
[`--test_sharding_strategy`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#flag--test_sharding_strategy)
and [`shard_count`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes-tests) to
...
[`--incompatible_check_sharding_support`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#flag--incompatible_check_sharding_support)
...
<table>
  ...
  <tr>
    ...
    <td>total
      <a href="/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#test.shard_count"><code>shard count</code></a>,
  ...
  <tr>
    ...
    <td>value of
      <a href="/versions/UNSAFE_release-9.1.0/docs/user-manual#flag--test_filter"><code>--test_filter</code></a>,
      if specified</td>
    <td>optional</td>
  </tr>
  <tr>
...
The [execution platform](/versions/UNSAFE_release-9.1.0/extending/platforms) for a test action is determined
via [toolchain resolution](/versions/UNSAFE_release-9.1.0/extending/toolchains#toolchain-resolution), just
