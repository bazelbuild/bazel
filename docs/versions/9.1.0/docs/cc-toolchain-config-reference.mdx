...
[`CcToolchainConfigInfo`](/versions/9.1.0/rules/lib/providers/CcToolchainConfigInfo) is a provider that provides the necessary level of
...
[`toolchain_config`](/versions/9.1.0/reference/be/c-cpp#cc_toolchain.toolchain_config) attribute of the
[`cc_toolchain`](/versions/9.1.0/reference/be/c-cpp#cc_toolchain) to your rule.
You can create the `CcToolchainConfigInfo` by calling
[`cc_common.create_cc_toolchain_config_info()`](/versions/9.1.0/rules/lib/toplevel/cc_common#create_cc_toolchain_config_info).
...
1.  User specifies a `cc_toolchain_suite` target in the `BUILD` file and points
    ...
    [`--crosstool_top` option](/versions/9.1.0/docs/user-manual#flag--crosstool_top).
...
<table>
  ...
  <tr>
   ...
   <td>
     <p>Feature-level. This feature implies the specified feature(s).
  ...
  <tr>
   ...
   <td>
     <p>Feature-level. Indicates that this feature is one of several mutually
...
<table>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>
     Sequence of <code>-iquote</code> includes -
  ...
  <tr>
   ...
   <td>compile</td>
   <td>
     Sequence of <code>-isystem</code> includes -
     directories in which the compiler searches for headers included using
     <code>#include &lt;foo.h&gt;</code>.
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>link</td>
   <td>
     <code>"yes"</code> or <code>"no"</code> depending on whether interface library should
     be generated.
   </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>link</td>
   <td>
     Linker flags coming from the <code>--linkopt</code>
  ...
  <tr>
   ...
   <td>link</td>
   <td>
     Truthy when current action is a <code>cc_test</code>
...
<table>
  ...
  <tr>
   <td><strong><code>per_object_debug_info</code></strong></td>
    <td>
      Enabled if the <code>supports_fission</code> feature is specified and
  ...
  <tr>
   ...
   <td>
     If enabled (and the option <code>--start_end_lib</code> is set), Bazel
  ...
  <tr>
   ...
   <td>
     If enabled (and the option <code>--interface_shared_objects</code> is
