...
Bazel](/versions/9.1.0/start/android-app) tutorial._

![Running Android instrumentation tests in parallel](/versions/9.1.0/docs/images/android_test.gif "Android instrumentation test")

**Figure 1.** Running parallel Android instrumentation tests.

[`android_instrumentation_test`](/versions/9.1.0/reference/be/android#android_instrumentation_test)
...
![The target dependency graph on an Android instrumentation test](/versions/9.1.0/docs/images/android_instrumentation_test.png "Target dependency graph")
