...
*   [Tutorial: Building a Java Project](/versions/UNSAFE_release-9.1.0/start/java)
*   [Java rules](/versions/UNSAFE_release-9.1.0/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/UNSAFE_release-9.1.0/migrate/maven)
...
[Java language version flag](/versions/UNSAFE_release-9.1.0/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/UNSAFE_release-9.1.0/docs/user-manual#java_runtime_version).
...
In addition to [general Bazel best practices](/versions/UNSAFE_release-9.1.0/configure/best-practices), below are
...
*   The sources should be a non-recursive [`glob`](/versions/UNSAFE_release-9.1.0/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/UNSAFE_release-9.1.0/extending/concepts) when building your Java
projects:

*   Main Java module: [`java_common`](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/java_common)
*   Main Java provider: [`JavaInfo`](/versions/UNSAFE_release-9.1.0/rules/lib/providers/JavaInfo)
*   Configuration fragment: [`java`](/versions/UNSAFE_release-9.1.0/rules/lib/fragments/java)
*   Other modules:
...
[`--extra_toolchains`](/versions/UNSAFE_release-9.1.0/docs/user-manual#extra-toolchains) flag.
