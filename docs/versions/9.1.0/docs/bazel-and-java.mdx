...
*   [Tutorial: Building a Java Project](/versions/9.1.0/start/java)
*   [Java rules](/versions/9.1.0/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/9.1.0/migrate/maven)
...
[Java language version flag](/versions/9.1.0/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/9.1.0/docs/user-manual#java_runtime_version).
...
In addition to [general Bazel best practices](/versions/9.1.0/configure/best-practices), below are
...
*   The sources should be a non-recursive [`glob`](/versions/9.1.0/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/9.1.0/extending/concepts) when building your Java
projects:

*   Main Java module: [`java_common`](/versions/9.1.0/rules/lib/toplevel/java_common)
*   Main Java provider: [`JavaInfo`](/versions/9.1.0/rules/lib/providers/JavaInfo)
*   Configuration fragment: [`java`](/versions/9.1.0/rules/lib/fragments/java)
*   Other modules:
...
[`--extra_toolchains`](/versions/9.1.0/docs/user-manual#extra-toolchains) flag.
