...
more details, see
[Attributes common to all rules](/versions/9.1.0/reference/be/common-definitions).
...
[Build Encyclopedia](/versions/9.1.0/reference/be/).
...
conform to the [label syntax](/versions/9.1.0/concepts/labels#labels-lexical-specification),
then explicit enumeration of files, or use of the
[`glob()`](/versions/9.1.0/reference/be/functions#glob) function produces an invalid labels
