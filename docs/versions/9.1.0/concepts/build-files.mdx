...
For more details, see [Hermeticity](/versions/9.1.0/basics/hermeticity).
...
The first argument of `load` is a [label](/versions/9.1.0/concepts/labels) identifying a
...
[Build Encyclopedia](/versions/9.1.0/reference/be/overview), but it is possible
