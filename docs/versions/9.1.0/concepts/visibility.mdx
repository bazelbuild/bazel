...
to build during the [analysis](/versions/UNSAFE_release-9.1.0/reference/glossary#analysis-phase) phase if it
...
[symbolic macros](/versions/UNSAFE_release-9.1.0/extending/macros), the term "location" can be simplified
...
packages and subpackages, see [Concepts and terminology](/versions/UNSAFE_release-9.1.0/concepts/build-ref).
...
[`visibility`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common.visibility) attribute.
...
*   `"//some_pkg:my_package_group"`: Grants access to all of the packages that
    are part of the given [`package_group`](/versions/UNSAFE_release-9.1.0/reference/be/functions#package_group).

    *   Package groups use a
        [different syntax](/versions/UNSAFE_release-9.1.0/reference/be/functions#package_group.packages) for
...
package specifies a [`default_visibility`](/versions/UNSAFE_release-9.1.0/reference/be/functions#package.default_visibility),
...
[`exports_files`](/versions/UNSAFE_release-9.1.0/reference/be/functions#exports_files), or implicitly created
...
[`config_setting`](/versions/UNSAFE_release-9.1.0/reference/be/general#config_setting) targets that are
referenced in the keys of a [`select()`](/versions/UNSAFE_release-9.1.0/reference/be/functions#select). There
...
Some rules have [implicit dependencies](/versions/UNSAFE_release-9.1.0/extending/rules#private_attributes_and_implicit_dependencies) —
...
[symbolic macros](/versions/UNSAFE_release-9.1.0/extending/macros).
...
`.bzl` file but not list it in the `srcs` of a [`filegroup`](/versions/UNSAFE_release-9.1.0/reference/be/general#filegroup),
...
[`visibility()`](/versions/UNSAFE_release-9.1.0/rules/lib/globals/bzl#visibility) function from within the file.
The argument to `visibility()` is a list of package specifications, just like
the [`packages`](/versions/UNSAFE_release-9.1.0/reference/be/functions#package_group.packages) attribute of
...
[`includes`](/versions/UNSAFE_release-9.1.0/reference/be/functions#package_group.includes) attribute.
