...
version](/versions/9.1.0/release#bazel-versioning) are fully backward-compatible. New major LTS
...
Model](/versions/9.1.0/release) page.
...
*   [For Bazel users - how to update Bazel](/versions/9.1.0/install/bazelisk)
*   [For contributors - best practices for incompatible changes](/versions/9.1.0/contribute/breaking-changes)
