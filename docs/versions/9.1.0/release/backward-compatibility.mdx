...
*   [For Bazel users - how to update Bazel](/versions/UNSAFE_release-9.1.0/install/bazelisk)
*   [For contributors - best practices for incompatible changes](/versions/UNSAFE_release-9.1.0/contribute/breaking-changes)
