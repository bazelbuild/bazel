...
| ----------- | ------------- | -------------- | -------------- |
| Bazel 9 | Rolling| [Check rolling release page](/versions/9.1.0/release/rolling) | N/A |
...
*   Rolling releases can ship incompatible changes. Incompatible flags are
    ...
    policy](/versions/9.1.0/release/backward-compatibility).
...
Compatibility](/versions/9.1.0/release/rule-compatibility) page.
