...
*   **[Why a Build System?](/versions/UNSAFE_release-9.1.0/basics/build-systems)**
...
*   **[Task-Based Build Systems](/versions/UNSAFE_release-9.1.0/basics/task-based-builds)**

    This page discusses task-based build systems (such as Make, Maven, and
    Gradle) and some of their challenges.

*   **[Artifact-Based Build Systems](/versions/UNSAFE_release-9.1.0/basics/artifact-based-builds)**

    This page discusses artifact-based build systems in response to the pain
    points of task-based build systems.

*   **[Distributed Builds](/versions/UNSAFE_release-9.1.0/basics/distributed-builds)**
...
*   **[Dependency Management](/versions/UNSAFE_release-9.1.0/basics/dependencies)**
