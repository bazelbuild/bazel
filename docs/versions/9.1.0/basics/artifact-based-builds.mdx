...
[build configurations](/versions/9.1.0/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/9.1.0/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/9.1.0/docs/sandboxing)_. On supported
