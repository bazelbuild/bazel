...
[build configurations](/versions/UNSAFE_release-9.1.0/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/UNSAFE_release-9.1.0/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/UNSAFE_release-9.1.0/docs/sandboxing)_. On supported
