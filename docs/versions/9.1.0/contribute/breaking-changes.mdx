...
[backward compatibility policy](/versions/9.1.0/release/backward-compatibility).
This document describes the process for Bazel contributors to make a breaking
change in Bazel to adhere to this policy.

1. Follow the [design document policy](/versions/9.1.0/contribute/design-documents).
...
Also add [`RELNOTES:`](/versions/9.1.0/contribute/release-notes) in the following form:
