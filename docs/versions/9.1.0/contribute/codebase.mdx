...
description is available in [Output directory layout](/versions/UNSAFE_release-9.1.0/remote/output-directories).
...
4.  Starlark rules can also define their own options, known as build settings
    (see [here](/versions/UNSAFE_release-9.1.0/extending/config)).
...
available [here](/versions/UNSAFE_release-9.1.0/reference/skyframe).
...
3.  Storing state between restarts, either using
    ...
    [`StateMachine`s](/versions/UNSAFE_release-9.1.0/contribute/statemachine-guide) were introduced for a
...
[here](/versions/UNSAFE_release-9.1.0/rules/language#differences-between-build-and-bzl-files).

More information about Starlark is available [here](/versions/UNSAFE_release-9.1.0/rules/language).
...
[here](/versions/UNSAFE_release-9.1.0/extending/config))
...
[here](/versions/UNSAFE_release-9.1.0/extending/aspects). A good
...
[here](/versions/UNSAFE_release-9.1.0/extending/platforms))
...
[here](/versions/UNSAFE_release-9.1.0/extending/toolchains)).
...
[visibility](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes) attribute. This
...
[here](/versions/UNSAFE_release-9.1.0/reference/test-encyclopedia). At the
...
Bazel has a
[little language](/versions/UNSAFE_release-9.1.0/query/guide)
...
[Build Event Protocol](/versions/UNSAFE_release-9.1.0/remote/bep)
...
[external dependencies overview](/versions/UNSAFE_release-9.1.0/external/overview) for more up-to-date
information.
