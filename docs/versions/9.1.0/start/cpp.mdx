...
While Bazel is a [build system](https://bazel.build/versions/9.1.0/basics/build-systems) that
...
Start by [installing Bazel](https://bazel.build/versions/9.1.0/install), if you haven't
...
[workspace](https://bazel.build/versions/9.1.0/reference/glossary#workspace).
...
*   One or more [`BUILD`
    files](https://bazel.build/versions/9.1.0/reference/glossary#build-file), which tell Bazel
    how to build different parts of the project. A directory within the
    workspace that contains a `BUILD` file is a
    [package](https://bazel.build/versions/9.1.0/reference/glossary#package). (More on packages
...
[rule](https://bazel.build/versions/9.1.0/reference/glossary#rule) as a set of instructions,
...
[target](https://bazel.build/versions/9.1.0/reference/glossary#target) and points to a specific
set of source files and
[dependencies](https://bazel.build/versions/9.1.0/reference/glossary#dependency). A target can
...
[`cc_binary` rule](https://bazel.build/versions/9.1.0/reference/be/c-cpp#cc_binary). The rule
...
file.](/versions/9.1.0/docs/images/cpp-tutorial-stage1.png "Dependency graph for hello-world
...
rule](https://bazel.build/versions/9.1.0/reference/be/c-cpp#cc_library)), then the
...
modification to the file.](/versions/9.1.0/docs/images/cpp-tutorial-stage2.png "Dependency
...
package.](/versions/9.1.0/docs/images/cpp-tutorial-stage3.png "Dependency graph for
...
*   To keep focusing on C++, read about common [C++ build use
    cases](https://bazel.build/versions/9.1.0/tutorials/cpp-use-cases).
*   To get started with building other applications with Bazel, see the
    tutorials for [Java](https://bazel.build/versions/9.1.0/start/java), [Android
    application](https://bazel.build/versions/9.1.0/start/android-app), or [iOS
    application](https://bazel.build/versions/9.1.0/start/ios-app).
*   To learn more about working with local and remote repositories, read about
    [external dependencies](https://bazel.build/versions/9.1.0/docs/external).
*   To learn more about Bazel's other rules, see this [reference
    guide](https://bazel.build/versions/9.1.0/rules).
