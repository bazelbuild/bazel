...
[Android rules](/versions/UNSAFE_release-9.1.0/reference/be/android).
...
* **Bazel.** To install, follow the [installation instructions](/versions/UNSAFE_release-9.1.0/install).
...
![Button greeting](/versions/UNSAFE_release-9.1.0/docs/images/android_tutorial_app.png "Tutorial app button greeting")
...
A [workspace](/versions/UNSAFE_release-9.1.0/concepts/build-ref#workspace) is a directory that contains the
...
A [`BUILD` file](/versions/UNSAFE_release-9.1.0/concepts/build-files) describes the relationship
...
structure in your workspace. Each [package](/versions/UNSAFE_release-9.1.0/concepts/build-ref#packages) is a
...
[build rule](/versions/UNSAFE_release-9.1.0/concepts/build-files#types-of-build-rules), which tells
...
[`android_library`](/versions/UNSAFE_release-9.1.0/reference/be/android#android_library) and
[`android_binary`](/versions/UNSAFE_release-9.1.0/reference/be/android#android_binary), that you can use to
...
The [`android_binary`](/versions/UNSAFE_release-9.1.0/reference/be/android#android_binary) rule builds
...
The [`build`](/versions/UNSAFE_release-9.1.0/docs/user-manual#build) subcommand instructs Bazel to build the
...
For more details about target labels and paths, see [Labels](/versions/UNSAFE_release-9.1.0/concepts/labels).
...
project's [bazelrc file](/versions/UNSAFE_release-9.1.0/run/bazelrc). The mobile-install-specific flags
...
![Bazel tutorial app](/versions/UNSAFE_release-9.1.0/docs/images/android_tutorial_before.png "Bazel tutorial app")
...
* More information on [mobile-install](/versions/UNSAFE_release-9.1.0/docs/mobile-install)
...
* Run Robolectric tests with the [robolectric-bazel](https://github.com/robolectric/robolectric-bazel)
  integration.
* Integrating C and C++ code into your Android app with the [NDK](/versions/UNSAFE_release-9.1.0/docs/android-ndk)
