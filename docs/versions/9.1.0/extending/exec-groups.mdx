...
Each execution group has its own [toolchain](/versions/UNSAFE_release-9.1.0/extending/toolchains) dependencies and
performs its own [toolchain resolution](/versions/UNSAFE_release-9.1.0/extending/toolchains#toolchain-resolution).
...
[declare](/versions/UNSAFE_release-9.1.0/rules/lib/globals/bzl#exec_group)
...
[`cfg`](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/attr#label)
...
[`ctx.actions.run_shell`](/versions/UNSAFE_release-9.1.0/rules/lib/builtins/actions#run_shell).
...
Rule authors will also be able to access the [resolved toolchains](/versions/UNSAFE_release-9.1.0/extending/toolchains#toolchain-resolution)
...
* `test`: Test runner actions (for more details, see
  the [execution platform section of the Test Encylopedia](/versions/UNSAFE_release-9.1.0/reference/test-encyclopedia#execution-platform)).
* `cpp_link`: C++ linking actions.

## Using execution groups to set execution properties

Execution groups are integrated with the
[`exec_properties`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes)
...
[`exec_compatible_with`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes) and
[`exec_group_compatible_with`](/versions/UNSAFE_release-9.1.0/reference/be/common-definitions#common-attributes)
