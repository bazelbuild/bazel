...
[loading phase](/versions/UNSAFE_release-9.1.0/extending/concepts#evaluation-model), legacy macros don't exist
...
Note: `$@` is a
[Make variable](/versions/UNSAFE_release-9.1.0/reference/be/make-variables#predefined_genrule_variables) that
...
from the [native](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/native) module:
...
[native.package_name()](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/native#package_name). Note that
...
[`Label`](/versions/UNSAFE_release-9.1.0/rules/lib/builtins/Label#Label) constructor:
...
[native.package_relative_label()](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/native#package_relative_label).
...
*   You can also use [print](/versions/UNSAFE_release-9.1.0/rules/lib/globals/all#print) for debugging. It
...
If you want to throw an error, use the [fail](/versions/UNSAFE_release-9.1.0/rules/lib/globals/all#fail)
