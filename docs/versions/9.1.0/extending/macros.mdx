...
and [legacy macros](/versions/9.1.0/extending/legacy-macros). Where possible, we recommend using
...
[`macro()`](https://bazel.build/versions/9.1.0/rules/lib/globals/bzl.html#macro) function with
two required parameters: `attrs` and `implementation`.

### Attributes {#attributes}

`attrs` accepts a dictionary of attribute name to [attribute
types](https://bazel.build/versions/9.1.0/rules/lib/toplevel/attr#members), which represents
...
[parameters](https://bazel.build/versions/9.1.0/rules/lib/toplevel/attr#parameters),
...
macro by passing the [rule](https://bazel.build/versions/9.1.0/rules/lib/builtins/rule) or
[macro symbol](https://bazel.build/versions/9.1.0/rules/lib/builtins/macro) to `macro()`'s
...
all Starlark build
rules](https://bazel.build/versions/9.1.0/reference/be/common-definitions#common-attributes).)
...
The [visibility](/versions/9.1.0/concepts/visibility) system helps protect the implementation
...
[default visibility](/versions/9.1.0/reference/be/functions#package.default_visibility) does
...
[visibility page](/versions/9.1.0/concepts/visibility#symbolic-macros) for more details.
