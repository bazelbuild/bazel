...
[`--instrumentation_filter`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#flag--instrumentation_filter)
...
[`--instrument_test_targets`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#flag--instrument_test_targets)
flag is required.
...
[target]`](/versions/UNSAFE_release-9.1.0/reference/command-line-reference#coverage). This runs the
