...
[`CcToolchainInfo`](/versions/UNSAFE_release-9.1.0/rules/lib/providers/CcToolchainInfo). A complete working
...
* `FeatureConfiguration` - returned by [cc_common.configure_features](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/cc_common#configure_features)
* cc toolchain config variables - returned by
  [cc_common.create_compile_variables](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/cc_common#create_compile_variables)
  or
  [cc_common.create_link_variables](/versions/UNSAFE_release-9.1.0/rules/lib/toplevel/cc_common#create_link_variables).

There still are tool-specific getters, such as
[compiler_executable](/versions/UNSAFE_release-9.1.0/rules/lib/providers/CcToolchainInfo#compiler_executable).
...
a provider containing [`CompilationContext`](/versions/UNSAFE_release-9.1.0/rules/lib/builtins/CompilationContext)
and
