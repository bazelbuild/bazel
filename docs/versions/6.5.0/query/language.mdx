...
For practical use cases, see the [Bazel Query How-To](/versions/6.5.0/docs/query-how-to).
...
For more details, see the [aquery reference](/versions/6.5.0/docs/aquery).
...
it doesn"t correctly resolve [select statements](/versions/6.5.0/reference/be/functions#select)
...
For more details, see the [cquery reference](/versions/6.5.0/docs/cquery).
...
see the [configurations](/versions/6.5.0/docs/user-manual#configurations)
...
[Skyframe](/versions/6.5.0/reference/skyframe) graph, rather than creating a new
...
For more details, see [Target Patterns](/versions/6.5.0/docs/user-manual#target-patterns), or
...
<table>
  <tr>
    <td><figure>         <img src="/versions/6.5.0/docs/images/somepath1.svg" alt="Somepath" />         <figcaption><code>somepath(S1 + S2, E)</code>, one possible result.</figcaption>       </figure> {{}"}{{}"}</td>
    <td><figure>         <img src="/versions/6.5.0/docs/images/somepath2.svg" alt="Somepath" />         <figcaption><code>somepath(S1 + S2, E)</code>, another possible result.</figcaption>       </figure> {{}"}{{}"}</td>
    <td><figure>         <img src="/versions/6.5.0/docs/images/allpaths.svg" alt="Allpaths" />         <figcaption><code>allpaths(S1 + S2, E)</code></figcaption>       </figure> {{}"}{{}"}</td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img src="/versions/6.5.0/docs/images/out-ranked.svg" alt="Out ranked" /></td>
    <td><code>       minrank        0 //c:c       1 //b:b       1 //a:a       2 //b:b.cc       2 //a:a.cc       </code></td>
    <td><code>       maxrank        0 //c:c       1 //b:b       2 //a:a       2 //b:b.cc       3 //a:a.cc       </code></td>
  </tr>
</table>
