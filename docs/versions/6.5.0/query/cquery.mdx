...
[`allrdeps`](/versions/6.5.0/query/language#allrdeps),
[`buildfiles`](/versions/6.5.0/query/language#buildfiles),
[`rbuildfiles`](/versions/6.5.0/query/language#rbuildfiles),
[`siblings`](/versions/6.5.0/query/language#siblings),
[`tests`](/versions/6.5.0/query/language#tests), and
[`visible`](/versions/6.5.0/query/language#visible).
...
`target`. This function is called for each [Target](/versions/6.5.0/rules/lib/Target)
