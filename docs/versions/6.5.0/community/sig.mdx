...
areas and to support communication and coordination between [Bazel owners, maintainers, and contributors](/versions/6.5.0/contribute/contribution-policy). This policy
