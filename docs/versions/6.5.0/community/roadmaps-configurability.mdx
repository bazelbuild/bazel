...
We also support
[`cquery`](https://bazel.build/versions/6.5.0/docs/cquery), [`Starlark configuration`](https://bazel.build/rules/config),
and
...
<span class="etabox">Q3 2021</span>**Android rules use the new [platforms API](https://bazel.build/concepts/platforms-intro)**
