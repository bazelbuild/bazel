...
We also support
[`cquery`](https://bazel.build/versions/6.5.0/docs/cquery), [`Starlark configuration`](https://bazel.build/versions/6.5.0/rules/config),
and
[`select()`](https://bazel.build/versions/6.5.0/docs/configurable-attributes).
...
<span class="etabox">Q3 2021</span>**Android rules use the new [platforms API](https://bazel.build/versions/6.5.0/concepts/platforms-intro)**
...
<div class="padbottom"></div>
<span class="etabox">paused</span>**C++ rules use the new [platformsfall API](https://bazel.build/versions/6.5.0/concepts/platforms-intro)**
