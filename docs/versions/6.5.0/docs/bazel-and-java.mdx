...
*   Main Java provider: [`java_common`](/versions/6.5.0/rules/lib/java_common)
*   Main Java module: [`JavaInfo`](/versions/6.5.0/rules/lib/JavaInfo)
*   Configuration fragment: [`java`](/versions/6.5.0/rules/lib/java)
*   Other modules:

    *   [`java_annotation_processing`](/versions/6.5.0/rules/lib/java_annotation_processing)
    *   [`java_compilation_info`](/versions/6.5.0/rules/lib/java_compilation_info)
    *   [`java_output`](/versions/6.5.0/rules/lib/java_output)
    *   [`java_output_jars`](/versions/6.5.0/rules/lib/java_output_jars)
    *   [`JavaRuntimeInfo`](/versions/6.5.0/rules/lib/JavaRuntimeInfo)
    *   [`JavaToolchainInfo`](/versions/6.5.0/rules/lib/JavaToolchainInfo)
