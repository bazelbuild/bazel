...
The `WORKSPACE` file may be empty or may contain references to [external dependencies](/docs/external) required to build your project.
...
For more information, read [Using the Android Native Development Kit with Bazel](/docs/android-ndk).
...
command line using the [`bazel mobile-install`](/docs/user-manual#mobile-install) command. This command uses
