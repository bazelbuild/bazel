...
using [selects](/versions/6.5.0/reference/be/functions#select)).
...
Set up Travis as described in their [getting started docs](https://docs.travis-ci.com/user/getting-started/). Then add a
