...
A provider that indicates what output groups a rule has.<br>See <a href="https://bazel.build/versions/6.5.0/rules/rules#requesting_output_files">Requesting output files</a> for more information.
...
<ul>
    ...
    Instantiate this provider with <br><pre class=language-python>OutputGroupInfo(group1 = &lt;files&gt;, group2 = &lt;files&gt;...)</pre>See <a href="https://bazel.build/versions/6.5.0/rules/rules#requesting_output_files">Requesting output files </a> for more information.
