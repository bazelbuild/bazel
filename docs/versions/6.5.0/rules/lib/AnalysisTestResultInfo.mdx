...
<ul>
    ...
    <a href="#success">success</a>
      ...
      <h2 id="AnalysisTestResultInfo">AnalysisTestResultInfo</h2>
        <p><pre class="rule-signature"><a class="anchor" href="AnalysisTestResultInfo.html">AnalysisTestResultInfo</a> AnalysisTestResultInfo(success, message)</pre></p>
    ...
    The <code>AnalysisTestResultInfo</code> constructor.
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <p><pre class="rule-signature"><a class="anchor" href="string.html">string</a> AnalysisTestResultInfo.message</pre></p>

    A descriptive message containing information about the test and its success/failure.


        <h2 id="success">success</h2>
        <p><pre class="rule-signature"><a class="anchor" href="bool.html">bool</a> AnalysisTestResultInfo.success</pre></p>
