...
[Macros](/versions/6.5.0/rules/macros) are the heart of this pattern. Macros are used like
...
[`ctx.actions.expand_template`](/versions/6.5.0/rules/lib/actions#expand_template)
