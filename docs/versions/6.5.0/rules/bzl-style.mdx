...
[Starlark](/versions/6.5.0/rules/language) is a
...
*   Follow [testing guidelines](/versions/6.5.0/rules/testing).
...
Since
[Starlark is not Python](/versions/6.5.0/rules/language#differences-with-python),
...
See also [macros](/versions/6.5.0/rules/macros#conventions).
...
*   Design your rule with extensibility in mind. Consider that other rules might
    ...
    actions you create.
*   Follow [performance guidelines](/versions/6.5.0/rules/performance) in your rules.
