...
*  [Install Bazel](/versions/6.5.0/install) if it's not yet installed.
*  If you're new to Bazel, go through the tutorial
   [Introduction to Bazel: Build Java](/versions/6.5.0/tutorials/java) before you start
...
[Guava project](https://github.com/google/guava) from Maven to Bazel.
