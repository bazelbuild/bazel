...
[Bzlmod](/versions/6.5.0/external/overview#bzlmod), use a [multiple-version
...
fetch a file with [`ctx.download`](/versions/6.5.0/rules/lib/repository_ctx#download) or
[`ctx.download_and_extract`](/versions/6.5.0/rules/lib/repository_ctx#download_and_extract). By
