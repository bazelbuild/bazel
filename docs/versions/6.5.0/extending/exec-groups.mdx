...
Each execution group has its own [toolchain](/versions/6.5.0/docs/toolchains) dependencies and
performs its own [toolchain resolution](/versions/6.5.0/docs/toolchains#toolchain-resolution).
...
[declare](/versions/6.5.0/rules/lib/globals#exec_group)
...
[`cfg`](/versions/6.5.0/rules/lib/toplevel/attr#label)
attribute param and the
[`config`](/versions/6.5.0/rules/lib/toplevel/config)
...
param of action generating methods, specifically [`ctx.actions.run`](/versions/6.5.0/rules/lib/builtins/actions#run) and
[`ctx.actions.run_shell`](/versions/6.5.0/rules/lib/builtins/actions#run_shell).
...
Rule authors will also be able to access the [resolved toolchains](/versions/6.5.0/docs/toolchains#toolchain-resolution)
...
[`exec_properties`](/versions/6.5.0/reference/be/common-definitions#common-attributes)
