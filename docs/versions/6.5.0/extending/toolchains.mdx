...
[`ToolchainInfo` provider](/versions/6.5.0/rules/lib/platform_common#ToolchainInfo)
...
The [`config_common.toolchain_type`](/versions/6.5.0/rules/lib/config_common#toolchain_type)
...
The use of [`attr.label`](/versions/6.5.0/rules/lib/attr#label) is the same as for a standard rule,
