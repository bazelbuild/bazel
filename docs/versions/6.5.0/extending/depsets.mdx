...
[to_list()](/versions/6.5.0/rules/lib/builtins/depset#to_list) method. It returns a list of all transitive
...
Please see [here](/versions/6.5.0/rules/lib/builtins/depset) for more details.
