...
[ci.bazel.build](https://github.com/bazelbuild/continuous-integration/blob/master/buildkite/README.md) is run, using Bazel
...
[TensorFlow](https://tensorflow.org) are tested on their complete
