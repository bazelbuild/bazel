...
[The Bazelisk installer](/versions/6.5.0/install/bazelisk) is an alternative to package installation.

## Installing on Fedora 25+ {#installing-fedora}

1. The [DNF](https://fedoraproject.org/wiki/DNF) package manager can
   install Bazel from the [COPR](https://copr.fedorainfracloud.org/) repository.
