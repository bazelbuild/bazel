...
Bazel has a [backward compatibility policy](/versions/6.5.0/release/backward-compatibility)
(see [guidance for rolling out incompatible changes](/versions/6.5.0/contribute/breaking-changes) if you
