...
[Debugging Remote Cache Hits for Remote Execution](/versions/6.5.0/docs/remote-execution-caching-debug).
...
[Cache Hits rate with Remote Execution](/versions/6.5.0/docs/remote-execution-caching-debug#check-cache-hits).
...
2. Follow the steps from [Troubleshooting cache hits for remote execution](/versions/6.5.0/docs/remote-execution-caching-debug#troubleshooting_cache_hits) to
...
3. Ensure your cache-reading Bazel invocations can get cache hits.
   ...
   c. Follow the same steps as to [ensure caching across machines](/versions/6.5.0/docs/remote-execution-caching-debug#caching-across-machines),
