...
[canonical repo names](/versions/8.7.0/external/overview#canonical-repo-name) as arguments:
...
[`local`](/versions/8.7.0/rules/lib/globals/bzl#repository_rule.local) or
[`configure`](/versions/8.7.0/rules/lib/globals/bzl#repository_rule.configure) set to true are
