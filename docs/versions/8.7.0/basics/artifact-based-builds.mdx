...
[build configurations](/versions/8.7.0/run/build#build-config-cross-compilation). Rather than
...
[adding custom rules](/versions/8.7.0/extending/rules).
...
conflicts impossible by using _[sandboxing](/versions/8.7.0/docs/sandboxing)_. On supported
