...
labels with an [*apparent* repo name](/versions/8.7.0/external/overview#apparent-repo-name),
which looks like:
...
[target patterns](/versions/8.7.0/run/build#specifying-build-targets).
...
[Bazel Query Language](/versions/8.7.0/query/language).
...
<p><span class="compare-better">Correct</span> — Use <code>//<var>package-name</var>:<var>filename</var></code></p>
...
outputs as described in the [Build Encyclopedia](/versions/8.7.0/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/8.7.0/reference/be/overview) for a
...
[General Rules: genrule](/versions/8.7.0/reference/be/general#genrule).
...
[Bazel Query tool](/versions/8.7.0/query/guide) operates.
