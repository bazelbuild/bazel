...
| Parameter | Description |
| --- | --- |
| `kwargs` | required  The `repo()` function accepts exactly the same arguments as the [`package()`](/versions/8.7.0/reference/be/functions#package) function in BUILD files. |