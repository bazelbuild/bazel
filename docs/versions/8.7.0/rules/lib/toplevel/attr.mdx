...
See the Rules page for more on [defining](https://bazel.build/versions/8.7.0/extending/rules#attributes)
and [using](https://bazel.build/versions/8.7.0/extending/rules#implementation_function) attributes.
