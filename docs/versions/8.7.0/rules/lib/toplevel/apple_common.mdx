...
| Parameter | Description |
| --- | --- |
| `version` | [string](../core/string); required  The string representation of the DottedVersion. |
...
These values can be passed to methods that expect a platform, like [XcodeVersionConfig.sdk_version_for_platform](../providers/XcodeVersionConfig#sdk_version_for_platform).
...
These values can be passed to methods that expect a platform type, like the 'apple' configuration fragment's [multi_arch_platform](../fragments/apple#multi_arch_platform) method.
