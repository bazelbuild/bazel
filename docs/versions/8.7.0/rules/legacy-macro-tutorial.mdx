...
IMPORTANT: This tutorial is for [*legacy macros*](/versions/8.7.0/extending/legacy-macros). If
...
"/versions/8.7.0//other/package:image.png"`, or even `src = select(...)`?
...
if possible, instead using [symbolic macros](/versions/8.7.0/extending/macros), which have
