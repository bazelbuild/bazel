...
changes such as changes to file attributes. [Sandboxing](/versions/8.6.0/docs/sandboxing)
...
have designed [Skyframe](/versions/8.6.0/reference/skyframe) to handle this
