...
| `tag_classes` | [dict](/versions/8.6.0/rules/lib/core/dict); default is `&lcub;&rcub;`  A dictionary to declare all the tag classes used by the extension. It maps from the name of the tag class to a `tag_class` object. |
