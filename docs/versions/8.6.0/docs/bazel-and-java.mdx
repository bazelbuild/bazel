...
*   [Tutorial: Building a Java Project](/versions/8.6.0/start/java)
*   [Java rules](/versions/8.6.0/reference/be/java)
...
*   [Migrating from Maven to Bazel](/versions/8.6.0/migrate/maven)
...
[Java language version flag](/versions/8.6.0/docs/user-manual#java-language-version).
...
[Java runtime version flag](/versions/8.6.0/docs/user-manual#java_runtime_version).
...
*   The sources should be a non-recursive [`glob`](/versions/8.6.0/reference/be/functions#glob) of
...
[extend Bazel's capabilities](/versions/8.6.0/extending/concepts) when building your Java
projects:

*   Main Java module: [`java_common`](/versions/8.6.0/rules/lib/toplevel/java_common)
*   Main Java provider: [`JavaInfo`](/versions/8.6.0/rules/lib/providers/JavaInfo)
*   Configuration fragment: [`java`](/versions/8.6.0/rules/lib/fragments/java)
*   Other modules:
...
[`--extra_toolchains`](/versions/8.6.0/docs/user-manual#extra-toolchains) flag.
