...
*   [For Bazel users - how to update Bazel](/versions/8.6.0/install/bazelisk)
*   [For contributors - best practices for incompatible changes](/versions/8.6.0/contribute/breaking-changes)
