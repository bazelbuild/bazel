...
Each execution group has its own [toolchain](/versions/8.6.0/extending/toolchains) dependencies and
performs its own [toolchain resolution](/versions/8.6.0/extending/toolchains#toolchain-resolution).
...
[declare](/versions/8.6.0/rules/lib/globals/bzl#exec_group)
...
[`cfg`](/versions/8.6.0/rules/lib/toplevel/attr#label)
...
Rule authors will also be able to access the [resolved toolchains](/versions/8.6.0/extending/toolchains#toolchain-resolution)
...
[`exec_properties`](/versions/8.6.0/reference/be/common-definitions#common-attributes)
