...
[exec_platform]: https://bazel.build/versions/8.6.0/extending/platforms#:~:text=Execution%20%2D%20a%20platform%20on%20which%20build%20tools%20execute%20build%20actions%20to%20produce%20intermediate%20and%20final%20outputs.
[exec_groups]: https://bazel.build/versions/8.6.0/extending/exec-groups
...
[run_shell]: https://bazel.build/versions/8.6.0/rules/lib/builtins/actions#run_shell
