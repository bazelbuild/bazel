...
[loading phase](/versions/8.6.0/extending/concepts#evaluation-model), legacy macros don't exist
...
Note: `$@` is a
[Make variable](/versions/8.6.0/reference/be/make-variables#predefined_genrule_variables) that
...
from the [native](/versions/8.6.0/rules/lib/toplevel/native) module:
...
[native.package_name()](/versions/8.6.0/rules/lib/toplevel/native#package_name). Note that
...
[`Label`](/versions/8.6.0/rules/lib/builtins/Label#Label) constructor:
...
[native.package_relative_label()](/versions/8.6.0/rules/lib/toplevel/native#package_relative_label).
...
*   You can also use [print](/versions/8.6.0/rules/lib/globals/all#print) for debugging. It
...
If you want to throw an error, use the [fail](/versions/8.6.0/rules/lib/globals/all#fail)
