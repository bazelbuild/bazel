...
[`macro()`](https://bazel.build/versions/8.6.0/rules/lib/globals/bzl.html#macro) function with
...
[parameters](https://bazel.build/versions/8.6.0/rules/lib/toplevel/attr#parameters),
...
The [visibility](/versions/8.6.0/concepts/visibility) system helps protect the implementation
...
[default visibility](/versions/8.6.0/reference/be/functions#package.default_visibility) does
...
[visibility page](/versions/8.6.0/concepts/visibility#symbolic-macros) for more details.
