...
<ul>
    ...
    Register an already-defined platform so that Bazel can use it as an <a href="/versions/7.4.0/docs/toolchains#toolchain-resolution">execution platform</a> during <a href="/versions/7.4.0/docs/toolchains">toolchain resolution</a>.
    ...
    Register an already-defined toolchain so that Bazel can use it during <a href="/versions/7.4.0/docs/toolchains">toolchain resolution</a>. See examples of <a href="/versions/7.4.0/docs/toolchains#defining-toolchains">defining</a> and <a href="/versions/7.4.0/docs/toolchains#registering-and-building-with-toolchains">registering toolchains</a>.
