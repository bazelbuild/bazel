...
<ul>
    ...
    Returns CToolchain text proto from the CcToolchainConfigInfo data.
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> CcToolchainConfigInfo.to_json()</pre></p>
...
# {"key":{"inner_key":{"inner_inner_key":"text"}}}
        ...
        <p><pre class="rule-signature"><a class="anchor" href="../core/string.html">string</a> CcToolchainConfigInfo.to_proto()</pre></p>
