...
While Bazel is a [build system](https://bazel.build/versions/8.3.0/basics/build-systems) that
...
Start by [installing Bazel](https://bazel.build/versions/8.3.0/install), if you haven't
...
[workspace](https://bazel.build/versions/8.3.0/reference/glossary#workspace).
...
*   One or more [`BUILD`
    ...
    [package](https://bazel.build/versions/8.3.0/reference/glossary#package). (More on packages
...
[rule](https://bazel.build/versions/8.3.0/reference/glossary#rule) as a set of instructions,
...
[target](https://bazel.build/versions/8.3.0/reference/glossary#target) and points to a specific
set of source files and
[dependencies](https://bazel.build/versions/8.3.0/reference/glossary#dependency). A target can
...
[`cc_binary` rule](https://bazel.build/versions/8.3.0/reference/be/c-cpp#cc_binary). The rule
...
*   To get started with building other applications with Bazel, see the
    tutorials for [Java](https://bazel.build/versions/8.3.0/start/java), [Android
...
*   To learn more about working with local and remote repositories, read about
    [external dependencies](https://bazel.build/versions/8.3.0/docs/external).
