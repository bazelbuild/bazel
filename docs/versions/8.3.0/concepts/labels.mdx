...
labels with an [*apparent* repo name](/versions/8.3.0/external/overview#apparent-repo-name),
which looks like:
...
[target patterns](/versions/8.3.0/run/build#specifying-build-targets).
...
[Bazel Query Language](/versions/8.3.0/query/language).
...
outputs as described in the [Build Encyclopedia](/versions/8.3.0/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/8.3.0/reference/be/overview) for a
...
[General Rules: genrule](/versions/8.3.0/reference/be/general#genrule).
...
[Bazel Query tool](/versions/8.3.0/query/guide) operates.

<table class="columns">
  <tr>
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.3.0/concepts/build-ref">
        <span class="material-icons" aria-hidden="true">arrow_back</span>Targets</a>
    </td>
    <td><a class="button button-with-icon button-primary"
           href="/versions/8.3.0/concepts/build-files">
