...
to build during the [analysis](/versions/8.3.0/reference/glossary#analysis-phase) phase if it
...
[symbolic macros](/versions/8.3.0/extending/macros), the term "location" can be simplified
...
packages and subpackages, see [Concepts and terminology](/versions/8.3.0/concepts/build-ref).
...
[`visibility`](/versions/8.3.0/reference/be/common-definitions#common.visibility) attribute.
...
*   `"//some_pkg:my_package_group"`: Grants access to all of the packages that
    are part of the given [`package_group`](/versions/8.3.0/reference/be/functions#package_group).

    *   Package groups use a
        [different syntax](/versions/8.3.0/reference/be/functions#package_group.packages) for
...
package specifies a [`default_visibility`](/versions/8.3.0/reference/be/functions#package.default_visibility),
...
[`exports_files`](/versions/8.3.0/reference/be/functions#exports_files), or implicitly created
...
[`config_setting`](/versions/8.3.0/reference/be/general#config_setting) targets that are
referenced in the keys of a [`select()`](/versions/8.3.0/reference/be/functions#select). There
...
Some rules have [implicit dependencies](/versions/8.3.0/extending/rules#private_attributes_and_implicit_dependencies) —
...
[symbolic macros](/versions/8.3.0/extending/macros).
...
`.bzl` file but not list it in the `srcs` of a [`filegroup`](/versions/8.3.0/reference/be/general#filegroup),
...
[`visibility()`](/versions/8.3.0/rules/lib/globals/bzl#visibility) function from within the file.
The argument to `visibility()` is a list of package specifications, just like
the [`packages`](/versions/8.3.0/reference/be/functions#package_group.packages) attribute of
...
[`includes`](/versions/8.3.0/reference/be/functions#package_group.includes) attribute.
