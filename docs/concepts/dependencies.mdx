...
<table class="cyan">
  ...
  <tr>
    <td>``` import b; b.foo(); ```</td>
    <td>``` import c; function foo() {}""   c.bar(); {}"" ```</td>
  </tr>
  <tr>
    <td><figure>         <img src="/docs/images/ab_c.svg"              alt="Declared dependency graph with arrows connecting a and b." />         <figcaption><b>Declared</b> dependency graph</figcaption>       </figure></td>
...
<table class="cyan">
  ...
  <tr>
    <td>``` import b; import c; b.foo(); c.garply(); ```</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<table class="cyan">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>``` import d; function foo() {}""   d.baz(); {}"" ```</td>
  </tr>
  <tr>
    <td><figure>         <img src="/docs/images/ab_c.svg"              alt="Declared dependency graph with arrows connecting a and b." />         <figcaption><b>Declared</b> dependency graph</figcaption>       </figure></td>
