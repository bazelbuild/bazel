...
User-defined environment variables set via the `env` attribute or the `--test_env` command-line option take precedence over variables set by Bazel's coverage tooling.
