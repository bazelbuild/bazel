...
DIST_DEPS = {
    ...
    "rules_java": {
        ...
        "archive": "rules_java-6.2.1.tar.gz",
        "sha256": "35ec35b374ad4b4c94445832d0e57a377642505cbc4a61837ce5768eb39fced5",
        "urls": ["https://github.com/bazelbuild/rules_java/releases/download/6.2.1/rules_java-6.2.1.tar.gz"],
