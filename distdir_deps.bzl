...
DIST_DEPS = {
    ...
    "rules_java": {
        ...
        "archive": "rules_java-6.3.3.tar.gz",
        "sha256": "b41961d960cd7131e1f48207a51f7dc98bf90db23a7eacc456e709b8aeca32f4",
        "urls": ["https://github.com/bazelbuild/rules_java/releases/download/6.3.3/rules_java-6.3.3.tar.gz"],
