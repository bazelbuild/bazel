...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2) {
    return RegularImmutableMap.fromEntries(null, entryOf(k1, v1), entryOf(k2, v2));
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3) {
    return RegularImmutableMap.fromEntries(null, entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3));
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
    return RegularImmutableMap.fromEntries(
        null, entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3), entryOf(k4, v4));
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(
    ...
    return RegularImmutableMap.fromEntries(
        null, entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3), entryOf(k4, v4), entryOf(k5, v5));
  }
  ...
  public static <K, V> ImmutableMap<K, V> ofEntries(Entry<? extends K, ? extends V>... entries) {
    ...
    return RegularImmutableMap.fromEntries(null, entries2);
  }
  ...
  public static class Builder<K, V> {
    ...
    public Builder<K, V> putAll(Iterable<? extends Entry<? extends K, ? extends V>> entries) {
      if (entries instanceof Collection) {
        if (nonSequenced == null && ((Collection) entries).size() > 1) {
          nonSequenced = getNonSequenced(entries);
        }
    ...
    private ImmutableMap<K, V> build(boolean throwIfDuplicateKeys) {
      ...
      return RegularImmutableMap.fromEntryArray(
          localSize, localEntries, throwIfDuplicateKeys, nonSequenced);
    }
  ...
  public static <K, V> ImmutableMap<K, V> copyOf(
    ...
    switch (entryArray.length) {
      ...
      default:
         ...
         */
        return RegularImmutableMap.fromEntries(getNonSequenced(entries), entryArray);
    }
  }
