...
//    if (!(map instanceof SequencedMap<? extends K, ? extends V>)
//        && !(map.getClass().getPackage().getName().startsWith("com.google.common."))) {
//      throw new IllegalArgumentException("Unsequenced map is not supported: " + map.getClass());
//    }
