...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
  ...
  public static <E> ImmutableSet<E> of(E e1, E e2) {
    return new RegularSetBuilderImpl<E>(2).add(e1).add(e2).review().build(null);
  }
  ...
  public static <E> ImmutableSet<E> of(E e1, E e2, E e3) {
    return new RegularSetBuilderImpl<E>(3).add(e1).add(e2).add(e3).review().build(null);
  }
  ...
  public static <E> ImmutableSet<E> of(E e1, E e2, E e3, E e4) {
    return new RegularSetBuilderImpl<E>(4).add(e1).add(e2).add(e3).add(e4).review().build(null);
  }
  ...
  public static <E> ImmutableSet<E> of(E e1, E e2, E e3, E e4, E e5) {
    return new RegularSetBuilderImpl<E>(5)
        .add(e1)
        .add(e2)
        .add(e3)
        .add(e4)
  ...
  public static <E> ImmutableSet<E> of(E e1, E e2, E e3, E e4, E e5, E e6, E... others) {
    ...
    return builder.review().build(null);
  }
  ...
  public static <E> ImmutableSet<E> copyOf(Collection<? extends E> elements) {
    boolean isSequenced = isSequenced(elements);
    /*
  ...
  public static <E> ImmutableSet<E> copyOf(E[] elements) {
    return fromArrayWithExpectedSize(
        elements, estimatedSizeForUnknownDuplication(elements.length), null);
  }
  ...
  private static <E> ImmutableSet<E> fromArrayWithExpectedSize(
    ...
    switch (elements.length) {
      ...
      default:
        ...
        return builder.review().build(isSequenced);
    }
  }
  ...
  public static class Builder<E> extends ImmutableCollection.Builder<E> {
    ...
    public ImmutableSet<E> build() {
      ...
      forceCopy = true;
      impl = impl.review();
      return impl.build(nonSequenced);
    }
  }
      ...
      switch (distinct) {
        ...
        default:
          ...
          return new RegularImmutableSet<>(
              elements, hashCode, requireNonNull(hashTable), hashTable.length - 1, isSequenced);
      }
    }
