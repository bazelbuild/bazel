...
{
    // The class names contained in these private strings will be mapped during
    ...
    public static final String METHOD_TYPE_INIT                      = "(Lcom/google/gson/Gson;" +
                                                                       ClassUtil.internalType(CLASS_OPTIMIZED_JSON_READER) +
                                                                       ClassUtil.internalType(CLASS_OPTIMIZED_JSON_WRITER) + ")V";
    ...
    public static final String METHOD_TYPE_FROM_JSON       = "(Lcom/google/gson/Gson;Lcom/google/gson/stream/JsonReader;" +
                                                             ClassUtil.internalType(CLASS_OPTIMIZED_JSON_READER) + ")V";
