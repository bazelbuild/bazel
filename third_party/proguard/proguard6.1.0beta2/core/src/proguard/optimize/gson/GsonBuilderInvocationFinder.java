                    ...
                    typeArgumentFinder.typeArgumentClasses.length == 1)
                {
                    ...
                    if (type != null)
                    {
                            ...
                            typeAdapterArgumentFinder.typeArgumentClasses.length == 1)
                        {
                            ...
                            Clazz typeAdapter =
                                programClassPool.getClass(typeAdapterArgumentClass);
                            ...
                            ImplementedClassFilter implementsInstanceCreaterFilter =
                            ...
                            typeAdapter.accept(implementsInstanceCreaterFilter);
                        }
                    }
                }
            }
